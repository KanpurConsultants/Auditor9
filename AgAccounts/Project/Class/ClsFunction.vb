...
Public Class ClsFunction
    Dim WithEvents GridReportFrm As FrmRepDisplay
    Public Function FOpen(ByVal StrSender As String, ByVal StrSenderText As String, Optional ByVal mTargetEntryType As TargetEntryType = TargetEntryType.EntryPoint)
        Dim FrmObj As Form = Nothing
        Dim StrUserPermission As String
        Dim DTUP As New DataTable

        Dim MDI As New MDIMain1
        ...
        DTUP = AgL.FillData("Select Permission From User_Permission Where UserName='" & AgL.PubUserName & "' And MnuModule='" & StrModuleName & "' And MnuName='" & StrSender & "'", AgL.GCn).Tables(0)
        ...
        DTUP = AgL.FillData("Select GroupText As UP From User_Control_Permission Where UserName='" & AgL.PubUserName & "' And MnuModule='" & StrModuleName & "' And MnuName='" & StrSender & "'", AgL.GCn).Tables(0)
        ...
        If mTargetEntryType = TargetEntryType.EntryPoint Then
            Select Case StrSender
                ...
                Case MDI.MnuAgeingAnalysisFIFO.Name
                    FrmObj = New FrmReportLayout("Ageing", MDI.MnuAgeingAnalysisFIFO.Text, 15)
                ...
                Case MDI.MnuLedger.Name
                    FrmObj = New FrmReportLayout("Ledger", MDI.MnuLedger.Text, 10)
                Case MDI.MnuTrialGroup.Name
                    FrmObj = New FrmReportLayout("TrialGroup", MDI.MnuTrialGroup.Text, 3)
                Case MDI.MnuTrialDetail.Name
                    FrmObj = New FrmReportLayout("TrialDetail", MDI.MnuTrialDetail.Text, 5)
            ...
            '    AgL.PubReportTitle = "TDS Category Description Master"
                ...
                Case MDI.MnuAnnexure.Name
                    FrmObj = New FrmReportLayout("Annexure", MDI.MnuAnnexure.Text, 4)
                Case MDI.MnuCashBook.Name
                    FrmObj = New FrmReportLayout("CashBook", MDI.MnuCashBook.Text, 10)
                Case MDI.MnuBankBook.Name
                    FrmObj = New FrmReportLayout("BankBook", MDI.MnuBankBook.Text, 10)
                Case MDI.MnuJournalBook.Name
                    FrmObj = New FrmReportLayout("Journal", MDI.MnuJournalBook.Text, 5)
                Case MDI.MnuDayBook.Name
                    FrmObj = New FrmReportLayout("DayBook", MDI.MnuDayBook.Text, 5)
                ...
                Case MDI.MnuMonthlyExpenseChart.Name
                    FrmObj = New FrmReportLayout("MonthlyExpenses", MDI.MnuMonthlyExpenseChart.Text, 4)
                ...
                Case MDI.MnuInterestLedger.Name
                    FrmObj = New FrmReportLayout("InterestLedger", MDI.MnuInterestLedger.Text, 8)
                ...
                Case MDI.MnuTrialDetailDrCr.Name
                    FrmObj = New FrmReportLayout("TrialDetailDrCr", MDI.MnuTrialDetailDrCr.Text, 7)
                ...
                Case MDI.MnuDailyTransactionSummary.Name
                    FrmObj = New FrmReportLayout("DailyTransBook", MDI.MnuDailyTransactionSummary.Text, 6)
                Case MDI.MnuOutstandinDebtorsFIFO.Name
                    FrmObj = New FrmReportLayout("FIFOWsOS_Dr", MDI.MnuOutstandinDebtorsFIFO.Text, 9)
                ...
                Case MDI.MnuAccountGroupWiseAgeingAnalysis.Name
                    FrmObj = New FrmReportLayout("AccountGrpWsOSAgeing", MDI.MnuAccountGroupWiseAgeingAnalysis.Text, 9)
        ...
        ElseIf mTargetEntryType = TargetEntryType.GridReport Then
            GridReportFrm = New FrmRepDisplay(StrSenderText, AgL)
            GridReportFrm.Filter_IniGrid()
            GridReportFrm.IsHideZeroColumns = False
