...
Public Class frmCurrencyMast
    ...
    Public Sub MoveRec()
        ...
        If DTMaster.Rows.Count > 0 Then
            DTTemp = AgL.FillData("Select Code, Name, Discription, SmallCurrency From Currency " &
                          " Where Code='" & AgL.XNull(DTMaster.Rows(BMBMaster.Position).Item("SearchCode")) & "'", AgL.GCn).Tables(0)
