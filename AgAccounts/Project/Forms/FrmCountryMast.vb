...
Public Class frmCountryMast
    ...
    Public Sub MoveRec()
        ...
        If DTMaster.Rows.Count > 0 Then
            DTTemp = AgL.FillData("Select CT.Code, CT.Name,CT.CurrencyCode,CR.Name As Currency " &
                          "From Country CT Left Join Currency CR on CR.Code=CT.CurrencyCode " &
                          "Where CT.Code='" & AgL.XNull(DTMaster.Rows(BMBMaster.Position).Item("SearchCode")) & "'", AgL.GCn).Tables(0)
    ...
    Private Sub FHP_CountryName(ByRef e As System.Windows.Forms.KeyPressEventArgs, ByVal Txt As TextBox)
        ...
        DTMain = AgL.FillData("Select Code, Name from Currency ", AgL.GCn).Tables(0)
