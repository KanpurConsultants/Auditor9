...
Public Class FrmAssetTransaction
    ...
    Public Sub MoveRec()
        ...
        If DTMaster.Rows.Count > 0 Then
            DTTemp = AgL.FillData("Select AT.V_No,AT.V_No, AT.V_Prefix,AT.V_Date,AT.V_Type,AT.Remark, " &
                    "AT.Asset,AT.Amount,AM.Name As AMName,AM.AssetGroup,AG.Name As GroupName,VT.Description, " &
                    "AT.PreparedBy,AT.ModifiedBy " &
                    ...
                    "Voucher_Type VT On AT.V_Type=VT.V_Type " &
                    "Where AT.DocId='" & AgL.XNull(DTMaster.Rows(BMBMaster.Position).Item("SearchCode")) & "'", AgL.GCn).Tables(0)
        ...
        Try
            ...
            If Topctrl1.Mode = "Add" Then
                GCnCmd.CommandText = "Insert Into AssetTransaction(DocId,V_Type,V_No,Recid,V_Prefix,V_Date, " &
                                     ...
                                     "U_EntDt,U_AE) Values " &
                                     "('" & (StrDocID) & "','" & TxtType.Tag & "'," & AgL.Chk_Text(TxtID.Text) & "," & AgL.Chk_Text(TxtRecid.Text) & "," & AgL.Chk_Text(TxtID.Tag) & "," & AgL.Chk_Text(CDate(TxtDate.Text).ToString("s")) & ", " &
            ...
            Else
                ...
                GCnCmd.CommandText = GCnCmd.CommandText + "V_Date=" & AgL.Chk_Text(CDate(TxtDate.Text).ToString("s")) & ", "
