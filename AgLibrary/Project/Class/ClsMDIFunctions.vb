...
Public Class ClsMDIFunctions
    ...
    Public Sub FUpdateUserGroupLevels(ByVal mConn As Object, ByVal mCmd As Object)
    ...
    Public Sub FManageEntryPointPermission(ByVal mConn As Object, ByVal mCmd As Object)
        Dim bQry$ = ""
