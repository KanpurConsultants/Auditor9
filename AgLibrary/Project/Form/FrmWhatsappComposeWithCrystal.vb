...
#End Region
    ...
    Public Function SendPDFByWhatsapp(receiverMobileNo As String, message As String, FileName As String) As String
        ...
        Dim RequestUrl As String = AgL.FGetSettings(AgL, "Whatsapp Request Url", "E Invoice", "", "", "", "", "", "", "")
        Dim Username As String = AgL.FGetSettings(AgL, "Whatsapp Username", "E Invoice", "", "", "", "", "", "", "")
        Dim Password As String = AgL.FGetSettings(AgL, "Whatsapp Password", "E Invoice", "", "", "", "", "", "", "")
