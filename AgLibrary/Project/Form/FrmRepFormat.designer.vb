...
Partial Class FrmRepFormat
    ...
    Private Sub InitializeComponent()
        ...
        Me.BtnSaveFilterSettings.Visible = False
        '
        'Pnl4
        '
    ...
    Public WithEvents TCMain As TabControl
    Public WithEvents TPDisplaySet As TabPage
    Public WithEvents TpFilterSetting As TabPage
    Public WithEvents TPGroupSet As TabPage
    Public WithEvents TPSortSet As TabPage
End Class
