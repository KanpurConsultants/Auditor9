...
Public Class FrmBackupDatase
    ...
    Public Function BackupDataBase(ByVal mConn As SqlClient.SqlConnection, ByVal mCompConn As SqlClient.SqlConnection,
                                   Optional ByVal mAgReportConn As SqlClient.SqlConnection = Nothing,
