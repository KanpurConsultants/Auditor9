...
Public Class FrmRepFormat
    ...
    Public Sub New(ByVal ColumnList As String, ByVal AgLibVar As ClsMain)
    ...
    Public Sub IniGrid()
        ...
        With AgCL
            ...
            .AddAgTextColumn(DglFilter, ColValue2, 90, 100, ColValue2, False, False)
            .AddAgButtonColumn(DglFilter, ColMValue, 50, ColMValue, False, False)
        End With
    ...
    Private Sub DglSort_Layout(sender As Object, e As LayoutEventArgs) Handles DglSort.Layout
