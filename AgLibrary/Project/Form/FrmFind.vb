...
Public Class FrmFind
    ...
    Public IsFrmCancelled As Boolean = False
    ...
    Public Sub New(ByVal ReportQry As String, ByVal Title As String, ByVal AgLibVar As ClsMain)
    ...
    Private Sub IniGrid()
        ...
        DGL1.ColumnHeadersDefaultCellStyle.BackColor = Color.SteelBlue
        DGL1.ColumnHeadersDefaultCellStyle.ForeColor = Color.White
        DGL1.CellBorderStyle = DataGridViewCellBorderStyle.None
        DGL1.RowTemplate.DefaultCellStyle.Padding = New Padding(5, 4, 5, 4)
        DGL1.RowTemplate.Height = 25
        ...
        DGL2.DefaultCellStyle.BackColor = Color.SteelBlue
    ...
    Public Sub ProcFillGrid(ByVal mMQry As String)
        ...
        Try
            ...
            If DGL1.Columns.Contains("SearchCode") Then DGL1.Columns("SearchCode").Visible = False : DGL2.Columns(DGL1.Columns("SearchCode").Index).Visible = False
            ...
            If DsMaster.Tables(0).Rows.Count <= 50000 Then
    ...
    Private Sub ProcSortGrid()
        ...
        Try
            ...
            With FrmObj.DglSort
                For I = 0 To .Rows.Count - 1
                    If .Item(FrmRepFormat.ColFieldName, I).Value <> "" Then
                        DGL1.DataSource.DefaultView.Sort &= IIf(DGL1.DataSource.DefaultView.Sort <> "", ",", "") & .Item(FrmRepFormat.ColFieldName, I).Value.ToString & " " & .Item(FrmRepFormat.Col2AscDsc, I).Value.ToString
                    End If
                Next
            End With
    ...
    Private Function RowsFilter(ByVal selStr As String, ByVal CtrlObj As Object, ByVal TXT As TextBox, ByVal e As System.Windows.Forms.KeyPressEventArgs, ByVal FndFldName As String, ByVal DTable As DataTable) As Integer
        Try
            ...
            If sa.Length = 0 And Asc(e.KeyChar) = 8 Then IntRow = 0 : CtrlObj.CurrentCell = CtrlObj(FndFldName, IntRow) : DsMaster.Tables(0).DefaultView.RowFilter = Nothing : DGL1.CurrentCell = DGL1(FndFldName, 0) : ProcFilterGrid() : Exit Function
            ...
            If Asc(e.KeyChar) = Keys.Back Or Asc(e.KeyChar) = 4 Or Asc(e.KeyChar) = 19 Then
                ProcFilterGrid()
            End If
    ...
    Private Sub DGL1_PreviewKeyDown(sender As Object, e As PreviewKeyDownEventArgs) Handles DGL1.PreviewKeyDown
        If e.KeyCode = Keys.Delete Then TxtFind.Text = "" : FManageFindTextboxVisibility() : DsMaster.Tables(0).DefaultView.RowFilter = Nothing : DGL1.CurrentCell = DGL1(fld, 0) : DsMaster.Tables(0).DefaultView.RowFilter = Nothing : ProcFilterGrid()
