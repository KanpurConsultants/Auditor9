...
Module MdlFunction
    ...
    Public Function FOpenIni(ByVal StrIniPath As String, ByVal StrUserName As String, ByVal StrPassword As String) As Boolean
        ...
        Try
            ...
            AgL.PubReportFaPath = My.Application.Info.DirectoryPath & "\ReportsFA"
...
#Region "Menu Design"
    ...
    Public Sub FAddMenu(ByVal MD As MDIMain, Optional ByVal StrModule As String = "")
        ...
        If AgL.PubUserName.ToString.ToUpper = AgLibrary.ClsConstant.PubSuperUserName Then
            mQry = "SELECT P.MnuModule, P.MnuName, P.MnuText, P.MainStreamCode, P.ReportFor     FROM User_Permission P WHERE P.UserName='" & AgLibrary.ClsConstant.PubSuperUserName & "' And IfNull(P.Active,'Y')='Y' And IfNull(P.Permission,'****') <> '****' ORDER BY P.MainStreamCode "
        ElseIf AgL.PubUserName.ToString.ToUpper = "SA" Or AgL.PubIsUserAdmin Then
            mQry = "SELECT P.MnuModule, P.MnuName, P.MnuText, P.MainStreamCode, P.ReportFor     FROM User_Permission P WHERE P.UserName='SA' And IfNull(P.Active,'Y')='Y' And IfNull(P.Permission,'****') <> '****' ORDER BY P.MainStreamCode "
        Else
            mQry = "SELECT P.MnuModule, P.MnuName, P.MnuText, P.MainStreamCode, P.ReportFor     FROM User_Permission P WHERE P.UserName='" & AgL.PubUserName & "' And IfNull(P.Active,'Y')='Y' And IfNull(P.Permission,'****') <> '****' ORDER BY P.MainStreamCode "
        End If
        ...
        If AgL.PubUserName.ToString.ToUpper = AgLibrary.ClsConstant.PubSuperUserName Then
            DTTemp = AgL.FillData("Select P.UserName||P.MnuName||P.MnuModule as SearchKey, 	P.UserName,P.MnuModule,P.MnuName,P.MnuText,P.SNo,P.MnuLevel,P.Parent,P.Permission,P.ReportFor,P.Active,P.RowId,P.UpLoadDate,User_Module.MainStreamCode,User_Module.GroupLevel From User_Permission P Left Join (Select MnuName||MnuModule As SearchKey,MainStreamCode, GroupLevel From User_Permission Where UserName='" & AgLibrary.ClsConstant.PubSuperUserName & "') As User_Module On P.MnuName||P.MnuModule=User_Module.SearchKey Where P.UserName='" & AgLibrary.ClsConstant.PubSuperUserName & "' And IfNull(P.Active,'Y')='Y' And IfNull(P.Permission,'****') <> '****' Order By User_Module.MainStreamCode", AgL.ECompConn).Tables(0)
        ElseIf AgL.PubUserName.ToString.ToUpper = "SA" Or AgL.PubIsUserAdmin Then
            DTTemp = AgL.FillData("Select P.UserName||P.MnuName||P.MnuModule as SearchKey, 	P.UserName,P.MnuModule,P.MnuName,P.MnuText,P.SNo,P.MnuLevel,P.Parent,P.Permission,P.ReportFor,P.Active,P.RowId,P.UpLoadDate,User_Module.MainStreamCode,User_Module.GroupLevel From User_Permission P Left Join (Select MnuName||MnuModule As SearchKey,MainStreamCode, GroupLevel From User_Permission Where UserName='SA') As User_Module On P.MnuName||P.MnuModule=User_Module.SearchKey Where P.UserName='SA' And IfNull(P.Active,'Y')='Y' And IfNull(P.Permission,'****') <> '****' Order By User_Module.MainStreamCode", AgL.ECompConn).Tables(0)
        Else
            DTTemp = AgL.FillData("Select P.UserName||P.MnuName||P.MnuModule as SearchKey, 	P.UserName,P.MnuModule,P.MnuName,P.MnuText,P.SNo,P.MnuLevel,P.Parent,P.Permission,P.ReportFor,P.Active,P.RowId,P.UpLoadDate,User_Module.MainStreamCode,User_Module.GroupLevel From User_Permission P Left Join (Select MnuName||MnuModule As SearchKey,MainStreamCode, GroupLevel From User_Permission Where UserName='SA') As User_Module On P.MnuName||P.MnuModule=User_Module.SearchKey Where P.UserName='" & AgL.PubUserName & "' And IfNull(P.Active,'Y')='Y' And IfNull(P.Permission,'****') <> '****' Order By User_Module.MainStreamCode", AgL.ECompConn).Tables(0)
        End If
