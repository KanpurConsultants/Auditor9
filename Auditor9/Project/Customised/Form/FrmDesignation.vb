...
#Region "Designer Code"
    Private Sub InitializeComponent()
        ...
        Me.GBoxDivision.Size = New System.Drawing.Size(138, 44)
        '
        'TxtDivision
        '
        Me.TxtDivision.AgSelectedValue = ""
        Me.TxtDivision.Size = New System.Drawing.Size(132, 18)
        Me.TxtDivision.Tag = ""
        '
        'TxtStatus
        '
...
#End Region
    ...
    Private Sub FrmYarn_BaseEvent_Data_Validation(ByRef passed As Boolean) Handles Me.BaseEvent_Data_Validation
        ...
        If Topctrl1.Mode = "Add" Then
            mQry = "Select count(*) From HRM_Designation Where Description='" & TxtDescription.Text & "' "
            If AgL.Dman_Execute(mQry, AgL.GCn).ExecuteScalar > 0 Then Err.Raise(1, , "Description Already Exist!")
        Else

            mQry = "Select count(*) From HRM_Designation Where Description='" & TxtDescription.Text & "' And Code <> '" & mInternalCode & "' "
            If AgL.Dman_Execute(mQry, AgL.GCn).ExecuteScalar > 0 Then Err.Raise(1, , "Description Already Exist!")
        End If
    End Sub
    ...
    Public Overridable Sub FrmYarn_BaseEvent_FindMain() Handles Me.BaseEvent_FindMain
        ...
        AgL.PubFindQry = "SELECT I.Code As SearchCode, I.Description  FROM HRM_Designation I "
        AgL.PubFindQryOrdBy = "[Description]"
    End Sub

    Private Sub FrmYarn_BaseEvent_Form_PreLoad() Handles Me.BaseEvent_Form_PreLoad
        MainTableName = "HRM_Designation"
    End Sub
    ...
    Private Sub FrmYarn_BaseFunction_FIniMast(ByVal BytDel As Byte, ByVal BytRefresh As Byte) Handles Me.BaseFunction_FIniMast
        ...
        mQry = "Select I.Code As SearchCode " &
                " From HRM_Designation I " & mConStr &
    ...
    Private Function FGetRelationalData() As Boolean
        Try
            mQry = " Select Count(*) From ItemCategory Where HRM_Designation = '" & mSearchCode & "'"
