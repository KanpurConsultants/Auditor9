...
Public Class FrmSplitData_Old
    ...
    Private Sub Button1_Click(sender As Object, e As EventArgs) Handles BtnOk.Click
        ...
        AddHandler Me._backgroundWorker1.DoWork, New DoWorkEventHandler(AddressOf Me.FTransferOpening)
    ...
    Private Sub FTransferOpening()
        mQry = " Select L.SubCode, IfNull(Sum(L.AmtDr),0) - IfNull(Sum(L.AmtCr),0) As Balance
                From Ledger L
                Group By L.SubCode "
        Dim DtHeader As DataTable = AgL.FillData(mQry, Connection_ExternalDatabase).Tables(0)
        ...
        Try
            ...
            For I As Integer = 0 To DtHeader.Rows.Count - 1
                ...
                Dim DtLine As DataTable = AgL.FillData(mQry, Connection_ExternalDatabase).Tables(0)
                ...
                For J As Integer = 0 To DtLine.Rows.Count - 1
                    ...
                    VoucherEntryTable.Line_ReferenceNo = ""
                    VoucherEntryTable.Line_ReferenceDate = ""
