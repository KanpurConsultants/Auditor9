...
Public Class FrmSettings_Visibility
    ...
    Protected Const Col1EntryName As String = "Entry Name"
    Protected Const Col1EntryDispName As String = "Entry Disp Name"
    ...
    Public Sub InitSettingData()
        ...
        DtSettingsData.Columns.Add(Col1EntryName)
        DtSettingsData.Columns.Add(Col1EntryDispName)
    ...
    Private Sub Ini_Grid()
        ...
        Dgl1.Columns(Col1TableDispName).Width = 80
        Dgl1.Columns(Col1EntryDispName).Width = 160
        Dgl1.Columns(Col1GridName).Width = 60
        ...
        Dgl1.Columns(Col1Process).Width = 80
        ...
        Dgl1.Columns(Col1EntryDispName).ReadOnly = True
        ...
        Dgl1.Columns(Col1EntryName).Visible = False
    ...
    Public Sub MovRec()
        ...
        GetSettingDataForTable("EntryLineUISetting", "Line")
    ...
    Public Sub GetSettingDataForTable(mTableName As String, mTableDispName As String)
        ...
        mQry = "SELECT H.Code As [Code], 
                H.EntryName As [Entry Name], H.GridName As [Grid Name], S.Name AS [Site], D.Div_Name AS [Division], H.NCat As [NCat], 
                IfNull(Vt.Description,H.V_Type) AS [Voucher Type], P.Name As [Process Name], Stg.Name As [Setting Group Name],
        ...
        If DtTemp.Rows.Count > 0 Then
            For I = 0 To DtTemp.Rows.Count - 1
                ...
                DtSettingsData.Rows(mGridRowNumber)(Col1EntryName) = AgL.XNull(DtTemp.Rows(I)("Entry Name"))
                DtSettingsData.Rows(mGridRowNumber)(Col1EntryDispName) = GetFormattedString(AgL.XNull(DtTemp.Rows(I)("Entry Name")).ToString.Replace("Frm", ""))
                ...
                DtSettingsData.Rows(mGridRowNumber)(Col1Process) = AgL.XNull(DtTemp.Rows(I)("Process Name"))
                DtSettingsData.Rows(mGridRowNumber)(Col1SettingGroup) = AgL.XNull(DtTemp.Rows(I)("Setting Group Name"))
    ...
    End Sub
    Private Sub FrmSettings_Visibility_KeyDown(sender As Object, e As KeyEventArgs) Handles MyBase.KeyDown
