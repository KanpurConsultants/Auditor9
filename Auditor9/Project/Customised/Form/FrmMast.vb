...
Public Class FrmMast

    Inherits AgTemplate.TempMaster

    Dim mQry$
    Dim mMasterType As String
...
#End Region
    ...
    Private Sub FrmYarn_BaseEvent_Data_Validation(ByRef passed As Boolean) Handles Me.BaseEvent_Data_Validation
        ...
        If Topctrl1.Mode = "Add" Then
            mQry = "Select count(*) From Mast Where Description='" & TxtDescription.Text & "' And Type = '" & mMasterType & "' "
            If AgL.Dman_Execute(mQry, AgL.GCn).ExecuteScalar > 0 Then Err.Raise(1, , "Description Already Exist!")
        Else
            mQry = "Select count(*) From Mast Where Description='" & TxtDescription.Text & "' And Type = '" & mMasterType & "' And Code <> '" & mInternalCode & "' "
            If AgL.Dman_Execute(mQry, AgL.GCn).ExecuteScalar > 0 Then Err.Raise(1, , "Description Already Exist!")
        End If
    End Sub
    ...
    Public Overridable Sub FrmYarn_BaseEvent_FindMain() Handles Me.BaseEvent_FindMain
        ...
        AgL.PubFindQry = "SELECT I.Code As SearchCode, I.Description  FROM Mast I "
    ...
    Private Sub FrmQuality1_BaseFunction_MoveRec(ByVal SearchCode As String) Handles Me.BaseFunction_MoveRec
        ...
        mQry = "Select H.* " &
                " From Mast H " &
                " Where H.Code='" & SearchCode & "' And Type = '" & mMasterType & "' "
    ...
    Public Sub New(ByVal StrUPVar As String, ByVal DTUP As DataTable, MasterType As String)
    ...
    Private Sub FrmYarn_BaseFunction_FIniMast(ByVal BytDel As Byte, ByVal BytRefresh As Byte) Handles Me.BaseFunction_FIniMast
        Dim mConStr$ = " Where Type = '" & mMasterType & "' "
    ...
    Private Sub FrmMast_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
    ...
    Private Function FGetRelationalData() As Boolean
        Try
            'mQry = " Select Count(*) From ItemCategory Where Mast = '" & mSearchCode & "'"
    ...
    Private Sub FrmMast_BaseFunction_BlankText() Handles Me.BaseFunction_BlankText
        Dim obj As Object
