...
Public Class FrmCustomerAcSettlementInvoiceAdjAadhat
    Dim mQry As String = ""
    ...
    Public Sub FMoverec(DocID As String, Sr As Integer)
        ...
        mQry = "Select Head.Description as HeadDescription, Head.Code as HeadCode, Head.PostInAc,
                IfNull(L.AdditionDeduction, Head.AdditionDeduction) as AdditionDeduction, Head.RateCalculationType, Head.CalculateOn, L.Rate, L.Amount, L.Remark
    ...
    Public Sub Calculation()
        ...
        For I = 0 To Dgl1.RowCount - 1
            ...
            If Val(Dgl1.Item(Col1Amount, I).Value) > 0 Then
                If Dgl1.Item(Col1AdditionDeduction, I).Value.ToString.ToUpper() = "ADDITION" Then
                    mSubTotal += Val(Dgl1.Item(Col1Amount, I).Value)
                Else
                    mSubTotal -= Val(Dgl1.Item(Col1Amount, I).Value)
                End If
            End If
        ...
        For I = 0 To Dgl1.RowCount - 1
            If Val(Dgl1.Item(Col1Amount, I).Value) > 0 Then
                If Dgl1.Item(Col1AdditionDeduction, I).Value.ToString.ToUpper() = "ADDITION" Then
                    mTotalAddition += Val(Dgl1.Item(Col1Amount, I).Value)
                Else
                    mTotalDeduction += Val(Dgl1.Item(Col1Amount, I).Value)
                End If
            End If
        Next
    ...
    Public Sub FSave(DocId As String, TSr As Integer, ByVal Conn As Object, ByVal Cmd As Object)
        ...
        For I = 0 To Dgl1.RowCount - 1
            If Val(Dgl1.Item(Col1Amount, I).Value) > 0 Then
                mSr += 1
                mQry = " INSERT INTO Cloth_SupplierSettlementInvoicesAdjustment (DocID, TSr, Sr, AdjustmentHead, AdditionDeduction, Rate, Amount, Remark) 
