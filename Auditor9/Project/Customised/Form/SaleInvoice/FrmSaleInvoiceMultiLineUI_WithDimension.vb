...
Public Class FrmSaleInvoiceMultiLineUI_WithDimension
    Dim mQry As String = ""
        ...
        Try
            ...
            Select Case Dgl1.Columns(Dgl1.CurrentCell.ColumnIndex).Name
                Case Col1Size
                    ...
                    Dgl1.Item(Col1Rate, mRowIndex).Value = ClsMain.FGetRateWithRatePattern("", mPartyCode, mSettingGroup, mDivCode, mSiteCode, Process.Sales, mVType, mRateType,
                        AgL.XNull(DglRow.Cells(FrmSaleInvoiceDirect_WithDimension.Col1ItemCategory).Tag),
                        AgL.XNull(DglRow.Cells(FrmSaleInvoiceDirect_WithDimension.Col1ItemGroup).Tag),
                        AgL.XNull(DglRow.Cells(FrmSaleInvoiceDirect_WithDimension.Col1Item).Tag),
                        AgL.XNull(DglRow.Cells(FrmSaleInvoiceDirect_WithDimension.Col1Dimension1).Tag),
                        AgL.XNull(DglRow.Cells(FrmSaleInvoiceDirect_WithDimension.Col1Dimension2).Tag),
                        AgL.XNull(DglRow.Cells(FrmSaleInvoiceDirect_WithDimension.Col1Dimension3).Tag),
                        AgL.XNull(DglRow.Cells(FrmSaleInvoiceDirect_WithDimension.Col1Dimension4).Tag),
                    ...
                    If Val(Dgl1.Item(Col1Rate, mRowIndex).Value) > 0 Then
                        Dgl1.Item(Col1Rate, mRowIndex).Value = Val(Dgl1.Item(Col1Rate, mRowIndex).Value) +
                            ClsMain.FGetRateWithRatePattern(RateCategory.RateAddition, mPartyCode, mSettingGroup, mDivCode, mSiteCode, Process.Sales, mVType, mRateType,
                                AgL.XNull(DglRow.Cells(FrmSaleInvoiceDirect_WithDimension.Col1ItemCategory).Tag),
                                AgL.XNull(DglRow.Cells(FrmSaleInvoiceDirect_WithDimension.Col1ItemGroup).Tag),
                                AgL.XNull(DglRow.Cells(FrmSaleInvoiceDirect_WithDimension.Col1Item).Tag),
                                AgL.XNull(DglRow.Cells(FrmSaleInvoiceDirect_WithDimension.Col1Dimension1).Tag),
                    ...
                    If ClsMain.FDivisionNameForCustomization(15) = "AGARWAL UNIFORM" Then
                        If mRowIndex > 0 Then
    ...
    Private Sub FCreateHelpSize(RowIndex As Integer)
        ...
        If AgL.XNull(DglRow.Cells(FrmSaleInvoiceDirect_WithDimension.Col1ItemCategory).Tag) <> "" Then
            strCond += " And (I.ItemCategory = '" & AgL.XNull(DglRow.Cells(FrmSaleInvoiceDirect_WithDimension.Col1ItemCategory).Tag) & "' 
        ...
        If DtItemRelation.Rows.Count > 0 Then
            If AgL.XNull(DglRow.Cells(FrmSaleInvoiceDirect_WithDimension.Col1Dimension3).Tag) <> "" Then
                If DtItemRelation.Select("ItemV_Type = '" & ItemV_Type.Dimension3 & "'
                                And RelatedItemV_Type = '" & ItemV_Type.SIZE & "'").Length > 0 Then
                    Dim DrItemRelation As DataRow() = DtItemRelation.Select("Item = '" & AgL.XNull(DglRow.Cells(FrmSaleInvoiceDirect_WithDimension.Col1Dimension3).Tag) & "'")
