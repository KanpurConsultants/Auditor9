...
Public Class FrmSaleInvoiceDimension
    ...
    Dim mObjFrmSaleInvoice As FrmSaleInvoiceDirect
    ...
    Public Property objFrmSaleInvoice() As FrmSaleInvoiceDirect
        Get
            objFrmSaleInvoice = mObjFrmSaleInvoice
        End Get
        Set(ByVal value As FrmSaleInvoiceDirect)
    ...
    Public Sub FSave(DocId As String, TSr As Integer, mGridRowIndex As Integer, ByVal Conn As Object, ByVal Cmd As Object, Optional MultiplyWithMinus As Boolean = False)
        ...
        If mObjFrmSaleInvoice.BtnFillPartyDetail.Tag IsNot Nothing Then
            bSalesTaxGroupParty = mObjFrmSaleInvoice.BtnFillPartyDetail.Tag.Dgl1.Item(mObjFrmSaleInvoice.BtnFillPartyDetail.Tag.Col1Value, mObjFrmSaleInvoice.BtnFillPartyDetail.Tag.rowSalesTaxGroup).Value
        End If
        mDimensionDetail = ""
        For I = 0 To Dgl1.RowCount - 1
                ...
                If Val(Dgl1.Item(Col1TotalQty, I).Value) <> 0 Then
                    If Dgl1.Item(ColSNo, I).Tag Is Nothing Then
                        ...
                        mQry = "Insert Into Stock(DocID, TSr, Sr, V_Type, 
                                ...
                                LotNo, Godown, EType_IR, Qty_Iss, Qty_Rec, 
                                Unit, Rate, Amount, Landed_Value) 
                                Values
                                (
                                    '" & DocId & "', " & TSr & ", " & mObjFrmSaleInvoice.mDimensionSrl & ", " & AgL.Chk_Text(mObjFrmSaleInvoice.TxtV_Type.Tag) & ",
                                    " & AgL.Chk_Text(mObjFrmSaleInvoice.LblPrefix.Text) & ", " & AgL.Chk_Date(mObjFrmSaleInvoice.TxtV_Date.Text) & ", " & AgL.Chk_Text(mObjFrmSaleInvoice.TxtV_No.Text) & ", " & AgL.Chk_Text(mObjFrmSaleInvoice.TxtReferenceNo.Text) & ",
                                    " & AgL.Chk_Text(mObjFrmSaleInvoice.TxtDivision.Tag) & ", " & AgL.Chk_Text(mObjFrmSaleInvoice.TxtSite_Code.Tag) & ", " & AgL.Chk_Text(mObjFrmSaleInvoice.TxtSaleToParty.Tag) & ", " & AgL.Chk_Text(bSalesTaxGroupParty) & ", " & AgL.Chk_Text(mObjFrmSaleInvoice.Dgl1(FrmSaleInvoiceDirect.Col1Item, mGridRowIndex).Tag) & ", " & AgL.Chk_Text(mObjFrmSaleInvoice.Dgl1(FrmSaleInvoiceDirect.Col1SalesTaxGroup, mGridRowIndex).Value) & ",
                                    " & AgL.Chk_Text(mObjFrmSaleInvoice.Dgl1(FrmSaleInvoiceDirect.Col1LotNo, mGridRowIndex).Value) & "," & AgL.Chk_Text(mObjFrmSaleInvoice.Dgl1(FrmSaleInvoiceDirect.Col1Godown, mGridRowIndex).Value) & ", 'I', " & Val(Dgl1(Col1TotalQty, I).Value) & ", 0,
                                    " & AgL.Chk_Text(mObjFrmSaleInvoice.Dgl1(FrmSaleInvoiceDirect.Col1Unit, mGridRowIndex).Value) & ", " & AgL.Chk_Text(mObjFrmSaleInvoice.Dgl1(FrmSaleInvoiceDirect.Col1Rate, mGridRowIndex).Value) & ", " & AgL.Chk_Text(mObjFrmSaleInvoice.Dgl1(FrmSaleInvoiceDirect.Col1Amount, mGridRowIndex).Value) & ",0
                                )   "
                        AgL.Dman_ExecuteNonQry(mQry, Conn, Cmd)
                    ...
                    Else
                        ...
                        mQry = "Update Stock Set V_Type = " & AgL.Chk_Text(mObjFrmSaleInvoice.TxtV_Type.Tag) & ",
                                    V_Prefix = " & AgL.Chk_Text(mObjFrmSaleInvoice.LblPrefix.Text) & ", 
                                    V_Date = " & AgL.Chk_Date(mObjFrmSaleInvoice.TxtV_Date.Text) & ", 
                                    V_No = " & AgL.Chk_Text(mObjFrmSaleInvoice.TxtV_No.Text) & ", 
                                    RecId = " & AgL.Chk_Text(mObjFrmSaleInvoice.TxtReferenceNo.Text) & ",
                                    Div_Code = " & AgL.Chk_Text(mObjFrmSaleInvoice.TxtDivision.Tag) & ", 
                                    Site_Code = " & AgL.Chk_Text(mObjFrmSaleInvoice.TxtSite_Code.Tag) & ", 
                                    Subcode = " & AgL.Chk_Text(mObjFrmSaleInvoice.TxtSaleToParty.Tag) & ", 
                                    SalesTaxGroupParty = " & AgL.Chk_Text(bSalesTaxGroupParty) & ", 
                                    Item = " & AgL.Chk_Text(mObjFrmSaleInvoice.Dgl1(FrmSaleInvoiceDirect.Col1Item, mGridRowIndex).Tag) & ",
                                    SalesTaxGroupItem = " & AgL.Chk_Text(mObjFrmSaleInvoice.Dgl1(FrmSaleInvoiceDirect.Col1SalesTaxGroup, mGridRowIndex).Tag) & ",
                                    LotNo = " & AgL.Chk_Text(mObjFrmSaleInvoice.Dgl1(FrmSaleInvoiceDirect.Col1LotNo, mGridRowIndex).Value) & ", 
                                    Godown = " & AgL.Chk_Text(mObjFrmSaleInvoice.Dgl1(FrmSaleInvoiceDirect.Col1Godown, mGridRowIndex).Value) & ", 
                                    EType_IR = 'I', 
                                    Qty_Iss = " & Val(Dgl1(Col1TotalQty, I).Value) & ", 
                                    Qty_Rec=0,
                                    Unit=" & AgL.Chk_Text(mObjFrmSaleInvoice.Dgl1(FrmSaleInvoiceDirect.Col1Unit, mGridRowIndex).Value) & ", 
                                    Rate=" & AgL.Chk_Text(mObjFrmSaleInvoice.Dgl1(FrmSaleInvoiceDirect.Col1Rate, mGridRowIndex).Value) & ", 
                                    Amount=" & AgL.Chk_Text(mObjFrmSaleInvoice.Dgl1(FrmSaleInvoiceDirect.Col1Amount, mGridRowIndex).Value) & ",
                                    Landed_Value=0                                
                                    Where DocID = '" & DocId & "' And TSr = " & TSr & " And Sr = " & Dgl1.Item(ColSNo, I).Tag & "
                                "
                        AgL.Dman_ExecuteNonQry(mQry, Conn, Cmd)
