...
Public Class FrmSaleInvoicePurchaseSummary
    ...
    Public Sub FLoadPurchaseDataFromSaleInvoice()
        ...
        Dim Col1ReferenceDocId As String = "Reference DocId"
        ...
        For I = 0 To mSaleInvoiceDgl.Rows.Count - 1
            ...
            'mQry += " Select " & AgL.Chk_Text(mSaleInvoiceDgl.Item(Col1ReferenceDocId, I).Tag) & " As SaleOrderDocId, 
            '        " & AgL.Chk_Text(mSaleInvoiceDgl.Item(Col1ReferenceDocId, I).Value) & " As SaleOrderNo, 
    ...
    Public Sub FPostPurchaseData(Conn As Object, Cmd As Object)
        ...
        For I = 0 To Dgl1.Rows.Count - 1
            ...
            For J = 0 To DtTemp.Rows.Count - 1
                ...
                PurchInvoiceTable.Line_DiscountPer = AgL.XNull(DtTemp.Rows(J)("DiscountPer"))
                PurchInvoiceTable.Line_DiscountAmount = AgL.XNull(DtTemp.Rows(J)("DiscountAmount"))
                ...
                PurchInvoiceTable.Line_Gross_Amount = AgL.VNull(DtTemp.Rows(J)("Gross_Amount"))
                PurchInvoiceTable.Line_Taxable_Amount = AgL.VNull(DtTemp.Rows(J)("Taxable_Amount"))
                ...
                PurchInvoiceTable.Line_SubTotal1 = AgL.VNull(DtTemp.Rows(J)("SubTotal1"))
