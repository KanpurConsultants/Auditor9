...
#End Region
            ...
            For I = 0 To .RowCount - 1
                If .Item(Col1Item, I).Value <> "" Then
                    ...
                    mQry = "INSERT INTO StockHeadDetail(DocId, Sr, Item, Process, " &
                            ...
                            " ReferenceDocId, ReferenceDocIdSr, DifferenceQty, DifferenceMeasure) " &
    ...
    Private Sub FPostInStock(ByVal Conn As Object, ByVal Cmd As Object)
        ...
        mQry = " INSERT INTO Stock (DocId, TSr, Sr, " &
                ...
                " Measure_Rec, " &
                " MeasureUnit, " &
                " Rate, Amount, ReferenceDocId, ReferenceDocIdSr) " &
                ...
                " L.MeasureUnit, " &
                " L.Rate, L.Amount, L.ReferenceDocId, L.ReferenceDocIdSr " &
                " FROM StockHeadDetail L  " &
        ...
        Try
            ...
            If ChkAssumeStock0IfNotFound.Checked Then
                ...
                ComputerStockQry = " SELECT L.Item, L.Unit, Round(IfNull(Sum(L.Qty_Rec),0) - IfNull(Sum(L.Qty_Iss),0),4) AS ComputerStock, 0 As PhysicalStock " &
                           " FROM Stock L " &
                           " LEFT JOIN Item I ON L.Item = I.Code " &
                           " WHERE Date(L.V_Date) <= '" & TxtV_Date.Text & "'   " &
                ...
                DtTemp = AgL.FillData(mQry, AgL.GCn)
