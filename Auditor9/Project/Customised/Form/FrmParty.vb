...
#End Region
    ...
    Private Sub FrmParty_BaseEvent_Data_Validation(ByRef passed As Boolean) Handles Me.BaseEvent_Data_Validation
        If UCase(TxtSalesTaxGroup.Text) = "REGISTERED" Then
