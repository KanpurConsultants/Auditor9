...
Public Class FrmClothSupplierSettlement
...
#Region "Form Designer Code"
    Private Sub InitializeComponent()
        ...
        Me.MaximizeBox = True
        Me.Name = "FrmClothSupplierSettlement"
...
#End Region
    ...
    Private Sub FrmProductionOrder_BaseEvent_Save_InTrans(ByVal SearchCode As String, ByVal Conn As Object, ByVal Cmd As Object) Handles Me.BaseEvent_Save_InTrans
            ...
            If Dgl1.Item(Col1Subcode, I).Value <> "" Then
                ...
                If Dgl1.Rows(I).Visible = True Then
                    ...
                    If TxtDrCr.Text = "Credit" Then
                        mLedgerPostingData += " Select " & AgL.Chk_Text(Dgl1.Item(Col1Subcode, I).Tag) & " as Subcode, " & AgL.Chk_Text(TxtParty.Tag) & " as ContraAc, 0 as AmtDr, " & Val(Dgl1.Item(Col1Amount, I).Value) & " as AmtCr, '" & mNarration & "' as Narration, " & AgL.Chk_Text(Dgl1.Item(Col1ChqRefNo, I).Tag) & " ChqNo, " & AgL.Chk_Text(Dgl1.Item(Col1ChqRefDate, I).Tag) & " ChqDate "
                    Else
        ...
        If Val(LblDifferenceAmount.Text) > 0 Then
            If mLedgerPostingData <> "" Then mLedgerPostingData += " UNION ALL "
            mLedgerPostingData += " Select " & AgL.Chk_Text("SUSPENSE") & " as Subcode, " & AgL.Chk_Text(TxtParty.Tag) & " as ContraAc, 0 as AmtDr, " & Val(LblDifferenceAmount.Text) & " as AmtCr, '" & mNarration & "' as Narration, Null ChqNo, Null as ChqDate "
            ...
            If Dgl2.Item(Col2InvoiceNo, I).Value <> "" Then
                If Dgl2.Item(ColSNo, I).Tag Is Nothing And Dgl2.Rows(I).Visible = True Then
                    If Dgl2.Item(Col2Select, I).Value = "þ" Then
                        ...
                        If Dgl2.Item(Col2BtnItemDetail, I).Tag IsNot Nothing Then
                            CType(Dgl2.Item(Col2BtnItemDetail, I).Tag, FrmClothSupplierSettlementInvoiceLine).FSave(mSearchCode, mSr, Conn, Cmd)
                        End If

                        If Dgl2.Item(Col2BtnAdjDetail, I).Tag IsNot Nothing Then
                            CType(Dgl2.Item(Col2BtnAdjDetail, I).Tag, FrmClothSupplierSettlementInvoiceAdj).FSave(mSearchCode, mSr, Conn, Cmd)
                        End If
                ...
                Else
                    If Dgl2.Rows(I).Visible = True And Dgl2.Item(Col2Select, I).Value = "þ" Then
                        ...
                        If Dgl2.Item(Col2BtnItemDetail, I).Tag IsNot Nothing Then
                            CType(Dgl2.Item(Col2BtnItemDetail, I).Tag, FrmClothSupplierSettlementInvoiceLine).FSave(mSearchCode, Val(Dgl2.Item(ColSNo, I).Tag), Conn, Cmd)
                        End If

                        If Dgl2.Item(Col2BtnAdjDetail, I).Tag IsNot Nothing Then
                            CType(Dgl2.Item(Col2BtnAdjDetail, I).Tag, FrmClothSupplierSettlementInvoiceAdj).FSave(mSearchCode, Val(Dgl2.Item(ColSNo, I).Tag), Conn, Cmd)
                        End If
                ...
                If Dgl2.Rows(I).Visible = True And Dgl2.Item(Col2Select, I).Value = "þ" Then
                    Dim obj As FrmClothSupplierSettlementInvoiceAdj
                    ...
                    If Dgl2.Item(Col2BtnAdjDetail, I).Tag IsNot Nothing Then
                        ...
                        For J = 0 To obj.Dgl1.Rows.Count - 1
                            If obj.Dgl1.Item(FrmClothSupplierSettlementInvoiceAdj.Col1Head, J).Value <> "" And Val(obj.Dgl1.Item(FrmClothSupplierSettlementInvoiceAdj.Col1Amount, J).Value) > 0 Then
                                If Val(obj.Dgl1.Item(FrmClothSupplierSettlementInvoiceAdj.Col1Rate, J).Value) > 0 Then
                                    mNarration = "Payment Settlement for Party " & TxtParty.Text & ", " & obj.Dgl1.Item(FrmClothSupplierSettlementInvoiceAdj.Col1Head, J).Value & " Availed at " & obj.Dgl1.Item(FrmClothSupplierSettlementInvoiceAdj.Col1RateCalculationType, J).Value & " of " & Val(obj.Dgl1.Item(FrmClothSupplierSettlementInvoiceAdj.Col1Rate, J).Value) & ".  Amount of Rs." & Val(obj.Dgl1.Item(FrmClothSupplierSettlementInvoiceAdj.Col1Amount, J).Value) & ""
                                Else
                                    mNarration = "Payment Settlement for Party " & TxtParty.Text & ", " & obj.Dgl1.Item(FrmClothSupplierSettlementInvoiceAdj.Col1Head, J).Value & " Amount of Rs." & Val(obj.Dgl1.Item(FrmClothSupplierSettlementInvoiceAdj.Col1Amount, J).Value) & ""
                                End If

                                If mLedgerPostingData <> "" Then mLedgerPostingData += " UNION ALL "
                                If obj.Dgl1.Item(FrmClothSupplierSettlementInvoiceAdj.Col1AdditionDeduction, J).Value.ToString.ToUpper = "DEDUCTION" Then
                                    mLedgerPostingData += " Select " & AgL.Chk_Text(obj.Dgl1.Item(FrmClothSupplierSettlementInvoiceAdj.Col1PostingAc, J).Value) & " as Subcode, " & AgL.Chk_Text(TxtParty.Tag) & " as ContraAc, 0 as AmtDr, " & Val(obj.Dgl1.Item(FrmClothSupplierSettlementInvoiceAdj.Col1Amount, J).Value) & " as AmtCr, '" & mNarration & "' as Narration, Null ChqNo, Null ChqDate  "
                                    mTotalAmount += Val(obj.Dgl1.Item(FrmClothSupplierSettlementInvoiceAdj.Col1Amount, J).Value)
                                Else
                                    mLedgerPostingData += " Select " & AgL.Chk_Text(obj.Dgl1.Item(FrmClothSupplierSettlementInvoiceAdj.Col1PostingAc, J).Value) & " as Subcode, " & AgL.Chk_Text(TxtParty.Tag) & " as ContraAc, " & Val(obj.Dgl1.Item(FrmClothSupplierSettlementInvoiceAdj.Col1Amount, J).Value) & " as AmtDr, 0 as AmtCr, '" & mNarration & "' as Narration, Null ChqNo, Null ChqDate  "
                                    mTotalAmount -= Val(obj.Dgl1.Item(FrmClothSupplierSettlementInvoiceAdj.Col1Amount, J).Value)
                                End If
                            End If
                        Next
                    ...
                    If Val(Dgl2.Item(Col2ItemDeductions, I).Value) > 0 Then
                        ...
                        mLedgerPostingData += " Select " & AgL.Chk_Text(DtSettings.Rows(0)("ItemDeductionPostingAc")) & " as Subcode, " & AgL.Chk_Text(TxtParty.Tag) & " as ContraAc, 0 as AmtDr, " & Val(Dgl2.Item(Col2ItemDeductions, I).Value) & " as AmtCr, '" & mNarration & "', Null ChqNo, Null ChqDate "
            ...
            If Dgl3.Item(Col3PaymentNo, I).Value <> "" Then
                If Dgl3.Item(ColSNo, I).Tag Is Nothing And Dgl3.Rows(I).Visible = True Then
                    If Dgl3.Item(Col3Select, I).Value = "þ" Then
                        mSr += 1
                        mQry = "Insert Into Cloth_SupplierSettlementPayments (DocID, Sr, PaymentDocID, PaymentDocIdSr, PaidAmount, AdjustedAmount)
                            Values ('" & mSearchCode & "', " & mSr & ",
        ...
        If TxtDrCr.Text = "Credit" Then
            mLedgerPostingData += " Select " & AgL.Chk_Text(TxtParty.Tag) & " as Subcode, Null as ContraAc, " & mTotalAmount & " as AmtDr, 0 as AmtCr, '" & mNarration & "' as Narration, Null as ChqNo, Null as ChqDate "
        Else
            mLedgerPostingData += " Select " & AgL.Chk_Text(TxtParty.Tag) & " as Subcode, Null as ContraAc, 0 as AmtDr, " & mTotalAmount & " as AmtCr, '" & mNarration & "' as Narration, Null as ChqNo, Null as ChqDate "
        End If


        mLedgerPostingData = "Select SubCode, ContraAc, Narration, Sum(AmtDr)*1.0 as AmtDr, Sum(AmtCr)*1.0 as AmtCr, ChqNo, ChqDate 
        ...
        If DtTemp.Rows.Count > 0 Then
            For I = 0 To DtTemp.Rows.Count - 1
                mQry = "INSERT INTO Ledger
                        ...
                        " & AgL.Chk_Text(AgL.XNull(DtTemp.Rows(I)("ChqNo"))) & "," & AgL.Chk_Text(AgL.XNull(DtTemp.Rows(I)("ChqDate"))) & "," & AgL.Chk_Text(AgL.XNull(DtTemp.Rows(I)("Narration"))) & "," & AgL.Chk_Text(TxtSite_Code.Tag) & "," & AgL.Chk_Text(TxtDivision.Tag) & ",
        ...
        If Val(LblDifferenceAmount.Text) > 0 Then
            ...
            AgL.Dman_ExecuteNonQry(mQry, Conn, Cmd)
                ...
                mQry = "Insert Into Ledger(DocId,RecId,V_SNo,V_Date,SubCode,ContraSub,AmtDr,AmtCr,
                          ...
                          ('" & StrDocID & "','" & mRecId & "',1," & AgL.Chk_Date(TxtV_Date.Text) & "," & AgL.Chk_Text(TxtParty.Tag) & "," & AgL.Chk_Text("SUSPENSE") & ", 
    ...
    Sub SaveFifoAdjustment(ByRef Conn As Object, ByRef Cmd As Object)
        ...
        mQry = "Select L.*, L.AmtDr+L.AmtCr as Amount,IfNull(Adj.AdjAmt,0) as AdjAmt, 0 as BalAmt, 
                ...
                Where L.V_Date <= " & AgL.Chk_Date(TxtV_Date.Text) & " And (L.DocId = '" & mSearchCode & "' 
        ...
        With DsTemp.Tables(0)
            If .Rows.Count > 0 Then
                ...
                If DsTemp.Tables(0).Rows.Count > 0 Then
                    TxtDifferenceJVDocNo.Text = AgL.XNull(DsTemp.Tables(0).Rows(0)("ReferenceDocID"))
                ...
                mQry = "Select L.*, IFNULL(Ledger.DivCode,'') || Ledger.Site_Code || '-' || Ledger.V_Type || '-' || Ledger.RecId As PaymentNo, Ledger.V_Date, cSg.Name as ContraName
                       ...
                       Left Join ledger on L.PaymentDocId = Ledger.DocID and L.Sr = Ledger.V_SNo
        ...
        For I = 0 To Dgl2.RowCount - 1
            If Dgl2.Rows(I).Visible Then
                If Val(Dgl2.Item(Col2InvoiceAmount, I).Value) > 0 Then
                    If Dgl2.Item(Col2Select, I).Value = "þ" Then
                        If Dgl2.Item(Col2BtnAdjDetail, I).Tag IsNot Nothing Then
                            CType(Dgl2.Item(Col2BtnAdjDetail, I).Tag, FrmClothSupplierSettlementInvoiceAdj).Calculation()
                            Dgl2.Item(Col2SettlementAddition, I).Value = CType(Dgl2.Item(Col2BtnAdjDetail, I).Tag, FrmClothSupplierSettlementInvoiceAdj).GetAdditions
                            Dgl2.Item(Col2SettlementDeduction, I).Value = CType(Dgl2.Item(Col2BtnAdjDetail, I).Tag, FrmClothSupplierSettlementInvoiceAdj).GetDeductions
                        End If
        ...
        For I = 0 To Dgl3.RowCount - 1
            If Dgl3.Rows(I).Visible Then
                If Val(Dgl3.Item(Col3Amount, I).Value) > 0 Then
                    If Dgl3.Item(Col3Select, I).Value = "þ" Then
                        LblPaidAmt.Text = Val(LblPaidAmt.Text) + Val(Dgl3.Item(Col3Amount, I).Value)
                    End If
                End If
            End If
        Next
    ...
    Private Sub FCreateHelpSubgroupLine()
        ...
        If DtV_TypeSettings.Rows.Count > 0 Then
            If AgL.XNull(DtV_TypeSettings.Rows(0)("FilterInclude_SubgroupTypeLine")) <> "" Then
                strCond += " And CharIndex('+' || Sg.SubgroupType,'" & AgL.XNull(DtV_TypeSettings.Rows(0)("FilterInclude_SubgroupTypeLine")) & "') > 0 "
                strCond += " And CharIndex('-' || Sg.SubgroupType,'" & AgL.XNull(DtV_TypeSettings.Rows(0)("FilterInclude_SubgroupTypeLine")) & "') <= 0 "
            End If
    ...
    Private Sub ShowSupplierSattlementAdjustment(mRow As Integer, Optional ShowDialog As Boolean = True)
        If Dgl2.Item(Col2BtnAdjDetail, mRow).Tag IsNot Nothing Then
            CType(Dgl2.Item(Col2BtnAdjDetail, mRow).Tag, FrmClothSupplierSettlementInvoiceAdj).InvoiceNo = Dgl2.Item(Col2InvoiceNo, mRow).Value & "        Dated : " & Dgl2.Item(Col2InvoiceDate, mRow).Value
            CType(Dgl2.Item(Col2BtnAdjDetail, mRow).Tag, FrmClothSupplierSettlementInvoiceAdj).InvoiceDocID = Dgl2.Item(Col2InvoiceNo, mRow).Tag
            CType(Dgl2.Item(Col2BtnAdjDetail, mRow).Tag, FrmClothSupplierSettlementInvoiceAdj).EntryMode = Topctrl1.Mode
            If ShowDialog Then Dgl2.Item(Col2BtnAdjDetail, mRow).Tag.ShowDialog()
            Dgl2.Item(Col2SettlementAddition, mRow).Value = CType(Dgl2.Item(Col2BtnAdjDetail, mRow).Tag, FrmClothSupplierSettlementInvoiceAdj).GetAdditions
            Dgl2.Item(Col2SettlementDeduction, mRow).Value = CType(Dgl2.Item(Col2BtnAdjDetail, mRow).Tag, FrmClothSupplierSettlementInvoiceAdj).GetDeductions
        Else

            Dim FrmObj As FrmClothSupplierSettlementInvoiceAdj
            FrmObj = New FrmClothSupplierSettlementInvoiceAdj
    ...
    Private Sub ShowSupplierSattlementInvoiceLines(mRow As Integer, Optional ShowDialog As Boolean = True)
        If Dgl2.Item(Col2BtnItemDetail, mRow).Tag IsNot Nothing Then
            CType(Dgl2.Item(Col2BtnItemDetail, mRow).Tag, FrmClothSupplierSettlementInvoiceLine).InvoiceNo = Dgl2.Item(Col2InvoiceNo, mRow).Value & "        Dated : " & Dgl2.Item(Col2InvoiceDate, mRow).Value
            CType(Dgl2.Item(Col2BtnItemDetail, mRow).Tag, FrmClothSupplierSettlementInvoiceLine).EntryMode = Topctrl1.Mode
            If ShowDialog Then Dgl2.Item(Col2BtnItemDetail, mRow).Tag.ShowDialog()
            Dgl2.Item(Col2ItemDeductions, mRow).Value = CType(Dgl2.Item(Col2BtnItemDetail, mRow).Tag, FrmClothSupplierSettlementInvoiceLine).GetDeductions
        Else

            Dim FrmObj As FrmClothSupplierSettlementInvoiceLine
            FrmObj = New FrmClothSupplierSettlementInvoiceLine
            FrmObj.InvoiceNo = Dgl2.Item(Col2InvoiceNo, mRow).Value & "        Dated : " & Dgl2.Item(Col2InvoiceDate, mRow).Value
    ...
    Private Sub InsertLedgerHead(LedgerHeadTableList As StructLedgerHead(),
        ...
        If LedgerHeadTableList(0).V_Type IsNot Nothing And LedgerHeadTableList(0).V_Type <> "" And SupplierSettlementPaymentsTableList.Length > 1 Then
            ...
            If LedgerHeadTableList(0).SalesTaxGroupParty Is Nothing Or LedgerHeadTableList(0).SalesTaxGroupParty = "" Or
                LedgerHeadTableList(0).SalesTaxGroupParty = "Composition" Then
