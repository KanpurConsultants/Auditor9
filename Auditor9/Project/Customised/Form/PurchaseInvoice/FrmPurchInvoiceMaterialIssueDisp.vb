...
Public Class FrmPurchInvoiceMaterialIssueDisp
    Dim mQry As String = ""
    ...
    Private Sub ShowStockEntryDimensionDetail(mRow As Integer, Optional IsShowFrm As Boolean = True)
        ...
        Else
            If Dgl1.Item(Col1Unit, mRow).Tag Then
                Dim FrmObj As FrmPurchInvoiceMaterialssueDimensionDIsp
                FrmObj = New FrmPurchInvoiceMaterialssueDimensionDIsp
