...
Public Class FrmPurchaseInvoiceParty
    Dim mQry As String = ""
    ...
    Public Sub IniGrid(DocID As String, PartyCode As String, AcGroupNature As String)
        ...
        Dgl1.Item(Col1Head, rowStateCode).Value = "State Code"
        ...
        Try
            ...
            If PartyCode <> "" Then
                ...
                Else
                    ...
                    mQry = "SELECT H.DispName VendorName, H.Address as VendorAddress, H.CityCode as VendorCity, C.CityName, C.State, S.ManualCode as StateManualCode, H.Pin as VendorPincode, H.Mobile VendorMobile, 
                    SR.RegistrationNo VendorSalesTaxNo, H.SalesTaxPostingGroup
                    ...
                    With DtTemp
                        ...
                        If DtTemp.Rows.Count > 0 Then
                            Dgl1.Item(Col1Value, rowPartyName).Value = AgL.XNull(DtTemp.Rows(0)("VendorName"))
                            Dgl1.Item(Col1Value, rowAddress).Value = AgL.XNull(DtTemp.Rows(0)("VendorAddress"))
                            Dgl1.Item(Col1Value, rowCity).Value = AgL.XNull(DtTemp.Rows(0)("CityName"))
                            Dgl1.Item(Col1Value, rowCity).Tag = AgL.XNull(DtTemp.Rows(0)("VendorCity"))
                            ...
                            Dgl1.Item(Col1Value, rowPincode).Value = AgL.XNull(DtTemp.Rows(0)("VendorPincode"))
                            Dgl1.Item(Col1Value, rowMobile).Value = AgL.XNull(DtTemp.Rows(0)("VendorMobile"))
                            Dgl1.Item(Col1Value, rowSalesTaxGroup).Value = AgL.XNull(DtTemp.Rows(0)("SalesTaxPostingGroup"))
                            Dgl1.Item(Col1Value, rowSalesTaxNo).Value = AgL.XNull(.Rows(0)("VendorSalesTaxNo"))
                            Dgl1.Item(Col1Value, rowPlaceOfSupply).Value = ClsFunction.GetPlaceOfSupply(Dgl1.Item(Col1Value, rowCity).Tag, "")
                        End If
                    End With
                End If
            Else
                'BtnHeaderDetail.Tag = FunRetNewUnitConversionObject()
                'BtnHeaderDetail.Tag.Dgl1.Readonly = IIf(AgL.StrCmp(Topctrl1.Mode, "Browse"), True, False)
                mQry = "SELECT H.VendorName, H.VendorAddress, H.VendorCity, C.CityName, C.State, S.ManualCode as StateManualCode, H.VendorPincode, H.VendorMobile, 
                    H.VendorSalesTaxNo, H.SalesTaxGroupParty, H.PlaceOfSupply
    ...
    Public Sub FSave(ByVal SearchCode As String, ByVal Conn As Object, ByVal Cmd As Object)
        If Dgl1.Rows.Count > 0 Then
            ...
            mQry = "
                    Update PurchInvoice Set 
                    VendorName=" & AgL.Chk_Text(Dgl1.Item(Col1Value, rowPartyName).Value) & ",
                    VendorAddress=" & AgL.Chk_Text(Dgl1.Item(Col1Value, rowAddress).Value) & ",
                    VendorCity=" & AgL.Chk_Text(Dgl1.Item(Col1Value, rowCity).Tag) & ",
                    VendorState=" & AgL.Chk_Text(Dgl1.Item(Col1Value, rowStateCode).Tag) & ",
                    VendorPincode=" & AgL.Chk_Text(Dgl1.Item(Col1Value, rowPincode).Value) & ",
                    VendorMobile=" & AgL.Chk_Text(Dgl1.Item(Col1Value, rowMobile).Value) & ",
                    ...
                    VendorSalesTaxNo=" & AgL.Chk_Text(Dgl1.Item(Col1Value, rowSalesTaxNo).Value) & "
