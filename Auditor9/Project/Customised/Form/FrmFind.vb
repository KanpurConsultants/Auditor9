...
Public Class frmFind
    ...
    Dim FindCmd As New SQLite.SQLiteCommand
    Dim FindTrans As SQLite.SQLiteTransaction
    Dim fld As String
    ...
    Private Sub frmFind_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Dim i As Int16, j As Int16 = 0, k As Int16      '' For Loop
        ...
        Try
            ...
            ' Dim selSq As String
            Try
                FindTrans = GcnTrans.BeginTransaction(IsolationLevel.Serializable)
                FindCmd.Transaction = FindTrans
                FindCmd.Connection = GcnTrans
            ...
            Try
                ...
                End If
                DTFind = AgL.FillData(StSql, GcnTrans)
    ...
    Private Sub GrdFind_DoubleClick(ByVal sender As Object, ByVal e As System.EventArgs) Handles GrdFind.DoubleClick
        AgL.PubSearchRow = GrdFind.Item(0, GrdFind.CurrentCell.RowIndex).Value
        AgL.PubFindQryOrdBy = ""
        mFlag = True
        Me.Close()
    End Sub
    ...
    Private Sub GrdFind_PreviewKeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.PreviewKeyDownEventArgs) Handles GrdFind.PreviewKeyDown
        Try
            If e.Control = True Then
                ...
                End Select
            End If
            If e.KeyCode = Keys.Delete Then TextBox1.Text = "" : GrdFind.CurrentCell = GrdFind(fld, 0)
            If e.KeyCode = Keys.Left Then TextBox1.Text = ""
            If e.KeyCode = Keys.Right Then TextBox1.Text = ""
            If e.KeyCode = Keys.Up Then TextBox1.Text = ""
            If e.KeyCode = Keys.Down Then TextBox1.Text = ""
        Catch ex As Exception
        End Try
    End Sub
    ...
    Private Function RowsFilter(ByVal selStr As String, ByVal CtrlObj As Object, ByVal TXT As TextBox, ByVal e As System.Windows.Forms.KeyPressEventArgs, ByVal FndFldName As String, ByVal DTable As DataTable) As Int16
        Try
            Dim strExpr As String, findStr As String
            Dim sa As String
            Dim IntRow As Int16
            Dim i As Int16
            sa = TXT.Text
            ...
            dtt = AgL.FillData(selStr, GcnTrans)
    ...
    Private Sub FilterSameRec()
        Try
            ...
            Dim FdVal As String, i As Int16
            ...
            End If
            dtFilter = AgL.FillData(HlpSt, GcnTrans)
    ...
    Private Sub FilterNotSameRec()
        Try
            Dim dtFilter As New DataTable, i As Int16
            ...
            For I = 0 To DataGrid.Columns.Count - 1
                ...
                For iRow = 0 To NumberOfRowsToScan - 1
                    If Not IsDBNull(DataGrid.Item(I, iRow).Value) Then
                        Width = System.Math.Max(Width, Graphics.MeasureString(DataGrid.Item(I, iRow).Value, DataGrid.Font).Width)
                    End If
                Next
                Width = Width + 4
