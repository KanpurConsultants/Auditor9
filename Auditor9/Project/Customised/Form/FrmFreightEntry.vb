...
Public Class FrmFreightEntry
    ...
    Public WithEvents TxtPaymentMode As AgControls.AgTextBox
...
#Region "Form Designer Code"
    Private Sub InitializeComponent()
        ...
        Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(FrmFreightEntry))
        ...
        Me.LblPartyName.Size = New System.Drawing.Size(82, 14)
        Me.LblPartyName.TabIndex = 693
        Me.LblPartyName.Text = "Freight A/c"
        '
        'PnlTotals
        '
        ...
        Me.Pnl1.Location = New System.Drawing.Point(4, 174)
        Me.Pnl1.Name = "Pnl1"
        Me.Pnl1.Size = New System.Drawing.Size(973, 211)
        Me.Pnl1.TabIndex = 7
        '
        'PnlCustomGrid
        '
        Me.PnlCustomGrid.Location = New System.Drawing.Point(810, 51)
        ...
        Me.LinkLabel1.Location = New System.Drawing.Point(4, 153)
        ...
        Me.LblCurrentBalance.Location = New System.Drawing.Point(379, 157)
        ...
        Me.BtnFillPartyDetail.Location = New System.Drawing.Point(843, 41)
        ...
        Me.Label3.Location = New System.Drawing.Point(261, 157)
        ...
        'MnuOptions
        '
        Me.MnuOptions.Items.AddRange(New System.Windows.Forms.ToolStripItem() {Me.MnuImportFromExcel, Me.MnuImportGSTDataFromDos, Me.MnuImportGSTDataFromExcel, Me.MnuImportFromTally, Me.MnuImportFromDos, Me.MnuEditSave, Me.MnuCancelEntry, Me.MnuReport})
        ...
        Me.Label5.Location = New System.Drawing.Point(363, 49)
        Me.Label5.Name = "Label5"
        Me.Label5.Size = New System.Drawing.Size(10, 7)
        Me.Label5.TabIndex = 741
        Me.Label5.Text = "Ä"
        '
        'TxtPaymentMode
        '
        Me.TxtPaymentMode.AgAllowUserToEnableMasterHelp = False
        Me.TxtPaymentMode.AgLastValueTag = Nothing
        Me.TxtPaymentMode.AgLastValueText = Nothing
        Me.TxtPaymentMode.AgMandatory = True
        ...
        Me.TxtPaymentMode.Font = New System.Drawing.Font("Verdana", 9.75!, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, CType(0, Byte))
        Me.TxtPaymentMode.Location = New System.Drawing.Point(380, 44)
        Me.TxtPaymentMode.MaxLength = 0
        Me.TxtPaymentMode.Name = "TxtPaymentMode"
        Me.TxtPaymentMode.Size = New System.Drawing.Size(414, 16)
        Me.TxtPaymentMode.TabIndex = 4
        '
        'Label6
        '
...
#End Region
    ...
    Private Sub FrmSaleOrder_BaseFunction_IniGrid() Handles Me.BaseFunction_IniGrid
        ...
        With AgCL
            ...
            .AddAgTextColumn(Dgl1, Col1HSN, 150, 255, Col1HSN, True, False)
        ...
        Dgl2.Anchor = AnchorStyles.Bottom + AnchorStyles.Left
    ...
    Private Sub FrmSaleOrder_BaseEvent_Save_InTrans(ByVal SearchCode As String, ByVal Conn As Object, ByVal Cmd As Object) Handles Me.BaseEvent_Save_InTrans
        ...
        mQry = " Update LedgerHead " &
                    ...
                    " PaymentMode = " & AgL.Chk_Text(TxtPaymentMode.Tag) & ", " &
        ...
        For I = 0 To Dgl1.RowCount - 1
            If Dgl1.Item(Col1Qty, I).Value <> "" Then
        ...
        If bSelectionQry <> "" Then
            mQry = "Insert Into LedgerHeadDetail(DocId, Sr, Subcode, LinkedSubcode, Barcode, Specification, SalesTaxGroupItem, " &
                       " Qty, Unit, Rate, Amount, ChqRefNo, ChqRefDate, HSN, Remarks, " &
    ...
    Sub PostGridToAccounts(DocID As String, MultiplyWithMinus As Boolean, ByRef Conn As Object, ByRef Cmd As Object)
        ...
        Dim mPaymentModeAc As String = ""
        Dim mPaymentModeAcName As String = ""
        Dim mSr As Integer = 3

        mSr = AgL.VNull(AgL.Dman_Execute("Select Max(V_SNo) As Sr
                            From Ledger With (NoLock)
                            Where DocId = '" & DocID & "'", IIf(AgL.PubServerName = "", AgL.GCn, AgL.GcnRead)).ExecuteScalar())
        ...
        For I = 0 To Dgl1.Rows.Count - 1
            If Dgl1.Rows(I).Visible = True And Val(Dgl1(Col1Amount, I).Value) <> 0 Then

                mSr += 1
                If mLedgerPostingData <> "" Then mLedgerPostingData += " UNION ALL "
                mNarration = TxtV_Type.Text & " : " & TxtPartyName.Text & IIf(Dgl1(Col1Specification, I).Value <> "", " L.R. No. " & Dgl1(Col1Specification, I).Value, "") & ". " & Dgl1(Col1Remark, I).Value
                mLedgerPostingData += " Select  " & mSr & " as Sr, " & AgL.Chk_Text(Dgl1(Col1Subcode, I).Tag) & " as Subcode, " & AgL.Chk_Text(Dgl1(Col1LinkedSubcode, I).Tag) & " as LinkedSubcode, " & AgL.Chk_Text(TxtPartyName.Tag) & "  as ContraAc, " & IIf(mHeaderAccountDrCr.ToUpper = "CR", Val(Dgl1(Col1Amount, I).Value), 0) & " as AmtDr, " & IIf(mHeaderAccountDrCr.ToUpper = "DR", Val(Dgl1(Col1Amount, I).Value), 0) & " as AmtCr, " & AgL.Chk_Text(mNarration) & " as Narration, " & AgL.Chk_Text(Dgl1(Col1ChqRefNo, I).Value) & " as ChqNo, " & AgL.Chk_Date(Dgl1(Col1ChqRefDate, I).Value) & " as ChqDate, " & AgL.Chk_Date(Dgl1(Col1EffectiveDate, I).Value) & " as EffectiveDate "

                mSr += 1
                If mLedgerPostingData <> "" Then mLedgerPostingData += " UNION ALL "
                mNarration = TxtV_Type.Text & " : " & Dgl1(Col1Subcode, I).Value & IIf(Dgl1(Col1Specification, I).Value <> "", " L.R. No. " & Dgl1(Col1Specification, I).Value, "") & ". " & Dgl1(Col1Remark, I).Value
                mLedgerPostingData += " Select " & mSr & " as Sr, " & AgL.Chk_Text(TxtPartyName.Tag) & " as Subcode, Null as LinkedSubcode, " & AgL.Chk_Text(Dgl1(Col1Subcode, I).Tag) & "  as ContraAc, " & IIf(mHeaderAccountDrCr.ToUpper = "DR", Val(Dgl1(Col1Amount, I).Value), 0) & " as AmtDr, " & IIf(mHeaderAccountDrCr.ToUpper = "CR", Val(Dgl1(Col1Amount, I).Value), 0) & " as AmtCr, " & AgL.Chk_Text(mNarration) & " as Narration, " & AgL.Chk_Text(Dgl1(Col1ChqRefNo, I).Value) & " as ChqNo, " & AgL.Chk_Date(Dgl1(Col1ChqRefDate, I).Value) & " as ChqDate, " & AgL.Chk_Date(Dgl1(Col1EffectiveDate, I).Value) & " as EffectiveDate "
            End If
        Next
        ...
        mLedgerPostingData = "Select Sr, SubCode, LinkedSubcode, ContraAc, Narration, AmtDr*1.0 as AmtDr, AmtCr*1.0 as AmtCr, ChqNo, ChqDate, EffectiveDate 
                              From (" & mLedgerPostingData & ") as X  Order By X.Sr"
        ...
        If DtTemp.Rows.Count > 0 Then
            For I = 0 To DtTemp.Rows.Count - 1
                mQry = "INSERT INTO Ledger
                        ...
                        U_Name, U_EntDt, U_AE)
                        VALUES('" & DocID & "', " & AgL.VNull(DtTemp.Rows(I)("Sr")) & ", " & Val(TxtV_No.Text) & ", " & AgL.Chk_Text(TxtV_Type.Tag) & ", " & AgL.Chk_Text(TxtReferenceNo.Text) & ", " & AgL.Chk_Text(LblPrefix.Text) & ",
        ...
        mLedgerPostingData = mLedgerPostingData.Replace("Order By X.Sr", "")

        mQry = "SELECT PM.PostToAc, Sg.Name  
                FROM PaymentModeAccount PM With (NoLock) 
                Left Join Subgroup Sg With (NoLock) On PM.PostToAc = Sg.Subcode
                WHERE PaymentMode ='" & TxtPaymentMode.Tag & "' 
                AND IfNull(PM.Site_Code, '" & TxtSite_Code.Tag & "') ='" & TxtSite_Code.Tag & "' 
                AND IfNull(PM.Div_Code,'" & TxtDivision.Tag & "' ) ='" & TxtDivision.Tag & "' 
                And PM.PostToAc Is Not Null"
        DtTemp = AgL.FillData(mQry, IIf(AgL.PubServerName = "", Conn, AgL.GcnRead)).Tables(0)
        If DtTemp.Rows.Count > 0 Then
            mPaymentModeAc = DtTemp.Rows(0)("PostToAc")
            mPaymentModeAcName = DtTemp.Rows(0)("Name")

            mLedgerPostingData = "Select X.SubCode, X.LinkedSubcode, Null as ContraAc, Null as Narration, Sum(X.AmtDr*1.0) as AmtCr, Sum(X.AmtCr*1.0) as AmtDr, X.ChqNo, X.ChqDate ChqDate, X.EffectiveDate, Max(Sg.Name) as SubcodeName 
                              From (" & mLedgerPostingData & ") as X 
                              Left Join Subgroup Sg On X.Subcode = Sg.Subcode
                              Where X.Subcode <> '" & TxtPartyName.Tag & "'  
                              Group By X.SubCode, X.LinkedSubcode, X.ChqNo, X.ChqDate, X.EffectiveDate
                              Order By Max(X.Sr)"
            DtTemp = AgL.FillData(mLedgerPostingData, IIf(AgL.PubServerName = "", Conn, AgL.GcnRead)).Tables(0)
            If DtTemp.Rows.Count > 0 Then
                For I = 0 To DtTemp.Rows.Count - 1
                    ...
                    mNarration = TxtV_Type.Text & " : Paid in " & mPaymentModeAcName
                    mQry = "INSERT INTO Ledger
                        (DocId, V_SNo, V_No, V_Type, RecID, V_Prefix, 
                        V_Date, SubCode, LinkedSubcode, ContraSub, AmtDr, AmtCr, 
                        Chq_No, Chq_Date, EffectiveDate, Narration, Site_Code, DivCode, 
                        U_Name, U_EntDt, U_AE)
                        VALUES('" & DocID & "', " & mSr & ", " & Val(TxtV_No.Text) & ", " & AgL.Chk_Text(TxtV_Type.Tag) & ", " & AgL.Chk_Text(TxtReferenceNo.Text) & ", " & AgL.Chk_Text(LblPrefix.Text) & ",
                        " & AgL.Chk_Date(TxtV_Date.Text) & ", " & AgL.Chk_Text(AgL.XNull(DtTemp.Rows(I)("Subcode"))) & ", " & AgL.Chk_Text(AgL.XNull(DtTemp.Rows(I)("LinkedSubcode"))) & ", " & AgL.Chk_Text(mPaymentModeAc) & ", " & Val(AgL.VNull(DtTemp.Rows(I)("AmtDr"))) & ", " & Val(AgL.VNull(DtTemp.Rows(I)("AmtCr"))) & ",
                        " & AgL.Chk_Text(AgL.XNull(DtTemp.Rows(I)("ChqNo"))) & "," & AgL.Chk_Text(AgL.XNull(DtTemp.Rows(I)("ChqDate"))) & "," & AgL.Chk_Text(AgL.XNull(DtTemp.Rows(I)("EffectiveDate"))) & "," & AgL.Chk_Text(mNarration) & "," & AgL.Chk_Text(TxtSite_Code.Tag) & "," & AgL.Chk_Text(TxtDivision.Tag) & ",
                        " & AgL.Chk_Text(AgL.PubUserName) & ", " & AgL.Chk_Date(AgL.PubLoginDate) & ", 'A'
                        )"
                    AgL.Dman_ExecuteNonQry(mQry, Conn, Cmd)
                    ...
                    mSr += 1
                    mNarration = TxtV_Type.Text & " : Payment of " & AgL.XNull(DtTemp.Rows(I)("SubcodeName"))
                    mQry = "INSERT INTO Ledger
                        (DocId, V_SNo, V_No, V_Type, RecID, V_Prefix, 
                        V_Date, SubCode, LinkedSubcode, ContraSub, AmtCr, AmtDr,
                        Chq_No, Chq_Date, EffectiveDate, Narration, Site_Code, DivCode, 
                        U_Name, U_EntDt, U_AE)
                        VALUES('" & DocID & "', " & mSr & ", " & Val(TxtV_No.Text) & ", " & AgL.Chk_Text(TxtV_Type.Tag) & ", " & AgL.Chk_Text(TxtReferenceNo.Text) & ", " & AgL.Chk_Text(LblPrefix.Text) & ",
                        " & AgL.Chk_Date(TxtV_Date.Text) & ", " & AgL.Chk_Text(mPaymentModeAc) & ", Null, " & AgL.Chk_Text(AgL.XNull(DtTemp.Rows(I)("Subcode"))) & ", " & Val(AgL.VNull(DtTemp.Rows(I)("AmtDr"))) & ", " & Val(AgL.VNull(DtTemp.Rows(I)("AmtCr"))) & ",
                        " & AgL.Chk_Text(AgL.XNull(DtTemp.Rows(I)("ChqNo"))) & "," & AgL.Chk_Text(AgL.XNull(DtTemp.Rows(I)("ChqDate"))) & "," & AgL.Chk_Text(AgL.XNull(DtTemp.Rows(I)("EffectiveDate"))) & "," & AgL.Chk_Text(mNarration) & "," & AgL.Chk_Text(TxtSite_Code.Tag) & "," & AgL.Chk_Text(TxtDivision.Tag) & ",
                        " & AgL.Chk_Text(AgL.PubUserName) & ", " & AgL.Chk_Date(AgL.PubLoginDate) & ", 'A'
                        )"
                    AgL.Dman_ExecuteNonQry(mQry, Conn, Cmd)
    ...
    Sub PostStructureLineToAccounts(ByVal FGMain As AgStructure.AgCalcGrid, ByVal mNarrParty As String, ByVal mNarr As String, ByVal mDocID As String, ByVal mDiv_Code As String,
    ...
    Private Sub FrmSaleOrder_BaseFunction_MoveRec(ByVal SearchCode As String) Handles Me.BaseFunction_MoveRec
        ...
        mQry = " Select H.*, Sg.Name as AccountName, Sg.Nature, VT.Category as VoucherCategory, PM.Description as PaymentModeDesc, HC.*                                 
        ...
        With DsTemp.Tables(0)
            If .Rows.Count > 0 Then
                ...
                TxtPaymentMode.Tag = AgL.XNull(.Rows(0)("PaymentMode"))
                TxtPaymentMode.Text = AgL.XNull(.Rows(0)("PaymentModeDesc"))
    ...
    Private Sub ValidateSubcodeLine(mRowIndex As Integer)
        ...
        If Dgl1.Columns(Col1LinkedSubcode).Visible Then
            ...
            For I = 0 To .Rows.Count - 1
                If .Item(Col1Subcode, I).Value <> "" Then
                    ...
                    If Dgl1.Columns(Col1Qty).Visible = True Then
                        If Val(.Item(Col1Qty, I).Value) = 0 And Val(.Item(Col1Amount, I).Value) > 0 Then
    ...
    Private Sub TxtBuyer_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles TxtPartyName.KeyDown, TxtPaymentMode.KeyDown
        Try
                    ...
                    If e.KeyCode <> Keys.Enter Then
                        If sender.AgHelpDataset Is Nothing Then
                            mQry = " Select H.Code, H.Description 
                                     From PaymentMode H 
                                     Left Join PaymentModeAccount L On H.Code = L.PaymentMode
                                     Left Join Subgroup Sg On L.PostToAc = Sg.Subcode    
                                     Where Sg.Nature = 'Cash'
                                     And IfNull(L.Site_Code,'" & TxtSite_Code.Tag & "') = '" & TxtSite_Code.Tag & "' 
                                     And IfNull(L.Div_Code,'" & TxtDivision.Tag & "') = '" & TxtDivision.Tag & "'
                                     Union All Select H.Code, H.Description From PaymentMode H Where H.Code = 'Credit'
                                   "
                ...
                Case Col1Subcode
                    If Dgl1.CurrentCell.RowIndex > 0 Then
                        If Dgl1.Item(Col1Subcode, Dgl1.CurrentCell.RowIndex).Value = "" Then
                            If Dgl1.Item(Col1Subcode, Dgl1.CurrentCell.RowIndex - 1).Value <> "" Then
    ...
    Private Sub FrmCarpetMaterialPlan_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If EntryNCat = Ncat.Receipt Then
    ...
    Private Sub FrmLedgerHead_BaseEvent_Topctrl_tbRef() Handles Me.BaseEvent_Topctrl_tbRef
        ...
        If TxtPaymentMode.AgHelpDataSet IsNot Nothing Then TxtPaymentMode.AgHelpDataSet.Dispose() : TxtPaymentMode.AgHelpDataSet = Nothing
    End Sub
        ...
        Try
            With Dgl1
                For I = 0 To .Rows.Count - 1
                    If .Item(Col1Subcode, I).Value <> "" Then
                        If mRow <> I Then
                            If AgL.StrCmp(.Item(Col1Subcode, I).Value & .Item(Col1Specification, I).Value, .Item(Col1Subcode, mRow).Value & .Item(Col1Specification, mRow).Value) Then
                                MsgBox("Item " & .Item(Col1Subcode, I).Value & " Is Already Feeded At Row No " & .Item(ColSNo, I).Value & "")
                                Dgl1.Item(Col1Specification, mRow).Tag = "" : Dgl1.Item(Col1Specification, mRow).Value = ""
                                .CurrentCell = .Item(Col1Specification, mRow) : Dgl1.Focus()
                            End If
                        End If
                    End If
                Next
    ...
    Private Sub FCreateHelpReferenceNoDebitNote()
        ...
        If Dgl1.AgHelpDataSet(Col1Specification) Is Nothing Then
            ...
            If TxtVoucherCategory.Text.ToUpper = "PURCH" Then
                mCondStr = " And L.AmtCr > 0 "
            Else
                mCondStr = " And L.AmtDr > 0 "
            End If

            mQry = "select L.DocID || '+' || Cast(L.V_SNo as nVarchar) as SearchKey, L.DivCode || L.Site_Code || '-' || L.V_Type || '-' ||  L.RecId as InvoiceNo, L.V_Date, I.Description as ItemName, S.Qty_Rec + S.Qty_Iss as Qty, S.Rate
                from Ledger L  With (NoLock)
                Left Join Stock S  With (NoLock) On L.DocID = S.DocId
                Left Join Item I  With (NoLock) On S.Item = I.Code
                Left Join viewHelpSubgroup Sg  With (NoLock) On L.Subcode = Sg.Code
                where DivCode='" & AgL.PubDivCode & "' And  L.Subcode = '" & TxtPartyName.Tag & "' And Date(L.V_Date)<=" & AgL.Chk_Date(CDate(TxtV_Date.Text).ToString("s")) & " 
    ...
    Private Sub Dgl1_RowEnter(sender As Object, e As DataGridViewCellEventArgs) Handles Dgl1.RowEnter
        ...
        End If
    End Sub
    Private Sub MnuImport_Click(sender As Object, e As EventArgs) Handles MnuImportFromExcel.Click, MnuImportFromDos.Click, MnuImportFromTally.Click, MnuEditSave.Click, MnuCancelEntry.Click, MnuImportGSTDataFromExcel.Click, MnuImportGSTDataFromDos.Click, MnuReport.Click
        Select Case sender.name
    ...
    Public Sub FImportFromExcel(bImportFor As ImportFor)
        ...
        If bImportFor = ImportFor.Dos Then
            ...
            Dim DtLedgerRows_Filtered As DataRow() = DtLedger.Select("[" & GetFieldAliasName(bImportFor, "V_Type") & "] In ('ZD','ZC','ZH','PR','MP') 
            ...
            For I = 0 To DtLedger.Rows.Count - 1
                ...
                If DtLedger.Rows(I)(GetFieldAliasName(bImportFor, "V_Type")).ToString.Trim = "ZD" Then
    ...
    Public Shared Sub FGetCalculationData(mSearchCode As String, Conn As Object, Cmd As Object)
        ...
        ClsMain.PostStructureLineToAccounts(DtCalcHeaderData, DtCalcLineData, mNarrationParty, mNarration, mSearchCode, AgL.XNull(DtTransactionDetail.Rows(0)("Div_Code")),
                                    ...
                                    AgL.XNull(DtTransactionDetail.Rows(0)("V_Date")), Conn, Cmd,, mMultiplyWithMinus)
    End Sub
