...
Public Class FrmSaleInvoiceReturn_Aadhat
    ...
    Public ColSNo As String = "S.No."
    Public Col1ImportStatus As String = "Import Status"
    Public Col1V_Nature As String = "V_Nature"
    Public Col1Barcode As String = "Barcode"
    Public Col1ItemCategory As String = "Item Category"
    Public Col1ItemGroup As String = "Item Group"
    Public Col1ItemCode As String = "Item Code"
    Public Col1ItemType As String = AgL.PubCaptionItemType
    Public Col1Item As String = "Item"
    Public Col1Dimension1 As String = "Dimension1"
    Public Col1Dimension2 As String = "Dimension2"
    Public Col1Dimension3 As String = "Dimension3"
    Public Col1Dimension4 As String = "Dimension4"
    Public Col1Specification As String = "Specification"
    Public Col1SalesTaxGroup As String = "Sales Tax Group Item"
    Public Col1SalesTaxGroup_BaseRate As String = "Sales Tax Group Item Base Rate"
    Public Col1BaleNo As String = "Bale No"
    Public Col1LotNo As String = "Lot No"
    Public Col1DocQty As String = "Doc Qty"
    Public Col1FreeQty As String = "Free Qty"
    Public Col1Qty As String = "Qty"
    Public Col1Unit As String = "Unit"
    Public Col1QtyDecimalPlaces As String = "Qty Decimal Places"
    Public Col1Pcs As String = "Pcs"
    Public Col1UnitMultiplier As String = "Unit Multiplier"
    Public Col1DealQty As String = "Deal Qty"
    Public Col1DealUnit As String = "Deal Unit"
    Public Col1DealUnitDecimalPlaces As String = "Deal Decimal Places"
    Public Col1Rate As String = "Rate"
    Public Col1DiscountPer As String = "Disc. %"
    Public Col1DiscountAmount As String = "Disc. Amt"
    Public Col1AdditionalDiscountPer As String = "Add. Disc. %"
    Public Col1AdditionalDiscountAmount As String = "Add. Disc. Amt"
    Public Col1AdditionPer As String = "Addition %"
    Public Col1AdditionAmount As String = "Addition Amt"
    Public Col1Amount As String = "Amount"
    Public Col1Remark As String = "Remark"
    Public Col1Godown As String = "Godown"
    Public Col1ReferenceNo As String = "Reference No"
    Public Col1ReferenceDocId As String = "Reference DocID"
    Public Col1ReferenceDocIdTSr As String = "Reference TSr"
    Public Col1ReferenceDocIdSr As String = "Reference Sr"
    Public Col1PurchaseRate As String = "Purchase Rate"
    Public Col1SaleInvoice As String = "Sale Invoice DocID"
    Public Col1SaleInvoiceSr As String = "Sale Invoice Sr"
    Public Col1DefaultDiscountPer As String = "Default Discount %"
    Public Col1DefaultAdditionalDiscountPer As String = "Default Additional Discount %"
    Public Col1DefaultAdditionPer As String = "Default Addition %"
    Public Col1PersonalDiscountPer As String = "Personal Discount %"
    Public Col1PersonalAdditionalDiscountPer As String = "Personal Additional Discount %"
    Public Col1PersonalAdditionPer As String = "Personal Addition %"
    Public Col1DiscountCalculationPattern As String = "Discount Calculation Pattern"
    Public Col1AdditionalDiscountCalculationPattern As String = "Additional Discount Calculation Pattern"
    Public Col1AdditionCalculationPattern As String = "Additional Calculation Pattern"
    Public Col1StockSr As String = "Stock Sr"
    Public Col1IsRecordLocked As String = "Is Record Locked"
    '========================================================================


    Public Col1PurchaseSalesTaxGroup As String = "Purchase Sales Tax Group Item"
    Public Col1PurchaseDiscountPer As String = "Purch Disc. %"
    Public Col1PurchaseDiscountAmount As String = "Purch Disc. Amt"
    Public Col1PurchaseAdditionalDiscountPer As String = "Purch Add. Disc. %"
    Public Col1PurchaseAdditionalDiscountAmount As String = "Purch Add. Disc. Amt"
    Public Col1PurchaseAmount As String = "Purch Amount"
    Public Col1PurchaseTaxableAmount As String = "Purch Taxable Amount"
    ...
    Public Const Col4PurchReturnNo As String = "Purch Return No"
    Public Const Col4PurchReturnDate As String = "Purch Return Date"
    ...
    Dim rowSupplier As Integer = 6
    Dim rowMasterSupplier As Integer = 7
    Dim rowReturnNo As Integer = 8
    Dim rowReturnDate As Integer = 9
    Dim rowPurchInvoiceNo As Integer = 10
    ...
    Public Const hcSupplier As String = "Supplier"
    Public Const hcMasterSupplier As String = "Master Supplier"
    Public Const hcReturnNo As String = "Purch Return No"
    Public Const hcReturnDate As String = "Purch Return Date"
    Public Const hcPurchaseInvoiceNo As String = "Purchase Invoice No"
...
#Region "Form Designer Code"
    Private Sub InitializeComponent()
        ...
        Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(FrmSaleInvoiceReturn_Aadhat))
        ...
        Me.TabControl1.Size = New System.Drawing.Size(992, 140)
        ...
        'Pnl2
        '
        Me.Pnl2.Location = New System.Drawing.Point(558, 0)
        Me.Pnl2.Name = "Pnl2"
        Me.Pnl2.Size = New System.Drawing.Size(422, 115)
        ...
        Me.Pnl3.Location = New System.Drawing.Point(558, 599)
        Me.Pnl3.Name = "Pnl3"
        Me.Pnl3.Size = New System.Drawing.Size(44, 14)
        ...
        Me.MaximizeBox = True
        Me.Name = "FrmSaleInvoiceReturn_Aadhat"
...
#End Region
    ...
    Private Sub FrmSaleOrder_BaseFunction_IniGrid() Handles Me.BaseFunction_IniGrid
        ...
        Dgl2.Item(Col1Head, rowSupplier).Value = hcSupplier
        Dgl2.Item(Col1Head, rowMasterSupplier).Value = hcMasterSupplier
        Dgl2.Item(Col1Head, rowReturnNo).Value = hcReturnNo
        Dgl2.Item(Col1Head, rowReturnDate).Value = hcReturnDate
        Dgl2.Item(Col1Head, rowPurchInvoiceNo).Value = hcPurchaseInvoiceNo
        Dgl2.Name = "Dgl2"
    ...
    Private Sub FrmSaleOrder_BaseEvent_Save_InTrans(ByVal SearchCode As String, ByVal Conn As Object, ByVal Cmd As Object) Handles Me.BaseEvent_Save_InTrans
        ...
        If EntryNCat = Ncat.SaleReturn Then
    ...
    Private Sub ApplyUISettings(NCAT As String)
        ...
        Try
            ...
            mQry = "Select H.*
                    ...
                    Where EntryName= 'FrmSaleInvoiceReturn_Aadhat'    And NCat = '" & NCAT & "' And GridName ='" & Dgl2.Name & "' "
    ...
    Private Sub FrmSaleOrder_BaseEvent_Data_Validation(ByRef passed As Boolean) Handles Me.BaseEvent_Data_Validation
        ...
        For I = 0 To Dgl4.Rows.Count - 1
            ...
            If Dgl4.Item(Col4PurchReturnDate, I).Value <> "" Then
                If DrVoucherTypeDateLock IsNot Nothing Then
                    If DrVoucherTypeDateLock.Length > 0 Then
                        If AgL.XNull(DrVoucherTypeDateLock(0)("LockTillDate")) <> "" Then
                            If CDate(Dgl4.Item(Col4PurchReturnDate, I).Value) <= CDate((AgL.XNull(DrVoucherTypeDateLock(0)("LockTillDate")))) Then
                ...
                If CDate(Dgl4.Item(Col4PurchReturnDate, I).Value) > CDate(AgL.PubLoginDate) And CDate(TxtV_Date.Text) > CDate(AgL.PubStartDate) Then
    ...
    Private Sub FCreateHelpItem(RowIndex As Integer)
        ...
        If Not AgL.VNull(AgL.PubDtEnviro.Rows(0)("ShowItemsOfOtherDivisions")) Then
            strCond += " And (Ig.Div_Code = '" & AgL.PubDivCode & "' Or IfNull(Ig.ShowItemInOtherDivisions,0) =1) "
        End If

        If Not AgL.VNull(AgL.PubDtEnviro.Rows(0)("ShowItemsOfOtherSites")) Then
            strCond += " And (Ig.Site_Code = '" & AgL.PubSiteCode & "' Or IfNull(Ig.ShowItemInOtherSites,0) =1) "
        End If
        ...
        strCond += " And I.ItemGroup In (SELECT Code FROM Item WHERE DefaultSupplier = '" & Dgl2.Item(Col1Value, rowMasterSupplier).Tag & "') "
    ...
    Private Sub FrmSaleInvoiceReturn_Aadhat_BaseEvent_Topctrl_tbEdit(ByRef Passed As Boolean) Handles Me.BaseEvent_Topctrl_tbEdit
        Dim DtTemp As DataTable
    ...
    Private Sub FrmSaleInvoiceReturn_Aadhat_BaseFunction_FIniList() Handles Me.BaseFunction_FIniList
    ...
    Private Sub Dgl2_CellEnter(sender As Object, e As DataGridViewCellEventArgs) Handles Dgl2.CellEnter
        Try
            ...
            Select Case Dgl2.CurrentCell.RowIndex
                Case rowPartyDocDate, rowReturnDate
                    ...
                    If e.KeyCode <> Keys.Enter Then
                        If Dgl2.Item(Col1Head, Dgl2.CurrentCell.RowIndex).Tag Is Nothing Then
                            mQry = "SELECT Sg.Code, Sg.Name FROM ViewHelpSubgroup Sg 
                                    WHERE Sg.SubgroupType = '" & SubgroupType.Supplier & "'"
                            Dgl2.Item(Col1Head, Dgl2.CurrentCell.RowIndex).Tag = AgL.FillData(mQry, AgL.GCn)
                        End If
    ...
    Private Sub Dgl2_EditingControl_Validating(sender As Object, e As CancelEventArgs) Handles Dgl2.EditingControl_Validating
        ...
        Select Case mRow
            Case rowSupplier
                mQry = " SELECT Sg.Parent, PSg.Name As ParentName  
                        FROM ViewHelpSubgroup Sg
                        LEFT JOIN ViewHelpSubgroup PSg On Sg.Parent = PSg.Code
                        WHERE Sg.Code = '" & Dgl2.Item(Col1Value, rowSupplier).Tag & "'"
                Dim DtSubGroup As DataTable = AgL.FillData(mQry, AgL.GCn).Tables(0)

                If DtSubGroup.Rows.Count > 0 Then
                    Dgl2.Item(Col1Value, rowMasterSupplier).Tag = AgL.XNull(DtSubGroup.Rows(0)("Parent"))
                    Dgl2.Item(Col1Value, rowMasterSupplier).Value = AgL.XNull(DtSubGroup.Rows(0)("ParentName"))
                    Dgl1.AgHelpDataSet(Col1Item) = Nothing
                End If
        End Select
    End Sub
    ...
    Private Sub BtnAttachments_Click(sender As Object, e As EventArgs) Handles BtnAttachments.Click
        Dim FrmObj As New AgLibrary.FrmAttachmentViewer()
    ...
    Public Sub Ini_Grid_Purchase()
        ...
        With AgCL
            ...
            .AddAgTextColumn(Dgl4, Col4PurchReturnNo, 100, 0, Col4PurchReturnNo, True, False)
            .AddAgDateColumn(Dgl4, Col4PurchReturnDate, 100, Col4PurchReturnDate, True, False)
    ...
    '    Dim FrmObj As New FrmSaleReturnInvoiceSummary
    '    FrmObj.StartPosition = FormStartPosition.CenterParent
    '    FrmObj.ShowDialog()
    '    Me.Tag = FrmObj
    ...
    Public Sub FLoadPurchaseDataFromSaleInvoice()
        ...
        For I = 0 To Dgl1.Rows.Count - 1
            If Dgl1.Item(Col1Item, I).Value <> "" Then
                ...
                FGetTaxRateForPurchase(Tax1_Per, Tax2_Per, Tax3_Per, PlaceOfSupply, bSalesTaxGroup,
                                       Dgl2.Item(Col1Value, rowSupplier).Tag)
                ...
                mQry = " INSERT INTO [#TempSaleInvoicePurchaseSummary](GrossAmount, TotalTax, Netamount) "
                mQry += " Select " & Val(Dgl1.Item(Col1PurchaseAmount, I).Value) & " As GrossAmount, 
        ...
        mQry = " Select Sum(H.GrossAmount) As GrossAmount,
        ...
        If DtTemp.Rows.Count > 0 Then
            ...
            For I = 0 To DtTemp.Rows.Count - 1
                ...
                Dgl4.Item(Col4PurchReturnNo, I).Value = Dgl2.Item(Col1Value, rowReturnNo).Value
                Dgl4.Item(Col4PurchReturnDate, I).Value = Dgl2.Item(Col1Value, rowReturnDate).Value
                Dgl4.Item(Col4ParentSupplier, I).Tag = Dgl2.Item(Col1Value, rowMasterSupplier).Tag
                Dgl4.Item(Col4ParentSupplier, I).Value = Dgl2.Item(Col1Value, rowMasterSupplier).Value
                Dgl4.Item(Col4Supplier, I).Tag = Dgl2.Item(Col1Value, rowSupplier).Tag
                Dgl4.Item(Col4Supplier, I).Value = Dgl2.Item(Col1Value, rowSupplier).Value
    ...
    Public Sub FPostPurchaseData(Conn As Object, Cmd As Object)
        ...
        For I = 0 To Dgl4.Rows.Count - 1
            ...
            PurchInvoiceTable.V_Date = Dgl4.Item(Col4PurchReturnDate, I).Value
            ...
            PurchInvoiceTable.VendorDocNo = Dgl4.Item(Col4PurchReturnNo, I).Value
            PurchInvoiceTable.VendorDocDate = Dgl4.Item(Col4PurchReturnDate, I).Value
            ...
            For J = 0 To DtTemp.Rows.Count - 1
                ...
                PurchInvoiceTable.Line_AdditionalDiscountAmount = Math.Abs(Math.Round(((PurchInvoiceTable.Line_Qty * PurchInvoiceTable.Line_Rate) - PurchInvoiceTable.Line_DiscountAmount) * PurchInvoiceTable.Line_AdditionalDiscountPer / 100, 2))
                ...
                mQry = "Select H.DocId, H.V_Date, H.VendorDocNo, L.Sr
                        From PurchInvoice H 
                        LEFT JOIN PurchInvoiceDetail L On H.DocId = L.DocId
                        Where H.GenDocId = '" & Dgl1.Item(Col1SaleInvoice, 0).Tag & "'
                        And L.Item = '" & AgL.XNull(DtTemp.Rows(J)("Item")) & "'"
                Dim DtPurchInvoiceDetail As DataTable = AgL.FillData(mQry, AgL.GCn).Tables(0)

                If DtPurchInvoiceDetail.Rows.Count > 0 Then
                    PurchInvoiceTable.Line_ReferenceDocId = AgL.XNull(DtPurchInvoiceDetail.Rows(0)("DocId"))
                    PurchInvoiceTable.Line_ReferenceSr = AgL.XNull(DtPurchInvoiceDetail.Rows(0)("Sr"))
                    PurchInvoiceTable.Line_ReferenceNo = AgL.XNull(DtPurchInvoiceDetail.Rows(0)("VendorDocNo"))
                    PurchInvoiceTable.Line_ReferenceDate = AgL.XNull(DtPurchInvoiceDetail.Rows(0)("V_Date"))
                    PurchInvoiceTable.Line_PurchInvoice = AgL.XNull(DtPurchInvoiceDetail.Rows(0)("DocId"))
                    PurchInvoiceTable.Line_PurchInvoiceSr = AgL.XNull(DtPurchInvoiceDetail.Rows(0)("Sr"))
                Else
                    mQry = "Select H.DocId, H.V_Date, H.VendorDocNo, L.Sr
                        From PurchInvoice H 
                        LEFT JOIN PurchInvoiceDetail L On H.DocId = L.DocId
                    ...
                    If DtPurchInvoiceDetail.Rows.Count > 0 Then
                        ...
                        PurchInvoiceTable.Line_PurchInvoiceSr = AgL.XNull(DtPurchInvoiceDetail.Rows(0)("Sr"))
                    Else
                        PurchInvoiceTable.Line_ReferenceNo = AgL.XNull(Dgl2.Item(Col1Value, rowPurchInvoiceNo).Value)
                ...
                If PurchInvoiceTable.Line_ReferenceNo = "" Then
                    Dgl2.CurrentCell = Dgl2.Item(Col1Value, rowPurchInvoiceNo)
                    Dgl2.Focus()
                    Err.Raise(1, "", "Purchase Invoice No is blank.")
                End If
    ...
    Private Sub Validating_SaleOrder(SaleOrder As String, bRowIndex As Integer)
        ...
        Try
            ...
            mQry = " SELECT H.Tags, Ig.Code As ItemGroup, Ig.Description As ItemGroupDesc, Ic.Code As ItemCategory,
                        ...
                        Sit.BookedFrom, Sit.Destination
                        FROM SaleInvoice H 
                        LEFT JOIN SaleInvoiceDetail L On H.DocId = L.DocId
                        LEFT JOIN ItemGroup Ig ON L.Item = Ig.Code
    ...
    End Function
    Private Sub FrmSaleInvoiceReturn_Aadhat_BaseEvent_Save_PostTrans(SearchCode As String) Handles Me.BaseEvent_Save_PostTrans
