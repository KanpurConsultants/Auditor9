...
Public Class FrmSaleInvoiceW_New
    Dim mSearchCode$ = ""
    ...
    Public Const Col3SyncedPurchInvoiceDocId As String = "SyncedPurchInvoiceDocId"
    ...
    Public Sub Ini_Grid()
        ...
        With AgCL
            ...
            .AddAgTextColumn(Dgl3, Col3SyncedPurchInvoiceDocId, 300, 0, Col3SyncedPurchInvoiceDocId, False, True)
            ...
            Select Case sender.NAME
                Case TxtOrderNo.Name
                    ...
                    mQry = "Select Si.DocId As SaleInvoiceDocId, Sg.Name As SaleToPartyName, Max(Sg1.Name) As BillToPartyName, 
                            ...
                            Max(Si.SaleToParty) As SaleToParty, Max(Si.BillToParty) As BillToParty, Max(Si.Site_Code) As Site_Code, 
                    ...
                    If DtTemp.Rows.Count > 0 Then
                        For I = 0 To DtTemp.Rows.Count - 1
                            ...
                            'mQry = "SELECT V1.DocId
                            '        FROM SaleInvoice H 
                            '        LEFT JOIN SaleInvoiceGeneratedEntries Ge ON H.DocID = Ge.DocId
                            '        LEFT JOIN (
                            '         SELECT Ge.Code, H.DocID
                            '         FROM SaleInvoice H 
                            '         LEFT JOIN SaleInvoiceGeneratedEntries Ge ON H.DocID = Ge.DocId
                            '         WHERE H.V_Type = 'WSI') AS V1 ON Ge.Code = V1.Code
                            '        WHERE H.OmsId = '" & AgL.XNull(DtTemp.Rows(I)("SaleInvoiceDocId")) & "'"

                            'mQry = "SELECT V1.DocId
                            '        FROM SaleInvoice H 
                            '        LEFT JOIN SaleInvoiceGeneratedEntries Ge ON H.DocID = Ge.DocId
                            '        LEFT JOIN (
                            '         SELECT Ge.Code, Ge.DocID
                            '         FROM SaleInvoiceGeneratedEntries Ge 
                            '         WHERE Ge.V_Type = 'WSI') AS V1 ON Ge.Code = V1.Code
                            '        WHERE H.OmsId = '" & AgL.XNull(DtTemp.Rows(I)("SaleInvoiceDocId")) & "'"

                            'mQry = "SELECT Count(*) FROM SaleInvoiceGeneratedEntries G WHERE G.DocId =  '" & AgL.XNull(DtTemp.Rows(I)("SaleInvoiceDocId")) & "'"

                            mQry = " SELECT Count(*) 
                                    FROM SaleInvoiceGeneratedEntries G 
                                    LEFT JOIN SaleInvoice Si ON G.DocId = Si.DocID
                                    WHERE Si.OmsId =  '" & AgL.XNull(DtTemp.Rows(I)("SaleInvoiceDocId")) & "'"
                            If AgL.XNull(AgL.Dman_Execute(mQry, AgL.GCn).ExecuteScalar()) = 0 Then
                                ...
                                mQry = " Select DocId From SaleInvoice Where OMSId = '" & AgL.XNull(DtTemp.Rows(I)("SaleInvoiceDocId")) & "'"
                                Dgl2.Item(Col2SyncedSaleInvoiceDocId, Dgl2.Rows.Count - 1).Value = AgL.XNull(AgL.Dman_Execute(mQry, AgL.GCn).ExecuteScalar())
                        ...
                        If DtTemp.Rows.Count > 0 Then
                            For I = 0 To DtTemp.Rows.Count - 1
                                ...
                                Dgl1.Item(Col1SyncedPurchInvoiceDocId, Dgl1.Rows.Count - 1).Value = AgL.XNull(AgL.Dman_Execute(mQry, AgL.GCn).ExecuteScalar())
    ...
    Private Function FDataValidation() As Boolean
        ...
        For I As Integer = 0 To Dgl1.Rows.Count - 1
            If AgL.XNull(Dgl1.Item(Col1WInvoiceNo, I).Value) <> "" Then
                ...
                If AgL.XNull(Dgl1.Item(Col1InvoiceNo, I).Value) <> "" And
...
#End Region
                ...
                If AgL.XNull(bDocId) <> "" Then
                    ...
                    If AgL.XNull(Dgl1.Item(Col1SyncedPurchInvoiceDocId, I).Value) <> "" Then
                        mQry = "Select Count(*) from SaleInvoiceGeneratedEntries Where DocID = '" & AgL.XNull(Dgl1.Item(Col1SyncedPurchInvoiceDocId, I).Value) & "'"
                        If AgL.Dman_Execute(mQry, AgL.GCn, AgL.ECmd).ExecuteScalar() = 0 Then
                            mQry = " INSERT INTO SaleInvoiceGeneratedEntries(Code, Type, DocId, SaleOrderNo, SaleOrderDocId, Site_Code, Div_Code, V_Type) 
                                    Select '" & mSearchCode & "' As Code, 'Purchase Invoice', '" & Dgl1.Item(Col1SyncedPurchInvoiceDocId, I).Value & "', '" & TxtOrderNo.Text & "', 
                            ...
                            mQry = " UPDATE Ledger Set EffectiveDate = " & AgL.Chk_Date(Dgl1.Item(Col1WInvoiceDate, I).Value) & "
                                Where DocId = '" & Dgl1.Item(Col1SyncedPurchInvoiceDocId, I).Value & "'"
                            AgL.Dman_ExecuteNonQry(mQry, AgL.GCn, AgL.ECmd)
                            ...
                            mQry = "Insert Into TransactionReferences (DocID, ReferenceDocID, IsEditingAllowed, IsDeletingAllowed) 
                                    Values (" & AgL.Chk_Text(Dgl1.Item(Col1SyncedPurchInvoiceDocId, I).Value) & ", '" & bDocId & "', 1, 0) "
                ...
                End If
                    ...
                    '            AgL.Dman_ExecuteNonQry(mQry, AgL.GCn, AgL.ECmd)
                    '        Else
                    '            If AgL.XNull(Dgl1.Item(Col1SyncedPurchInvoiceDocId, I).Value) <>
                    '                    AgL.XNull(Dgl1.Item(Col1SyncedPurchInvoiceDocId, I - 1).Value) Then
                    '                mQry = " INSERT INTO SaleInvoiceGeneratedEntries(Code, Type, DocId, SaleOrderNo, SaleOrderDocId, Site_Code, Div_Code, V_Type) 
                    '                    Select '" & mSearchCode & "' As Code, 'Purchase Invoice', '" & Dgl1.Item(Col1SyncedPurchInvoiceDocId, I).Value & "', '" & TxtOrderNo.Text & "', 
                    '                    '" & TxtSaleOrderDocId_W.Text & "', '" & AgL.PubSiteCode & "', '" & AgL.PubDivCode & "','PI' As V_Type "
                    '                AgL.Dman_ExecuteNonQry(mQry, AgL.GCn, AgL.ECmd)
        ...
        If AgL.XNull(Dgl2.Item(Col2WInvoiceNo, mRow).Value) <> "" Then
            ...
            For I = 0 To Dgl2.Rows.Count - 1
                If Val(Dgl2.Item(Col2WQty, I).Value) > 0 Then
                    ...
                    SaleInvoiceTableList(UBound(SaleInvoiceTableList)).Line_Rate = (Val(Dgl2.Item(Col2WSaleInvoiceAmount, I).Value) + Val(Dgl2.Item(Col2WDiscount, I).Value)) / Val(Dgl2.Item(Col2WQty, I).Value)
...
#End Region
            ...
            If AgL.XNull(bDocId) <> "" And (AgL.XNull(SaleInvoiceTableList(0).V_Type) = "SI" Or AgL.XNull(SaleInvoiceTableList(0).V_Type) = "WSI") Then
                Dgl2.Item(Col2WSaleInvoiceDocId, mRow).Value = bDocId

                mQry = " INSERT INTO SaleInvoiceGeneratedEntries(Code, Type, DocId, SaleOrderNo, SaleOrderDocId, Site_Code, Div_Code, V_Type) 
                            Select '" & mSearchCode & "' As Code, 'Sale Invoice', '" & bDocId & "', '" & TxtOrderNo.Text & "', 
                            '" & TxtSaleOrderDocId_W.Text & "', '" & AgL.PubSiteCode & "', '" & AgL.PubDivCode & "', '" & SaleInvoiceTableList(0).V_Type & "' "
                AgL.Dman_ExecuteNonQry(mQry, AgL.GCn, AgL.ECmd)



                If AgL.XNull(Dgl2.Item(Col2SyncedSaleInvoiceDocId, mRow).Value) <> "" Then
                    mQry = "Delete From SaleInvoiceTransport Where DocId = '" & Dgl2.Item(Col2SyncedSaleInvoiceDocId, mRow).Value & "'"
                    AgL.Dman_ExecuteNonQry(mQry, AgL.GCn, AgL.ECmd)
                    mQry = "Select * from SaleInvoiceTransport Where DocId =  '" & Dgl2.Item(Col2SaleInvoiceDocId, mRow).Value & "'"
                    dtTemp = AgL.FillData(mQry, Connection_Pakka).Tables(0)
                    If dtTemp.Rows.Count > 0 Then
                        mQry = "
                                    ...
                                    Values( '" & Dgl2.Item(Col2SyncedSaleInvoiceDocId, mRow).Value & "', " & AgL.Chk_Text(FGetSubCodeFromOMSId(AgL.XNull(dtTemp.Rows(0)("Transporter")))) & ", " & AgL.Chk_Text(AgL.XNull(dtTemp.Rows(0)("LRNo"))) & ", " & AgL.Chk_Date(AgL.XNull(dtTemp.Rows(0)("LRDate"))) & ", 
                    ...
                    mQry = " INSERT INTO SaleInvoiceGeneratedEntries(Code, Type, DocId, SaleOrderNo, SaleOrderDocId, Site_Code, Div_Code, V_Type) 
                                    Select '" & mSearchCode & "' As Code, 'Sale Invoice', '" & Dgl2.Item(Col2SyncedSaleInvoiceDocId, mRow).Value & "', '" & TxtOrderNo.Text & "', 
                                    '" & TxtSaleOrderDocId_W.Text & "', '" & AgL.PubSiteCode & "', '" & AgL.PubDivCode & "', 'SI' "
                    AgL.Dman_ExecuteNonQry(mQry, AgL.GCn, AgL.ECmd)

                    mQry = " UPDATE SaleInvoice Set GenDocId = '" & Dgl2.Item(Col2SyncedSaleInvoiceDocId, mRow).Value & "'
                            Where DocId = '" & bDocId & "'"
                    AgL.Dman_ExecuteNonQry(mQry, AgL.GCn, AgL.ECmd)

                    mQry = "Insert Into TransactionReferences (DocID, ReferenceDocID, IsEditingAllowed, IsDeletingAllowed) 
                                    Values (" & AgL.Chk_Text(Dgl2.Item(Col2SyncedSaleInvoiceDocId, mRow).Value) & ", '" & bDocId & "', 1, 0) "
                    AgL.Dman_ExecuteNonQry(mQry, Conn, Cmd)
                Else
            ...
            If Dgl1.Item(Col1WInvoiceDate, I).Value <> "" Then
                ...
                For J As Integer = 0 To Dgl2.Rows.Count - 1
                    If Dgl1.Item(Col1SaleInvoiceDocId, I).Value = Dgl2.Item(Col2SaleInvoiceDocId, J).Value And
                        ...
                        'Dgl2.Item(Col2WSaleInvoiceAmount, J).Tag = Val(Dgl1.Item(Col1WAmount, I).Value) +
                        '        (Val(Dgl1.Item(Col1WAmount, I).Value) * Val(Dgl2.Item(Col2AdditionPer, J).Value) / 100) -
                        '        (Val(Dgl1.Item(Col1WAmount, I).Value) * Val(Dgl2.Item(Col2AdditionalDiscountPer, J).Value) / 100) -
                        '        (Val(Dgl1.Item(Col1WQty, I).Value) * Val(Dgl2.Item(Col2DiscountPer, J).Value))
        ...
        For I As Integer = 0 To DtTemp.Rows.Count - 1
            If AgL.XNull(DtTemp.Rows(I)("Type")) = "Sale Invoice" Then
                ...
                For J As Integer = 0 To DtTransaction.Rows.Count - 1
                    ...
                    Dgl2.Item(Col2InvoiceNo, Dgl2.Rows.Count - 1).Value = AgL.XNull(DtTransaction.Rows(J)("PakkaInvoiceNo"))
                    Dgl2.Item(Col2InvoiceDate, Dgl2.Rows.Count - 1).Value = AgL.XNull(DtTransaction.Rows(J)("PakkaInvoiceDate"))
                Next
            ElseIf AgL.XNull(DtTemp.Rows(I)("Type")) = "Purchase Invoice" Then
                ...
                For J As Integer = 0 To DtTransaction.Rows.Count - 1
                    ...
                    Dgl1.Item(Col1WInvoiceNo, Dgl1.Rows.Count - 1).Value = AgL.XNull(DtTransaction.Rows(J)("VendorDocNo"))
                    ...
                    Dgl1.Item(Col1InvoiceNo, Dgl1.Rows.Count - 1).Value = AgL.XNull(DtTransaction.Rows(J)("PakkaInvoiceNo"))
                    Dgl1.Item(Col1InvoiceDate, Dgl1.Rows.Count - 1).Value = AgL.XNull(DtTransaction.Rows(J)("PakkaInvoiceDate"))
                Next
    ...
    Private Sub MoveRec()
        ...
        For I As Integer = 0 To DtPurchInvoiceDetail.Rows.Count - 1
            Dgl1.Rows.Add()
            Dgl1.Item(ColSNo, I).Value = Dgl1.Rows.Count
            Dgl1.Item(Col1SyncedPurchInvoiceDocId, I).Value = AgL.XNull(DtPurchInvoiceDetail.Rows(I)("SyncedPurchInvoiceDocId"))
            ...
            Dgl1.Item(Col1WPurchInvoiceAmount, I).Value = AgL.VNull(DtPurchInvoiceDetail.Rows(I)("WPurchInvoiceAmount"))
        ...
        For I As Integer = 0 To DtSaleInvoiceDetail.Rows.Count - 1
            Dgl2.Rows.Add()
            Dgl2.Item(ColSNo, I).Value = Dgl2.Rows.Count
            Dgl2.Item(Col2SyncedSaleInvoiceDocId, I).Value = AgL.XNull(DtSaleInvoiceDetail.Rows(I)("SyncedSaleInvoiceDocId"))
    ...
    Private Sub FPostUIValues(SearchCode As String, Conn As Object, Cmd As Object)
        ...
        For I As Integer = 0 To Dgl1.Rows.Count - 1
            ...
            mQry = "INSERT INTO WPurchInvoiceDetail (Code, Sr, SyncedPurchInvoiceDocId, Supplier, InvoiceNo, InvoiceDate, ItemGroup, InvoiceDiscountPer, InvoiceAdditionalDiscountPer, DiscountPer, AdditionalDiscountPer, AdditionPer, Amount, AmountWithoutDiscountAndTax, MasterSupplier, WInvoiceNo, WInvoiceDate, WQty, WFreight, WPacking, WAmount, WPurchInvoiceAmount, WPurchInvoiceDocId)
                ...
                " & AgL.Chk_Text(Dgl1.Item(Col1SyncedPurchInvoiceDocId, I).Value) & " As SyncedPurchInvoiceDocId, 
                ...
                " & Val(Dgl1.Item(Col1WPurchInvoiceAmount, I).Value) & " As WPurchInvoiceAmount,
        ...
        For I As Integer = 0 To Dgl2.Rows.Count - 1
            ...
            mQry = "INSERT INTO WSaleInvoiceDetail (Code, Sr, SyncedSaleInvoiceDocId, Party, InvoiceNo, InvoiceDate, ItemGroup, DiscountPer, AdditionalDiscountPer, AdditionPer, Amount, AmountWithoutTax, Discount, MasterParty, WSaleOrderDocId, WInvoiceNo, WInvoiceDate, WQty, WFreight, WPacking, WDiscount, WSaleInvoiceAmount, WSaleInvoiceDocId)
                    Select " & AgL.Chk_Text(SearchCode) & " As Code,  " & mSr & " As Sr, 
                    " & AgL.Chk_Text(Dgl2.Item(Col2SyncedSaleInvoiceDocId, I).Value) & " As SyncedSaleInvoiceDocId, 
        ...
        For I As Integer = 0 To Dgl3.Rows.Count - 1
            ...
            mQry = "INSERT INTO WLedgerHeadDetail (Code, Sr, DrCr, V_Date, Party, ReasonAc, Amount, SyncedPurchInvoiceDocId, Remark)
                    ...
                    " & AgL.Chk_Text(Dgl3.Item(Col3SyncedPurchInvoiceDocId, I).Value) & " As SyncedPurchInvoiceDocId, 
    ...
    Private Sub Dgl2_CellEnter(sender As Object, e As DataGridViewCellEventArgs) Handles Dgl2.CellEnter
        Try
            ...
            Select Case Dgl2.Columns(Dgl2.CurrentCell.ColumnIndex).Name
                Case Col2WInvoiceDate
                    If Dgl2.Item(Col2InvoiceDate, Dgl2.CurrentCell.RowIndex).Value <> "" Then
                        Dgl2.Columns(Col2WInvoiceDate).ReadOnly = True
                    End If
            End Select
        Catch ex As Exception
            MsgBox(ex.Message)
