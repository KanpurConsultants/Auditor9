...
Public Class FrmSaleInvoiceReturn_Aadhat_Old
...
#Region "Form Designer Code"
    Private Sub InitializeComponent()
        ...
        Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(FrmSaleInvoiceReturn_Aadhat_Old))
...
#End Region
    ...
    Public Sub FPrintThisDocument(ByVal objFrm As Object, ByVal V_Type As String,
        ...
        Try
            ...
            ClsMain.Formula_Set(mCrd, CType(objFrm, AgTemplate.TempTransaction).TxtDivision.Tag, CType(objFrm, AgTemplate.TempTransaction).TxtSite_Code.Tag, RepTitle)
    ...
    Public Sub FLoadPurchaseDataFromSaleInvoice()
        ...
        For I = 0 To Dgl1.Rows.Count - 1
            mQry = "Select So.ManualRefNo As OrderNo, So.V_Date As OrderDate,
                    From SaleInvoice L
                    LEFT JOIN SaleInvoice So On L.SaleInvoice = So.DocId
                    Where L.DocId = '" & Dgl1.Item(Col1ReferenceDocId, I).Value & "'
        ...
        mQry = " CREATE " & IIf(AgL.PubServerName = "", "Temp", "") & " TABLE [#TempSaleInvoiceSaleOrderSummary](
                SaleOrderDocId NVARCHAR(21),
                SaleOrderNo NVARCHAR(20),
                GrossAmount Float,
                TotalTax Float,
