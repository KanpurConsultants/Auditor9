...
Public Class FrmSaleInvoiceDirect_WithDimension_ShyamaShyam
    ...
    Public rowSaleToParty As Integer = 6
    Public rowSaleToPartyName As Integer = 7
    Public rowBillToParty As Integer = 8
...
#Region "Form Designer Code"
    Private Sub InitializeComponent()
        ...
        Me.PnlCalcGrid.Location = New System.Drawing.Point(672, 433)
        Me.PnlCalcGrid.Name = "PnlCalcGrid"
        Me.PnlCalcGrid.Size = New System.Drawing.Size(311, 144)
        ...
        Me.MnuCancelEntry.Size = New System.Drawing.Size(184, 22)
        ...
        Me.MnuPrintBulk.Size = New System.Drawing.Size(184, 22)
        Me.MnuPrintBulk.Text = "Print Bulk"
        '
        'MnuReferenceEntries
        '
        Me.MnuReferenceEntries.Name = "MnuReferenceEntries"
        Me.MnuReferenceEntries.Size = New System.Drawing.Size(184, 22)
        Me.MnuReferenceEntries.Text = "Reference Entries"
        '
        'MnuHistory
        '
        Me.MnuHistory.Name = "MnuHistory"
        Me.MnuHistory.Size = New System.Drawing.Size(184, 22)
        Me.MnuHistory.Text = "History"
        '
        'MnuReport
        '
        Me.MnuReport.Name = "MnuReport"
        Me.MnuReport.Size = New System.Drawing.Size(184, 22)
...
#End Region
    ...
    Private Sub FrmSaleOrder_BaseFunction_IniGrid() Handles Me.BaseFunction_IniGrid
        ...
        With AgCL
            ...
            .AddAgNumberColumn(Dgl1, Col1DocQty, 70, 8, 4, True, Col1DocQty, True, False, True)
    ...
    Private Sub FrmSaleOrder_BaseEvent_Save_InTrans(ByVal SearchCode As String, ByVal Conn As Object, ByVal Cmd As Object) Handles Me.BaseEvent_Save_InTrans
        ...
        mQry = " Select S.DocId, S.TSr, S.Sr, S.Qty_Iss, 
                ...
                LEFT JOIN Stock S With (NoLock) ON L.DocId = S.DocId And L.Sr = S.TSr
        ...
        If AgL.StrCmp(AgL.XNull(DtV_TypeSettings.Rows(0)("LedgerPostingPartyAcType")), SaleInvoiceLedgerPostingPartyAcType.SaleToParty) Then
            ...
            bLinkedPartyAc = DglMain.Item(Col1Value, rowBillToParty).Tag
        Else
            bPartyLedgerPostingAc = DglMain.Item(Col1Value, rowBillToParty).Tag
            bLinkedPartyAc = DglMain.Item(Col1Value, rowSaleToParty).Tag
        End If
    ...
    Private Sub UpdateItemGroupPerson(LineGridRowIndex As Integer, ByRef Conn As Object, ByRef Cmd As Object)
        ...
        If TxtNature.Text.ToUpper <> "CASH" Then
            If Val(Dgl1.Item(Col1DiscountPer, LineGridRowIndex).Value) > 0 And Val(Dgl1.Item(Col1DiscountPer, LineGridRowIndex).Value) <> Val(Dgl1.Item(Col1DefaultDiscountPer, LineGridRowIndex).Value) Then
            ...
            If Val(Dgl1.Item(Col1AdditionalDiscountPer, LineGridRowIndex).Value) > 0 And Val(Dgl1.Item(Col1AdditionalDiscountPer, LineGridRowIndex).Value) <> Val(Dgl1.Item(Col1DefaultAdditionalDiscountPer, LineGridRowIndex).Value) Then
            ...
            If Val(Dgl1.Item(Col1AdditionPer, LineGridRowIndex).Value) > 0 And Val(Dgl1.Item(Col1AdditionPer, LineGridRowIndex).Value) <> Val(Dgl1.Item(Col1DefaultAdditionPer, LineGridRowIndex).Value) Then
    ...
    Private Sub InsertStock(DocID As String, TSr As Integer, Sr As Integer, LineGridRowIndex As Integer, MultiplyWithMinus As Boolean, ByRef Conn As Object, ByRef Cmd As Object)
        ...
        mQry = "Insert Into Stock(DocID, TSr, Sr, V_Type, V_Prefix, V_Date, V_No, RecID, Div_Code, Site_Code, 
                                ...
                                (
                                    ...
                                    " & AgL.Chk_Text(DglMain.Item(Col1Value, rowSaleToParty).Tag) & ", " & AgL.Chk_Text(bSalesTaxGroupParty) & " , " & AgL.Chk_Text(Dgl1.Item(Col1Barcode, LineGridRowIndex).Tag) & ", 
    ...
    Private Sub ApplyUISetting()
        ...
        GetUISetting(Dgl3, Me.Name, AgL.PubDivCode, AgL.PubSiteCode, bNCat, DglMain.Item(Col1Value, rowV_Type).Tag, "", DglMain.Item(Col1Value, rowSettingGroup).Tag, ClsMain.GridTypeConstants.VerticalGrid)
        ...
        GetUISetting(DglPurchase, Me.Name, AgL.PubDivCode, AgL.PubSiteCode, bNCat, DglMain.Item(Col1Value, rowV_Type).Tag, "", DglMain.Item(Col1Value, rowSettingGroup).Tag, ClsMain.GridTypeConstants.HorizontalGrid)
        GetUISetting(DglItemCategorySummary, Me.Name, AgL.PubDivCode, AgL.PubSiteCode, bNCat, DglMain.Item(Col1Value, rowV_Type).Tag, "", DglMain.Item(Col1Value, rowSettingGroup).Tag, ClsMain.GridTypeConstants.HorizontalGrid)
    ...
    Private Sub FrmSaleOrder_BaseFunction_MoveRec(ByVal SearchCode As String) Handles Me.BaseFunction_MoveRec
        ...
        mQry = " Select H.*, Sg.Name As SaleToPartyDesc, 
                ...
                Sg.Nature, RT.Description as RateTypeName, SgWc.DispName As SaleToPartyDispName_Master
    ...
    Private Sub Validating_ItemCode(ItemCode As String, ByVal mColumn As Integer, ByVal mRow As Integer)
        ...
        Try
            mQry = "Select I.Code, I.Description, I.ManualCode, I.Unit, IfNull(I.SalesTaxPostingGroup, IC.SalesTaxPostingGroup) as SalesTaxPostingGroup, I.MaintainStockYn, 
                    ...
                    IG.ItemInvoiceGroup, IIG.Description as ItemInvoiceGroupName, U.ShowDimensionDetailInSales, U.DecimalPlaces as QtyDecimalPlaces, IG.Default_DiscountPerSale ,
            ...
            If bContraWindowBaseField = Dgl1.Columns(mColumnName).Name Then
                ...
                Else
                    If MsgBox("No Invoice found to return for selected customer. Do you want to continue without invoice references?", vbYesNo) = MsgBoxResult.No Then
                        ...
                        Dgl1.Rows.Add()
                    Else
                        If FDivisionNameForCustomization(4) = "DEVI" Then
    ...
    Private Sub FrmSaleOrder_BaseEvent_Data_Validation(ByRef passed As Boolean) Handles Me.BaseEvent_Data_Validation
        ...
        If FGetSettings(SettingFields.GeneratedEntryV_TypeForAadhat, SettingType.General) <> "" Then
            For I = 0 To DglPurchase.Rows.Count - 1
                ...
                If DglPurchase.Item(Col5Supplier, I).Value = "" Then
                    MsgBox("Purchase Supplier is blank at row number " & (I + 1).ToString, MsgBoxStyle.Information)
                    DglPurchase.Focus() : MakeGridCurrentCellNothing(DglPurchase.Name)
                    DglPurchase.CurrentCell = DglPurchase.Item(Col5Supplier, I)
                    Try
                ...
                If DglPurchase.Item(Col5Supplier, I).Value = DglPurchase.Item(Col5ParentSupplier, I).Value Then
                    MsgBox("Purchase Supplier is wrong at row number " & (I + 1).ToString, MsgBoxStyle.Information)
                    DglPurchase.Focus() : MakeGridCurrentCellNothing(DglPurchase.Name)
                    DglPurchase.CurrentCell = DglPurchase.Item(Col5Supplier, I)
                    Try
                        Dgl1.CurrentCell = Dgl1.Item(ColSNo, Dgl1.Rows.Count - 1)
        ...
        Try
            ...
            Select Case Dgl1.Columns(Dgl1.CurrentCell.ColumnIndex).Name
                ...
                Case Col1StockInDiv_Code
                    If Dgl1.Item(Col1StockInDocId, Dgl1.CurrentCell.RowIndex).Value <> "" Then
    ...
    Private Sub DGL1_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles Dgl1.KeyDown
        ...
        If CType(AgL.VNull(FGetSettings(SettingFields.AllowLineRowDeletionYn, SettingType.General)), Boolean) = True Then
    ...
    Private Sub FCreateHelpItemGroup(RowIndex As Integer)
        ...
        strCond += " And (I.Site_Code = '" & AgL.PubSiteCode & "' Or I.Site_Code Is Null ) "
    ...
    Public Sub FGetPrint(ByVal SearchCode As String, mPrintFor As ClsMain.PrintFor,
        ...
        If DtTemp.Rows.Count > 0 Then
            ...
            Next
            If FGetSettings(SettingFields.DocumentPrintReportFileName, SettingType.General) <> "" Then
    ...
    Sub FGetPrintCrystal(ByVal SearchCode As String, mPrintFor As ClsMain.PrintFor, Optional ByVal IsPrintToPrinter As Boolean = False, Optional BulkCondStr As String = "")
        ...
        For I = 1 To PrintingCopies.Length
            ...
            mQry = mQry + "
                ...
                ISS.Description as ItemState, ifNull(Catalog.Specification,'') as CatalogSpecification, L.Unit, U.DecimalPlaces as UnitDecimalPlaces, 
        ...
        If mDocReportFileName = "" Then
            ClsMain.FPrintThisDocument(Me, objRepPrint, DglMain.Item(Col1Value, rowV_Type).Tag, mQry, "SaleInvoice_Print.rpt", mPrintTitle, , sQry, sQryRepName, DglMain.Item(Col1Value, rowSaleToParty).Tag, DglMain.Item(Col1Value, rowV_Date).Value, IsPrintToPrinter, AgL.XNull(DtDoc.Rows(0)("Div_Code")), AgL.XNull(DtDoc.Rows(0)("Site_Code")))
        Else
            ClsMain.FPrintThisDocument(Me, objRepPrint, DglMain.Item(Col1Value, rowV_Type).Tag, mQry, mDocReportFileName, mPrintTitle, , sQry, sQryRepName, DglMain.Item(Col1Value, rowSaleToParty).Tag, DglMain.Item(Col1Value, rowV_Date).Value, IsPrintToPrinter, AgL.XNull(DtDoc.Rows(0)("Div_Code")), AgL.XNull(DtDoc.Rows(0)("Site_Code")))
        End If
    ...
    Public Sub FGetPrintCrystal_Aadhat(ObjFrm As Object, ByVal SearchCode As String, mPrintFor As ClsMain.PrintFor, IsPrintToPrinter As Boolean, BulkCondStr As String, PrintingCopiesStr As String)
        ...
        If dtDoc.Rows.Count > 0 Then
            ...
            For I = 1 To PrintingCopies.Length
                ...
                Left Join SaleInvoiceTrnSetting TS  With (NoLock) On H.DocId = TS.DocID
                Left Join SaleInvoiceDetail L  With (NoLock) On H.DocID = L.DocID
                Left Join SaleInvoiceDetailSku Lsku With (NoLock) On L.DocId = lSku.DociD And L.Sr = LSku.Sr
                Left Join Item I  With (NoLock) On LSku.Item = I.Code
                Left Join Unit U  With (NoLock) On I.Unit = U.Code
                Left Join Item IG  With (NoLock) On LSku.ItemGroup = IG.Code
                Left Join Item IC  With (NoLock) On LSKu.ItemCategory = IC.Code
                Left Join City C  With (NoLock) On H.SaleToPartyCity = C.CityCode
                Left Join State  With (NoLock) On C.State = State.Code
                Left Join SaleInvoiceTransport TD  With (NoLock) On H.DocID = TD.DocID
            ...
            If mDocReportFileName = "" Then
                ClsMain.FPrintThisDocument(ObjFrm, objRepPrint, AgL.XNull(dtDoc.Rows(0)("V_Type")), mQry, "SaleInvoice_Print.rpt", mPrintTitle, , , , AgL.XNull(dtDoc.Rows(0)("SaleToParty")), AgL.XNull(dtDoc.Rows(0)("V_Date")), IsPrintToPrinter)
            Else
                ClsMain.FPrintThisDocument(ObjFrm, objRepPrint, AgL.XNull(dtDoc.Rows(0)("V_Type")), mQry, mDocReportFileName, mPrintTitle, , , , AgL.XNull(dtDoc.Rows(0)("SaleToParty")), AgL.XNull(dtDoc.Rows(0)("V_Date")), IsPrintToPrinter)
            End If
        End If
    End Sub
    ...
    Private Sub ShowSaleInvoiceParty(DocID As String, PartyCode As String, AcGroupNature As String, Optional ShowDialogForCash As Boolean = False)
        If AgL.XNull(DtV_TypeSettings.Rows(0)("SaleInvoicePattern")) = SaleInvoicePattern.PointOfSale And
            ...
            AcGroupNature = "Cash"
        ElseIf DglMain.Item(Col1Value, rowSaleToParty).Tag.ToString.ToUpper = "TEMPPARTY" Then
            AcGroupNature = "Cash"
        End If
        If DglMain.Item(Col1BtnDetail, rowSaleToParty).Tag IsNot Nothing Then
    ...
    Public Shared Narrowing Operator CType(v As FrmSaleInvoiceDirect_Aadhat) As FrmSaleInvoiceDirect_WithDimension_ShyamaShyam
    ...
    Private Sub MnuImport_Click(sender As Object, e As EventArgs) Handles MnuImportFromExcel.Click, MnuImportFromDos.Click, MnuImportFromTally.Click, MnuEditSave.Click,
            MnuGenerateEWayBill.Click, MnuReconcileBill.Click, MnuEMail.Click, MnuSendSms.Click, MnuReferenceEntries.Click, MnuReport.Click, MnuHistory.Click, MnuPrintBulk.Click, MnuCancelEntry.Click
        Select Case sender.name
    ...
    Public Shared Function InsertSaleInvoice(SaleInvoiceTableList As StructSaleInvoice(), Optional SaleInvoiceDimensionTableList As StructSaleInvoiceDimensionDetail() = Nothing) As String
        ...
        If SaleInvoiceTableList(0).V_Type IsNot Nothing Then
            ...
            If AgL.XNull(SaleInvoiceTableList(0).ManualRefNo) <> "" Then
                Dim bTransactionCompCode As String = AgL.XNull(AgL.Dman_Execute(" Select Comp_Code From Company C 
                    Where " & AgL.Chk_Date(SaleInvoiceTableList(0).V_Date) & " Between C.Start_Dt And C.End_Dt ", IIf(AgL.PubServerName = "", AgL.GCn, AgL.GcnRead)).ExecuteScalar())

                If AgL.VNull(AgL.Dman_Execute(" Select Count(*)
                        From SaleInvoice H
                        LEFT JOIN Company C ON H.V_Date BETWEEN C.Start_Dt AND C.End_Dt
                        Where H.V_Type = '" & SaleInvoiceTableList(0).V_Type & "'
                        And H.Site_Code = '" & SaleInvoiceTableList(0).Site_Code & "'
                        And H.Div_Code = '" & SaleInvoiceTableList(0).Div_Code & "'
                        And H.ManualRefNo = '" & SaleInvoiceTableList(0).ManualRefNo & "'
                        And C.Comp_Code = '" & bTransactionCompCode & "'
                        ", IIf(AgL.PubServerName = "", AgL.GCn, AgL.GcnRead)).ExecuteScalar()) > 0 Then
                    Err.Raise(1,, "Manual Ref No " & SaleInvoiceTableList(0).ManualRefNo & " already exists.")
                End If
            End If
    ...
    Private Sub FPrintBulk(SearchCode As String)
        ...
        If FrmObj.mOkButtonPressed Then
            ...
            If FrmObj.Dgl1.Item(FrmPrintDialog.Col1Value, FrmPrintDialog.rowFromDate).Value <> "" Then
                mQry += " AND H.V_Date <= " & AgL.Chk_Date(FrmObj.Dgl1.Item(FrmPrintDialog.Col1Value, FrmPrintDialog.rowFromDate).Value) & ""
            End If
            If FrmObj.Dgl1.Item(FrmPrintDialog.Col1Value, FrmPrintDialog.rowToDate).Value <> "" Then
                mQry += " AND H.V_Date >= " & AgL.Chk_Date(FrmObj.Dgl1.Item(FrmPrintDialog.Col1Value, FrmPrintDialog.rowToDate).Value) & ""
            End If
    ...
    Public Sub FSplitSale(SearchCode As String, Conn As Object, Cmd As Object)
        ...
        For I = 0 To DtHeaderSource.Rows.Count - 1
            ...
            Dim SaleInvoiceTable As New FrmSaleInvoiceDirect_WithDimension_ShyamaShyam.StructSaleInvoice
    ...
    Public Sub Ini_Grid_Purchase()
        If FGetSettings(SettingFields.GeneratedEntryV_TypeForAadhat, SettingType.General) <> "" Then
            ...
            With AgCL
                ...
                .AddAgTextColumn(DglPurchase, Col5Supplier, 150, 0, Col5Supplier, True, False)
    ...
    Public Sub FPostPurchaseData(Conn As Object, Cmd As Object)
        ...
        For I = 0 To DglPurchase.Rows.Count - 1
            ...
            For J = 0 To DtTemp.Rows.Count - 1
                ...
                If CType(AgL.VNull(FGetSettings(SettingFields.TreatRateAsAmountYn, SettingType.General)), Boolean) = True Then
                    ...
                    If PurchInvoiceTable.Line_Qty < 0 Then
                        PurchInvoiceTable.Line_Amount = Math.Round((-1.0 * PurchInvoiceTable.Line_Rate) - PurchInvoiceTable.Line_DiscountAmount - PurchInvoiceTable.Line_AdditionalDiscountAmount, 2)
                    Else
                        PurchInvoiceTable.Line_Amount = Math.Round((1.0 * PurchInvoiceTable.Line_Rate) - PurchInvoiceTable.Line_DiscountAmount - PurchInvoiceTable.Line_AdditionalDiscountAmount, 2)
                    End If
                Else
                ...
                If FDivisionNameForCustomization(12) = "MAA KI KRIPA" Or
                    ...
                    If PurchInvoiceTable.Line_Qty < 0 Then
                        Tot_Tax1 = Val(DglPurchase.Item(Col5TotalTax, I).Value) * -1.0
                    Else
            ...
            Dim bDocId As String = InsertPurchInvoice(PurchInvoiceTableList)
        ...
        If FDivisionNameForCustomization(12) = "MAA KI KRIPA" Or
            ...
            If DtTemp.Rows.Count > 0 Then
                ...
                For I = 0 To DtTemp.Rows.Count - 1
                    ...
                    DglPurchase.Item(Col5ParentSupplier, I).Tag = AgL.XNull(DtTemp.Rows(I)("Supplier"))
                    DglPurchase.Item(Col5ParentSupplier, I).Value = AgL.XNull(DtTemp.Rows(I)("SupplierName"))
                    DtChild = AgL.FillData("Select Code, Name From viewHelpSubgroup Sg Where Sg.Parent='" & DglPurchase.Item(Col5ParentSupplier, I).Tag & "'", AgL.GCn).Tables(0)
                    If DtChild.Rows.Count = 1 Then
                        DglPurchase.Item(Col5Supplier, I).Tag = AgL.XNull(DtChild.Rows(0)("Code"))
                        DglPurchase.Item(Col5Supplier, I).Value = AgL.XNull(DtChild.Rows(0)("Name"))
                    Else
                        DglPurchase.Item(Col5Supplier, I).Tag = ""
                        DglPurchase.Item(Col5Supplier, I).Value = ""
                    End If
                    ...
                    If mDtPurchaseData IsNot Nothing Then
                        If mDtPurchaseData.Rows.Count > 0 Then
                            Dim mDrPurchase As DataRow() = mDtPurchaseData.Select("ParentSupplier = '" & DglPurchase.Item(Col5ParentSupplier, I).Tag & "' 
                            ...
                            If mDrPurchase.Length > 0 Then
                                ...
                                DglPurchase.Item(Col5Supplier, I).Tag = AgL.XNull(mDrPurchase(0)("Supplier"))
                                DglPurchase.Item(Col5Supplier, I).Value = AgL.XNull(mDrPurchase(0)("SupplierName"))
                            End If
                        End If
                    End If
    ...
    Private Sub FFillPurchasePrevData()
        ...
        For I As Integer = 0 To DglPurchase.Rows.Count - 1
            ...
            bQry += "Select '" & DglPurchase.Item(Col5Supplier, I).Tag & "' As Supplier, 
                    '" & DglPurchase.Item(Col5Supplier, I).Value & "' As SupplierName, 
                    '" & DglPurchase.Item(Col5ParentSupplier, I).Tag & "' As ParentSupplier, 
        ...
        With DtTemp
            ...
            If .Rows.Count > 0 Then
                For I As Integer = 0 To DtTemp.Rows.Count - 1
                    ...
                    DglPurchase.Item(Col5ParentSupplier, I).Tag = AgL.XNull(DtTemp.Rows(I)("ParentSupplier"))
                    DglPurchase.Item(Col5ParentSupplier, I).Value = AgL.XNull(DtTemp.Rows(I)("ParentSupplierName"))
                    DglPurchase.Item(Col5ItemGroup, I).Tag = AgL.XNull(DtTemp.Rows(I)("ItemGroup"))
    ...
    Private Sub DglPurchase_CellEnter(sender As Object, e As DataGridViewCellEventArgs) Handles DglPurchase.CellEnter
        Try
            Dim bRowIndex As Integer = DglPurchase.CurrentCell.RowIndex
            Dim bColumnIndex As Integer = DglPurchase.CurrentCell.ColumnIndex

            Select Case DglPurchase.Columns(DglPurchase.CurrentCell.ColumnIndex).Name
                Case Col5Supplier
                    mQry = " Select Code, Name From ViewHelpSubGroup
                             Where Parent = '" & DglPurchase.Item(Col5ParentSupplier, bRowIndex).Tag & "'"
                    DglPurchase.AgHelpDataSet(Col5Supplier) = AgL.FillData(mQry, AgL.GCn)
    ...
    Private Sub Dgl1_CellBeginEdit(sender As Object, e As DataGridViewCellCancelEventArgs) Handles Dgl1.CellBeginEdit
        Try
            ...
            Select Case Dgl1.Columns(Dgl1.CurrentCell.ColumnIndex).Name
                Case Col1ItemCategory, Col1ItemGroup, Col1Item
    ...
    Private Sub DglPurchase_EditingControl_KeyDown(sender As Object, e As KeyEventArgs) Handles DglPurchase.EditingControl_KeyDown
        Try
            ...
            Select Case DglPurchase.Columns(DglPurchase.CurrentCell.ColumnIndex).Name
                'Case Col5Supplier
                '    If e.KeyCode <> Keys.Enter Then
                '        If DglPurchase.AgHelpDataSet(Col5Supplier) Is Nothing Then
                '            mQry = " Select Code, Name From ViewHelpSubGroup
                '                Where Parent = '" & DglPurchase.Item(Col5ParentSupplier, bRowIndex).Tag & "'"
                '            DglPurchase.AgHelpDataSet(Col5Supplier) = AgL.FillData(mQry, AgL.GCn)
                '        End If
    ...
    Public Shared Function InsertPurchInvoice(PurchInvoiceTableList As StructPurchInvoice(), Optional PurchInvoiceDimensionTableList As StructPurchInvoiceDimensionDetail() = Nothing) As String
        ...
        If PurchInvoiceTableList(0).V_Date IsNot Nothing Then
            ...
            mQry = " INSERT INTO PurchInvoice (DocID,  V_Type,  V_Prefix, V_Date,  V_No,  Div_Code,  Site_Code,
                        ManualRefNo, Process,  Vendor,  BillToParty,  Agent, VendorName,  VendorAddress,
            ...
            For I As Integer = 0 To PurchInvoiceTableList.Length - 1
                If PurchInvoiceTableList(I).Line_ItemName IsNot Nothing Then
                    ...
                    mQry = "INSERT INTO PurchInvoiceDetailSku (DocID, Sr, ItemCategory, ItemGroup, Item)
                            Select " & AgL.Chk_Text(PurchInvoiceTableList(0).DocID) & ", 
                            " & Val(PurchInvoiceTableList(I).Line_Sr) & ", 
            ...
            If mFlag_Import = False And AgL.StrCmp(PurchInvoiceTableList(0).V_Type, "REC") = False Then
                FGetCalculationData_Purchase(PurchInvoiceTableList(0).DocID, AgL.GCn, AgL.ECmd)
            End If
    ...
    End Function
    Public Shared Sub FGetCalculationData_Purchase(mSearchCode As String, Conn As Object, Cmd As Object)
        Dim mQry As String = ""
        mQry = "SELECT Sd.* 
    ...
    Private Sub LblBalanceLimit_DoubleClick(sender As Object, e As EventArgs) Handles LblBalanceLimit.DoubleClick
