...
Public Class FrmSaleInvoiceOrderSummary
    ...
    Public Const Col1TcsYn As String = "TCS (Y/N)"
    ...
    Public Sub Ini_Grid()
        ...
        With AgCL
            ...
            .AddAgTextColumn(Dgl1, Col1TcsYn, 100, 0, Col1TcsYn, True, False)
        End With
        ...
        Try
            Select Case sender.NAME
                Case TxtOrderNo.Name
                    mQry = "Select H.SaleToParty, Sg.Name As SaleToPartyName, Sg.Parent, IfNull(H.Status,'Active') As Status
                    ...
                    If DtTemp.Rows.Count > 0 Then
                        If AgL.XNull(DtTemp.Rows(0)("Status")) <> "Active" Then
                            MsgBox("Order is in " & AgL.XNull(DtTemp.Rows(0)("Status")) & " Status." & " Only Active Order can be selected for invoice.", MsgBoxStyle.Information)
                            Exit Sub
                        End If
                ...
                Case TxtOrderNo.Name
                    If e.KeyCode <> Keys.Enter Then
                        If sender.AgHelpDataset Is Nothing Then
                            mQry = "SELECT H.DocId As Code, H.ManualRefNo As OrderNo, H.V_Type As OrderType, H.V_Date As OrderDate, H.Status " &
                                    " FROM SaleInvoice H With (NoLock) 
    ...
    Private Sub Dgl1_EditingControl_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles Dgl1.EditingControl_KeyDown
        Try
            ...
            Select Case Dgl1.Columns(Dgl1.CurrentCell.ColumnIndex).Name
                Case Col1TcsYn
                    If e.KeyCode <> Keys.Enter Then
                        If Dgl1.Item(Col1TcsYn, Dgl1.CurrentCell.RowIndex).Tag Is Nothing Then
                            mQry = " Select 'YES' AS CODE, 'YES' AS NAME UNION ALL SELECT 'NO' AS CODE, 'NO' AS NAME "
                            Dgl1.Item(Col1TcsYn, Dgl1.CurrentCell.RowIndex).Tag = AgL.FillData(mQry, AgL.GCn)

                        End If

                        If Dgl1.AgHelpDataSet(Col1TcsYn) Is Nothing Then
                            Dgl1.AgHelpDataSet(Col1TcsYn) = Dgl1.Item(Col1TcsYn, Dgl1.CurrentCell.RowIndex).Tag
                        End If
                    End If
                Case Col1Supplier
                    If e.KeyCode <> Keys.Enter Then
    ...
    Private Function FDataValidation() As Boolean
        For I As Integer = 0 To Dgl1.Rows.Count - 1
            ...
            If Dgl1.Item(Col1TcsYn, I).Value = "" Then
                MsgBox("TCS Y/N is blank for line no " & Dgl1.Item(ColSNo, I).Value & "", MsgBoxStyle.Information)
                FDataValidation = False
                Exit Function
            End If
