...
Public Class ClsStockHeadReport
    ...
    Dim rowItemGroup As Integer = 7
    Dim rowItemCategory As Integer = 8
    Dim rowCity As Integer = 9
    Dim rowState As Integer = 10
    Dim rowHSN As Integer = 11
    ...
    Public Sub ProcJobReport(Optional mFilterGrid As AgControls.AgDataGrid = Nothing,
        ...
        Try
            ...
            mQry = " SELECT H.DocID, L.Sr, strftime('%d/%m/%Y', H.V_Date) As V_Date, H.V_Date As V_Date_ActualFormat,
                    H.SubCode As Party, Sku.ItemGroup, Sku.ItemCategory,
            ...
            ClsMain.FSetDimensionCaptionForHorizontalGrid(ReportFrm.DGL1)
