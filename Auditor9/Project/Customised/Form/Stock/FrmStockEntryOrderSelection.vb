...
Public Class FrmStockEntryOrderSelection
    Dim mQry As String = ""
    ...
    Public Sub IniGrid(SearchCode As String)
        With AgCL
            ...
            .AddAgTextColumn(Dgl1, Col1RawMaterial, 100, 0, Col1RawMaterial, True, True)
    ...
    Public Sub FFillOrderBalance()
        ...
        mQry = " Select 'o' As Tick, L.DocID || '#' || Cast(L.Sr as Varchar) As SearchKey, 
                ...
                L.Barcode, Bc.Description As BarcodeDesc, Sku.Code As SkuCode, Sku.Description As Sku
        ...
        For I As Integer = 0 To Dgl1.Columns.Count - 1
            If Dgl1.Columns(I).Name <> Col1ItemType And Dgl1.Columns(I).Name <> Col1Sku And
                Dgl1.Columns(I).Name <> Col1ReferenceDocIdTSr And Dgl1.Columns(I).Name <> Col1ReferenceDocIdSr Then
        ...
        For I As Integer = 0 To DtTemp.Rows.Count - 1
            ...
            Dgl1.Item(Col1BalanceQty, I).Value = AgL.VNull(DtTemp.Rows(I)("BalanceQty"))
        ...
        Next
    End Sub
    Private Sub FrmStockEntryOrderSelection_KeyDown(sender As Object, e As KeyEventArgs) Handles Me.KeyDown
