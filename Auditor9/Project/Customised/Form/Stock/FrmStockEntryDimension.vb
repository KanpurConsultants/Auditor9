...
Public Class FrmStockEntryDimension
    Dim mQry As String = ""
    ...
    Dim mObjFrmStockEntry As FrmStockEntry
    ...
    Public Property DglRow() As DataGridViewRow
        ...
        End Set
    End Property
    Public Property objFrmStockEntry() As FrmStockEntry
        Get
            objFrmStockEntry = mObjFrmStockEntry
        End Get
        Set(ByVal value As FrmStockEntry)
            mObjFrmStockEntry = value
        End Set
    End Property
    ...
    Private Sub DGL1_RowsAdded(ByVal sender As Object, ByVal e As System.Windows.Forms.DataGridViewRowsAddedEventArgs) Handles Dgl1.RowsAdded, Dgl1.RowsAdded
        ...
        Try
            If Dgl1.Columns.Count > 1 Then
                Dgl1.Item(Col1ItemType, e.RowIndex).Tag = AgL.XNull(DglRow.Cells(FrmStockEntry.Col1ItemType).Tag)
                Dgl1.Item(Col1ItemCategory, e.RowIndex).Tag = AgL.XNull(DglRow.Cells(FrmStockEntry.Col1ItemCategory).Tag)
                Dgl1.Item(Col1ItemGroup, e.RowIndex).Tag = AgL.XNull(DglRow.Cells(FrmStockEntry.Col1ItemGroup).Tag)
                Dgl1.Item(Col1Item, e.RowIndex).Tag = AgL.XNull(DglRow.Cells(FrmStockEntry.Col1Item).Tag)
                Dgl1.Item(Col1Dimension1, e.RowIndex).Tag = AgL.XNull(DglRow.Cells(FrmStockEntry.Col1Dimension1).Tag)
                Dgl1.Item(Col1Dimension2, e.RowIndex).Tag = AgL.XNull(DglRow.Cells(FrmStockEntry.Col1Dimension2).Tag)
                Dgl1.Item(Col1Dimension3, e.RowIndex).Tag = AgL.XNull(DglRow.Cells(FrmStockEntry.Col1Dimension3).Tag)
                Dgl1.Item(Col1Dimension4, e.RowIndex).Tag = AgL.XNull(DglRow.Cells(FrmStockEntry.Col1Dimension4).Tag)
                Dgl1.Item(Col1Size, e.RowIndex).Tag = AgL.XNull(DglRow.Cells(FrmStockEntry.Col1Size).Tag)

                Dgl1.Item(Col1ItemCategory, e.RowIndex).Value = AgL.XNull(DglRow.Cells(FrmStockEntry.Col1ItemCategory).Value)
                Dgl1.Item(Col1ItemGroup, e.RowIndex).Value = AgL.XNull(DglRow.Cells(FrmStockEntry.Col1ItemGroup).Value)
                Dgl1.Item(Col1Item, e.RowIndex).Value = AgL.XNull(DglRow.Cells(FrmStockEntry.Col1Item).Value)
                Dgl1.Item(Col1Dimension1, e.RowIndex).Value = AgL.XNull(DglRow.Cells(FrmStockEntry.Col1Dimension1).Value)
                Dgl1.Item(Col1Dimension2, e.RowIndex).Value = AgL.XNull(DglRow.Cells(FrmStockEntry.Col1Dimension2).Value)
                Dgl1.Item(Col1Dimension3, e.RowIndex).Value = AgL.XNull(DglRow.Cells(FrmStockEntry.Col1Dimension3).Value)
                Dgl1.Item(Col1Dimension4, e.RowIndex).Value = AgL.XNull(DglRow.Cells(FrmStockEntry.Col1Dimension4).Value)
                Dgl1.Item(Col1Size, e.RowIndex).Value = AgL.XNull(DglRow.Cells(FrmStockEntry.Col1Size).Value)
            End If
        Catch ex As Exception
        End Try
    End Sub
            ...
            If Dgl1.Rows(I).Visible Then
                If Val(Dgl1.Item(Col1TotalQty, I).Value) <> 0 Then
                    If Dgl1.Item(ColSNo, I).Tag Is Nothing Then
                        ...
                        If CType(AgL.VNull(mObjFrmStockEntry.FGetSettings(ClsMain.SettingFields.PostInStockYn, SettingType.General)), Boolean) = True Then
                            ...
                            mQry = "Insert Into Stock(DocID, TSr, Sr, V_Type, 
                                ...
                                Values
                                (
                                    '" & DocId & "', " & TSr & ", " & mObjFrmStockEntry.mDimensionSrl & ", " & AgL.Chk_Text(mObjFrmStockEntry.DglMain.Item(FrmStockEntry.Col1Value, mObjFrmStockEntry.rowV_Type).Tag) & ",
                                    " & AgL.Chk_Text(mObjFrmStockEntry.LblPrefix.Text) & ", " & AgL.Chk_Date(mObjFrmStockEntry.DglMain.Item(FrmStockEntry.Col1Value, mObjFrmStockEntry.rowV_Date).Value) & ", " & AgL.Chk_Text(mObjFrmStockEntry.DglMain.Item(FrmStockEntry.Col1Value, mObjFrmStockEntry.rowV_No).Value) & ", " & AgL.Chk_Text(mObjFrmStockEntry.DglMain.Item(FrmStockEntry.Col1Value, mObjFrmStockEntry.rowReferenceNo).Value) & ",
                                    " & AgL.Chk_Text(mObjFrmStockEntry.TxtDivision.Tag) & ", " & AgL.Chk_Text(mObjFrmStockEntry.DglMain.Item(FrmStockEntry.Col1Value, mObjFrmStockEntry.rowSite_Code).Tag) & ", 
                                    " & AgL.Chk_Text(mObjFrmStockEntry.Dgl2.Item(FrmStockEntry.Col1Value, mObjFrmStockEntry.rowGodown).Tag) & ", 
                                    " & AgL.Chk_Text(mObjFrmStockEntry.DglMain.Item(FrmStockEntry.Col1Value, mObjFrmStockEntry.rowParty).Tag) & ", 
                                    " & AgL.Chk_Text(Dgl1(Col1SKU, I).Tag) & ", 
                                    " & AgL.Chk_Text(mObjFrmStockEntry.Dgl1(FrmStockEntry.Col1LotNo, mGridRowIndex).Value) & ", 'R', 
                                    " & bQty_Receive & ", " & bQty_Issue & ",
                                    " & AgL.Chk_Text(mObjFrmStockEntry.Dgl1(FrmStockEntry.Col1Unit, mGridRowIndex).Value) & ", " & AgL.Chk_Text(mObjFrmStockEntry.Dgl1(FrmStockEntry.Col1Rate, mGridRowIndex).Value) & ", " & AgL.Chk_Text(mObjFrmStockEntry.Dgl1(FrmStockEntry.Col1Amount, mGridRowIndex).Value) & ",0
                                )   "
                            AgL.Dman_ExecuteNonQry(mQry, Conn, Cmd)
                        End If
                    ...
                    Else
                        ...
                        If CType(AgL.VNull(mObjFrmStockEntry.FGetSettings(ClsMain.SettingFields.PostInStockYn, SettingType.General)), Boolean) = True Then
                            ...
                            mQry = "Update Stock Set V_Type = " & AgL.Chk_Text(mObjFrmStockEntry.DglMain.Item(FrmStockEntry.Col1Value, mObjFrmStockEntry.rowV_Type).Tag) & ",
                                    V_Prefix = " & AgL.Chk_Text(mObjFrmStockEntry.LblPrefix.Text) & ", 
                                    V_Date = " & AgL.Chk_Date(mObjFrmStockEntry.DglMain.Item(FrmStockEntry.Col1Value, mObjFrmStockEntry.rowV_Date).Value) & ", 
                                    V_No = " & AgL.Chk_Text(mObjFrmStockEntry.DglMain.Item(FrmStockEntry.Col1Value, mObjFrmStockEntry.rowV_No).Value) & ", 
                                    RecId = " & AgL.Chk_Text(mObjFrmStockEntry.DglMain.Item(FrmStockEntry.Col1Value, mObjFrmStockEntry.rowReferenceNo).Value) & ",
                                    Div_Code = " & AgL.Chk_Text(mObjFrmStockEntry.TxtDivision.Tag) & ", 
                                    Site_Code = " & AgL.Chk_Text(mObjFrmStockEntry.DglMain.Item(FrmStockEntry.Col1Value, mObjFrmStockEntry.rowSite_Code).Tag) & ", 
                                    Godown = " & AgL.Chk_Text(mObjFrmStockEntry.Dgl2.Item(FrmStockEntry.Col1Value, mObjFrmStockEntry.rowGodown).Tag) & ", 
                                    Subcode = " & AgL.Chk_Text(mObjFrmStockEntry.DglMain.Item(FrmStockEntry.Col1Value, mObjFrmStockEntry.rowParty).Tag) & ", 
                                    Item = " & AgL.Chk_Text(Dgl1(Col1SKU, I).Tag) & ",
                                    LotNo = " & AgL.Chk_Text(mObjFrmStockEntry.Dgl1(FrmStockEntry.Col1LotNo, mGridRowIndex).Value) & ", 
                                    EType_IR = 'R', 
                                    Qty_Rec = " & bQty_Receive & ", 
                                    Qty_Iss = " & bQty_Issue & ",
                                    Unit=" & AgL.Chk_Text(mObjFrmStockEntry.Dgl1(FrmStockEntry.Col1Unit, mGridRowIndex).Value) & ", 
                                    Rate=" & AgL.Chk_Text(mObjFrmStockEntry.Dgl1(FrmStockEntry.Col1Rate, mGridRowIndex).Value) & ", 
                                    Amount=" & AgL.Chk_Text(mObjFrmStockEntry.Dgl1(FrmStockEntry.Col1Amount, mGridRowIndex).Value) & ",
                                    Landed_Value=0                                
                                    Where DocID = '" & DocId & "' And TSr = " & TSr & " And Sr = " & Dgl1.Item(ColSNo, I).Tag & "
                                "
                            AgL.Dman_ExecuteNonQry(mQry, Conn, Cmd)
            ...
            For I As Integer = 0 To Dgl1.Rows.Count - 1
                If AgL.VNull(Dgl1.Item(Col1Qty, I).Value) > 0 Then
                    If Dgl1.Columns(Col1ItemType).Visible = False Then
                        Dgl1.Item(Col1ItemType, I).Tag = AgL.XNull(DglRow.Cells(FrmStockEntry.Col1ItemType).Tag)
                        Dgl1.Item(Col1ItemType, I).Value = AgL.XNull(DglRow.Cells(FrmStockEntry.Col1ItemType).Value)
                    End If
                    If Dgl1.Columns(Col1ItemCategory).Visible = False Then
                        Dgl1.Item(Col1ItemCategory, I).Tag = AgL.XNull(DglRow.Cells(FrmStockEntry.Col1ItemCategory).Tag)
                        Dgl1.Item(Col1ItemCategory, I).Value = AgL.XNull(DglRow.Cells(FrmStockEntry.Col1ItemCategory).Value)
                    End If
                    If Dgl1.Columns(Col1ItemGroup).Visible = False Then
                        Dgl1.Item(Col1ItemGroup, I).Tag = AgL.XNull(DglRow.Cells(FrmStockEntry.Col1ItemGroup).Tag)
                        Dgl1.Item(Col1ItemGroup, I).Value = AgL.XNull(DglRow.Cells(FrmStockEntry.Col1ItemGroup).Value)
                    End If
                    If Dgl1.Columns(Col1Item).Visible = False Then
                        Dgl1.Item(Col1Item, I).Tag = AgL.XNull(DglRow.Cells(FrmStockEntry.Col1Item).Tag)
                        Dgl1.Item(Col1Item, I).Value = AgL.XNull(DglRow.Cells(FrmStockEntry.Col1Item).Value)
                    End If
                    If Dgl1.Columns(Col1Dimension1).Visible = False Then
                        Dgl1.Item(Col1Dimension1, I).Tag = AgL.XNull(DglRow.Cells(FrmStockEntry.Col1Dimension1).Tag)
                        Dgl1.Item(Col1Dimension1, I).Value = AgL.XNull(DglRow.Cells(FrmStockEntry.Col1Dimension1).Value)
                    End If
                    If Dgl1.Columns(Col1Dimension2).Visible = False Then
                        Dgl1.Item(Col1Dimension2, I).Tag = AgL.XNull(DglRow.Cells(FrmStockEntry.Col1Dimension2).Tag)
                        Dgl1.Item(Col1Dimension2, I).Value = AgL.XNull(DglRow.Cells(FrmStockEntry.Col1Dimension2).Value)
                    End If
                    If Dgl1.Columns(Col1Dimension3).Visible = False Then
                        Dgl1.Item(Col1Dimension3, I).Tag = AgL.XNull(DglRow.Cells(FrmStockEntry.Col1Dimension3).Tag)
                        Dgl1.Item(Col1Dimension3, I).Value = AgL.XNull(DglRow.Cells(FrmStockEntry.Col1Dimension3).Value)
                    End If
                    If Dgl1.Columns(Col1Dimension4).Visible = False Then
                        Dgl1.Item(Col1Dimension4, I).Tag = AgL.XNull(DglRow.Cells(FrmStockEntry.Col1Dimension4).Tag)
                        Dgl1.Item(Col1Dimension4, I).Value = AgL.XNull(DglRow.Cells(FrmStockEntry.Col1Dimension4).Value)
                    End If
                    If Dgl1.Columns(Col1Size).Visible = False Then
                        Dgl1.Item(Col1Size, I).Tag = AgL.XNull(DglRow.Cells(FrmStockEntry.Col1Size).Tag)
                        Dgl1.Item(Col1Size, I).Value = AgL.XNull(DglRow.Cells(FrmStockEntry.Col1Size).Value)
                    End If
                End If
            Next
        Catch ex As Exception
    ...
    Private Sub ApplyUISetting()
        ClsMain.GetUISetting(Dgl1, Me.Name, AgL.PubDivCode, AgL.PubSiteCode,
                objFrmStockEntry.LblV_Type.Tag, objFrmStockEntry.DglMain.Item(FrmStockEntry.Col1Value, objFrmStockEntry.rowV_Type).Tag,
                "", objFrmStockEntry.DglMain.Item(FrmStockEntry.Col1Value, objFrmStockEntry.rowSettingGroup).Tag, ClsMain.GridTypeConstants.HorizontalGrid)
    End Sub
End Class