...
Public Class FrmSendWhatsapp
    ...
    '        ' Get the shared link
    '        Dim shareResponse = Await client.PostAsync("https://api.dropboxapi.com/2/sharing/create_shared_link_with_settings",
    '        New StringContent($"{""path"":""{dropboxPath}""}", Encoding.UTF8, "application/json"))
