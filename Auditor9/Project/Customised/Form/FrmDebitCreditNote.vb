...
Public Class FrmDebitCreditNote
    ...
    Public Const Col1SpecificationDocId As String = "Specifica  tion DocId"
    ...
    Friend WithEvents MnuEmailDocument As ToolStripMenuItem
...
#Region "Form Designer Code"
    Private Sub InitializeComponent()
        ...
        'MnuEmailDocument
        '
        Me.MnuEmailDocument.Name = "MnuEmailDocument"
        ...
        Me.TxtPartyDocNo.Location = New System.Drawing.Point(380, 81)
        ...
        Me.LblPartyDocNo.Location = New System.Drawing.Point(258, 83)
        ...
        Me.TxtPartyDocDate.Location = New System.Drawing.Point(630, 81)
        ...
        Me.TxtBank.Location = New System.Drawing.Point(382, 81)
        ...
        Me.LblBank.Location = New System.Drawing.Point(259, 81)
        ...
        Me.BtnAttachments.TabIndex = 3018
        ...
        Me.LblLinkedParty.Location = New System.Drawing.Point(258, 62)
...
#End Region
    ...
    Private Sub FrmSaleOrder_BaseFunction_IniGrid() Handles Me.BaseFunction_IniGrid
        ...
        With AgCL
            ...
            .AddAgTextColumn(Dgl1, Col1Remark, 150, 1000, Col1Remark, True, False)
    ...
    Sub PostGridToAccounts(DocID As String, MultiplyWithMinus As Boolean, ByRef Conn As Object, ByRef Cmd As Object)
        ...
        For I = 0 To Dgl1.Rows.Count - 1
            If Dgl1.Rows(I).Visible = True And Val(Dgl1(Col1Amount, I).Value) <> 0 And Dgl1.Item(Col1Amount, I).Style.ForeColor <> Color.Blue Then
                ...
                mNarration = TxtPartyName.Text & ". " & Dgl1(Col1Remark, I).Value
                ...
                If mLedgerPostingData <> "" Then mLedgerPostingData += " UNION ALL "
                mNarration = Dgl1(Col1Subcode, I).Value & ". " & Dgl1(Col1Remark, I).Value
                ...
                If LblV_Type.Tag = Ncat.Receipt Then
                    If TxtBank.Text <> "" Then
                        If mLedgerPostingData <> "" Then mLedgerPostingData += " UNION ALL "
                        mNarration = Dgl1(Col1Subcode, I).Value & " deposited cash to bank. " & Dgl1(Col1Remark, I).Value
        ...
        With DtTemp
            For I = 0 To .Rows.Count - 1
                If Trim(AgL.XNull(.Rows(I)("PostAc"))) <> "" And Val(AgL.VNull(.Rows(I)("Amount"))) <> 0 Then
                    ...
                    If AgL.StrCmp(AgL.XNull(.Rows(I)("PostAc")), "|PARTY|") Then
                        mNarration = AgL.XNull(.Rows(I)("Narration"))
                    Else
                        mNarration = TxtPartyName.Text + ", " + AgL.XNull(.Rows(I)("Narration"))
                    End If
    ...
    Private Sub FrmSaleOrder_BaseFunction_MoveRec(ByVal SearchCode As String) Handles Me.BaseFunction_MoveRec
        ...
        mQry = " Select H.*, Sg.Name as AccountName, Sg.Nature, VT.Category as VoucherCategory, Bank.Name as BankAcName, LSg.Name As LinkedPartyName, HC.*                                 
    ...
    Private Sub TxtBuyer_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles TxtPartyName.KeyDown, TxtBank.KeyDown, TxtLinkedParty.KeyDown
        Try
                    ...
                    If e.KeyCode <> Keys.Enter Then
                        If sender.AgHelpDataset Is Nothing Then
                            If AgL.StrCmp(AgL.PubDBName, "Sadhvi") Then
                                mQry = " Select Code, Name From ViewHelpSubGroup Where Code in ('D100037067','D100037068','D100037144') "
                            Else
    ...
    Private Sub Dgl1_RowEnter(sender As Object, e As DataGridViewCellEventArgs) Handles Dgl1.RowEnter
        ...
        End If
    End Sub
    Private Sub MnuImport_Click(sender As Object, e As EventArgs) Handles MnuImportFromExcel.Click, MnuImportFromDos.Click, MnuImportFromTally.Click, MnuEditSave.Click, MnuImportGSTDataFromExcel.Click, MnuImportGSTDataFromDos.Click, MnuReport.Click, MnuEmailDocument.Click, MnuPrintBulk.Click
        Select Case sender.name
    ...
    Private Sub SetAttachmentCaption()
        ...
        End If
    End Sub
    Private Sub FHPGD_Specification(ByRef e As System.Windows.Forms.KeyEventArgs)
        Dim DTMain As New DataTable
        Dim FRH As DMHelpGrid.FrmHelpGrid
        If Topctrl1.Mode = "Browse" Then Exit Sub
        If ClsMain.IsSpecialKeyPressed(e) Or e.KeyCode = Keys.Enter Then Exit Sub

        If e.KeyCode = Keys.Delete Then
            Dgl1(Col1Specification, Dgl1.CurrentCell.RowIndex).Tag = ""
            Dgl1(Col1Specification, Dgl1.CurrentCell.RowIndex).Value = ""
            Exit Sub
        End If
        ...
        If TxtVoucherCategory.Text.ToUpper = "PURCH" Then
            ...
            FRH = New DMHelpGrid.FrmHelpGrid(New DataView(DTMain), "", 400, 900)
            FRH.FFormatColumn(0, , 0, , False)
            FRH.FFormatColumn(1, "Party Doc.No.", 80, DataGridViewContentAlignment.MiddleLeft)
            FRH.FFormatColumn(2, "Invoice No.", 80, DataGridViewContentAlignment.MiddleLeft)
            FRH.FFormatColumn(3, "Doc.Type", 130, DataGridViewContentAlignment.MiddleLeft)
            FRH.FFormatColumn(4, "Doc.Date", 100, DataGridViewContentAlignment.MiddleLeft)
            FRH.FFormatColumn(5, "Item", 250, DataGridViewContentAlignment.MiddleLeft)
            FRH.FFormatColumn(6, "Qty", 70, DataGridViewContentAlignment.MiddleRight)
            FRH.FFormatColumn(7, "Rate", 70, DataGridViewContentAlignment.MiddleRight)
        ...
        Else
            ...
            FRH = New DMHelpGrid.FrmHelpGrid(New DataView(DTMain), "", 400, 900)
            FRH.FFormatColumn(0, , 0, , False)
            FRH.FFormatColumn(1, "Invoice No.", 80, DataGridViewContentAlignment.MiddleLeft)
            FRH.FFormatColumn(2, "Doc.Type", 130, DataGridViewContentAlignment.MiddleLeft)
            FRH.FFormatColumn(3, "Doc.Date", 100, DataGridViewContentAlignment.MiddleLeft)
            FRH.FFormatColumn(4, "Item", 250, DataGridViewContentAlignment.MiddleLeft)
            FRH.FFormatColumn(5, "Qty", 70, DataGridViewContentAlignment.MiddleRight)
            FRH.FFormatColumn(6, "Rate", 70, DataGridViewContentAlignment.MiddleRight)
            FRH.StartPosition = FormStartPosition.CenterScreen
            FRH.ShowDialog()
        End If
        ...
        If FRH.BytBtnValue = 0 Then
            If Not FRH.DRReturn.Equals(Nothing) Then
                Dgl1(Col1Specification, Dgl1.CurrentCell.RowIndex).Tag = AgL.XNull(FRH.DRReturn.Item(0))
                Dgl1(Col1Specification, Dgl1.CurrentCell.RowIndex).Value = AgL.XNull(FRH.DRReturn.Item(1))
            End If
        End If

        FValidate_ReferenceNo(Dgl1.CurrentCell.RowIndex)
        FRH = Nothing
        'If Dgl1.CurrentCell.RowIndex = Dgl1.Rows.Count - 1 Then Dgl1.Rows.Add()
    End Sub
