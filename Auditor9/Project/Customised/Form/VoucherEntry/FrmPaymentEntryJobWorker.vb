...
Public Class FrmPaymentEntryJobWorker
    ...
    Public Const Col1BalanceInvoiceAmount As String = "Balance Invoice Amount"
    Public Const Col1BalanceAdvance As String = "Balance Advance"
    Public Const Col1OtherBalanceAmount As String = "Other Balance Amount"
    Public Const Col1Deduction As String = "Deduction"
    Public Const Col1OtherCharges As String = "Other Charges"
    Public Const Col1NetPayableAmount As String = "Net Payable Amount"
    Public Const Col1PaidAmount As String = "Paid Amount"
...
#Region "Form Designer Code"
    Private Sub InitializeComponent()
        ...
        Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(FrmPaymentEntryJobWorker))
        ...
        Me.Label4.Location = New System.Drawing.Point(363, 70)
        ...
        Me.TxtPartyName.Location = New System.Drawing.Point(380, 63)
        ...
        Me.LblPartyName.Location = New System.Drawing.Point(258, 63)
        ...
        Me.Label30.Location = New System.Drawing.Point(258, 45)
        ...
        'MnuOptions
        '
        Me.MnuOptions.Items.AddRange(New System.Windows.Forms.ToolStripItem() {Me.MnuImportFromExcel, Me.MnuImportGSTDataFromDos, Me.MnuImportGSTDataFromExcel, Me.MnuImportFromTally, Me.MnuImportFromDos, Me.MnuEditSave, Me.MnuCancelEntry, Me.MnuReport, Me.MnuPrintCheque})
        ...
        Me.TxtPartyDocNo.Location = New System.Drawing.Point(380, 82)
        ...
        Me.LblPartyDocNo.Location = New System.Drawing.Point(258, 84)
        ...
        Me.TxtPartyDocDate.Location = New System.Drawing.Point(800, 31)
        ...
        Me.LblPartyDocDate.Location = New System.Drawing.Point(508, 83)
        ...
        Me.TxtBank.Location = New System.Drawing.Point(382, 82)
        ...
        Me.LblBank.Location = New System.Drawing.Point(259, 82)
        ...
        Me.BtnFill.Location = New System.Drawing.Point(906, 166)
        Me.BtnFill.Name = "BtnFill"
        Me.BtnFill.Size = New System.Drawing.Size(69, 23)
        Me.BtnFill.TabIndex = 3007
        Me.BtnFill.Text = "Fill"
        Me.BtnFill.UseVisualStyleBackColor = True
        '
        'FrmPaymentEntryJobWorker
        '
        ...
        Me.MaximizeBox = True
        Me.Name = "FrmPaymentEntryJobWorker"
...
#End Region
    ...
    Private Sub FrmSaleOrder_BaseFunction_IniGrid() Handles Me.BaseFunction_IniGrid
        ...
        With AgCL
            ...
            .AddAgNumberColumn(Dgl1, Col1BalanceInvoiceAmount, 100, 8, 2, False, Col1BalanceInvoiceAmount, True, True, True)
            .AddAgNumberColumn(Dgl1, Col1BalanceAdvance, 100, 8, 2, False, Col1BalanceAdvance, True, False, True)
            .AddAgNumberColumn(Dgl1, Col1OtherBalanceAmount, 100, 8, 2, False, Col1OtherBalanceAmount, True, True, True)
            ...
            .AddAgNumberColumn(Dgl1, Col1NetPayableAmount, 100, 8, 2, False, Col1NetPayableAmount, True, True, True)
            .AddAgNumberColumn(Dgl1, Col1PaidAmount, 100, 8, 2, False, Col1PaidAmount, True, False, True)
        ...
        AgCalcGrid1.AgLineGridGrossColumn = Dgl1.Columns(Col1PaidAmount).Index
        ...
        Try
            ...
            If DtTemp.Rows.Count > 0 Then
                ...
                For I = 0 To DtTemp.Rows.Count - 1
                    ...
                    Dgl1.Item(Col1PaidAmount, mRow).Value = AgL.XNull(DtTemp.Rows(I)("Freight"))
                Next
    ...
    Private Sub FrmSaleOrder_BaseEvent_Save_InTrans(ByVal SearchCode As String, ByVal Conn As Object, ByVal Cmd As Object) Handles Me.BaseEvent_Save_InTrans
        ...
        For I = 0 To Dgl1.RowCount - 1
            If IIf(LblV_Type.Tag = Ncat.CreditNoteCustomer Or LblV_Type.Tag = Ncat.DebitNoteCustomer Or LblV_Type.Tag = Ncat.DebitNoteSupplier Or LblV_Type.Tag = Ncat.CreditNoteSupplier, Dgl1.Item(Col1Remark, I).Value, Dgl1.Item(Col1Subcode, I).Value) <> "" Then
                If mMultiplyWithMinus Then
                    ...
                    Dgl1.Item(Col1PaidAmount, I).Value = -Math.Abs(Val(Dgl1.Item(Col1PaidAmount, I).Value))
                End If
                ...
                If Dgl1.Item(ColSNo, I).Tag Is Nothing And Dgl1.Rows(I).Visible = True Then
                    ...
                    bSelectionQry += " Select " & AgL.Chk_Text(mSearchCode) & ", " & mSr & ", " &
                                            ...
                                            " " & Val(Dgl1.Item(Col1PaidAmount, I).Value) & ", " &
                                            ...
                                            " " & Val(Dgl1.Item(Col1BalanceInvoiceAmount, I).Value) & ", " &
                                            " " & Val(Dgl1.Item(Col1BalanceAdvance, I).Value) & ", " &
                                            " " & Val(Dgl1.Item(Col1OtherBalanceAmount, I).Value) & ", " &
                                            " " & Val(Dgl1.Item(Col1NetPayableAmount, I).Value) & ", " &
                    ...
                    If Dgl1.Rows(I).Visible = True Then
                        ...
                        If Dgl1.Rows(I).DefaultCellStyle.BackColor <> RowLockedColour Then
                            mQry = " UPDATE LedgerHeadDetail " &
                                        ...
                                        " Amount = " & Val(Dgl1.Item(Col1PaidAmount, I).Value) & ", " &
                                        ...
                                        " BalanceInvoiceAmount = " & Val(Dgl1.Item(Col1BalanceInvoiceAmount, I).Value) & ", " &
                                        " BalanceAdvance = " & Val(Dgl1.Item(Col1BalanceAdvance, I).Value) & ", " &
                                        " OtherBalanceAmount = " & Val(Dgl1.Item(Col1OtherBalanceAmount, I).Value) & ", " &
                                        " NetPayableAmount = " & Val(Dgl1.Item(Col1NetPayableAmount, I).Value) & ", " &
                                        " UploadDate = Null, " &
                ...
                If Dgl1.Item(Col1PaidAmount, I).Tag IsNot Nothing Then
                    CType(Dgl1.Item(Col1PaidAmount, I).Tag, FrmVoucherEntryCash).FSave(mSearchCode, IIf(Val(Dgl1.Item(ColSNo, I).Tag) = 0, mSr, Val(Dgl1.Item(ColSNo, I).Tag)), Conn, Cmd)
                End If
            End If
        Next
        ...
        If bSelectionQry <> "" Then
            mQry = "Insert Into LedgerHeadDetail(DocId, Sr, Subcode, LinkedSubcode, Barcode, Specification, HSN, SalesTaxGroupItem, " &
                       ...
                       " SpecificationDocId, SpecificationDocIdSr, BalanceInvoiceAmount, 
                       BalanceAdvance, OtherBalanceAmount, NetPayableAmount, EffectiveDate) " & bSelectionQry
            AgL.Dman_ExecuteNonQry(mQry, Conn, Cmd)
    ...
    Sub PostGridToAccounts(DocID As String, MultiplyWithMinus As Boolean, ByRef Conn As Object, ByRef Cmd As Object)
        ...
        For I = 0 To Dgl1.Rows.Count - 1
            If Dgl1.Rows(I).Visible = True And Val(Dgl1(Col1PaidAmount, I).Value) <> 0 And Dgl1.Item(Col1PaidAmount, I).Style.ForeColor <> Color.Blue Then
                If mLedgerPostingData <> "" Then mLedgerPostingData += " UNION ALL "
                mNarration = TxtV_Type.Text & " : " & TxtPartyName.Text & ". "
                ...
                mLedgerPostingData += " Select " & AgL.Chk_Text(Dgl1(Col1TempSno, I).Value) & " as TSr, " & AgL.Chk_Text(Dgl1(Col1Subcode, I).Tag) & " as Subcode, " & AgL.Chk_Text(Dgl1(Col1LinkedSubcode, I).Tag) & " as LinkedSubcode, " & AgL.Chk_Text(TxtPartyName.Tag) & "  as ContraAc, " & IIf(mHeaderAccountDrCr.ToUpper = "CR", Val(Dgl1(Col1PaidAmount, I).Value), 0) & " as AmtDr, " & IIf(mHeaderAccountDrCr.ToUpper = "DR", Val(Dgl1(Col1PaidAmount, I).Value), 0) & " as AmtCr, " & AgL.Chk_Text(mNarration) & " as Narration, " & AgL.Chk_Text(Dgl1(Col1ChqRefNo, I).Value) & " as ChqNo, " & AgL.Chk_Date(Dgl1(Col1ChqRefDate, I).Value) & " as ChqDate, " & AgL.Chk_Date(Dgl1(Col1EffectiveDate, I).Value) & " as EffectiveDate "

                If mLedgerPostingData <> "" Then mLedgerPostingData += " UNION ALL "
                mNarration = TxtV_Type.Text & " : " & Dgl1(Col1Subcode, I).Value & ". "
                If LblV_Type.Tag = Ncat.Receipt And TxtBank.Text <> "" Then
                    mNarration = mNarration & " deposited cash to " & TxtBank.Text & ". "
                End If
                mNarration = mNarration & Dgl1(Col1Remark, I).Value

                mLedgerPostingData += " Select " & AgL.Chk_Text(Dgl1(Col1TempSno, I).Value) & "  as TSr, " & AgL.Chk_Text(TxtPartyName.Tag) & " as Subcode, Null as LinkedSubcode, " & AgL.Chk_Text(Dgl1(Col1Subcode, I).Tag) & "  as ContraAc, " & IIf(mHeaderAccountDrCr.ToUpper = "DR", Val(Dgl1(Col1PaidAmount, I).Value), 0) & " as AmtDr, " & IIf(mHeaderAccountDrCr.ToUpper = "CR", Val(Dgl1(Col1PaidAmount, I).Value), 0) & " as AmtCr, " & AgL.Chk_Text(mNarration) & " as Narration, " & AgL.Chk_Text(Dgl1(Col1ChqRefNo, I).Value) & " as ChqNo, " & AgL.Chk_Date(Dgl1(Col1ChqRefDate, I).Value) & " as ChqDate, " & AgL.Chk_Date(Dgl1(Col1EffectiveDate, I).Value) & " as EffectiveDate "
                ...
                If Val(Dgl1(Col1Deduction, I).Value) > 0 Then
                    If mLedgerPostingData <> "" Then mLedgerPostingData += " UNION ALL "
                    mNarration = TxtV_Type.Text & " : Amount deducted."
                    mNarration = mNarration & Dgl1(Col1Remark, I).Value
                    ...
                    If mLedgerPostingData <> "" Then mLedgerPostingData += " UNION ALL "
                    mNarration = TxtV_Type.Text & " : " & Dgl1(Col1Subcode, I).Value & ". Amount deducted."
                    mNarration = mNarration & Dgl1(Col1Remark, I).Value
                ...
                If Val(Dgl1(Col1OtherCharges, I).Value) > 0 Then
                    If mLedgerPostingData <> "" Then mLedgerPostingData += " UNION ALL "
                    mNarration = TxtV_Type.Text & " : " & TxtPartyName.Text & ". Other Charges."
                    mNarration = mNarration & Dgl1(Col1Remark, I).Value
                    ...
                    If mLedgerPostingData <> "" Then mLedgerPostingData += " UNION ALL "
                    mNarration = TxtV_Type.Text & " : " & Dgl1(Col1Subcode, I).Value & ". Other Charges."
                    mNarration = mNarration & Dgl1(Col1Remark, I).Value
                ...
                If LblV_Type.Tag = Ncat.Receipt Then
                    If TxtBank.Text <> "" Then
                        If mLedgerPostingData <> "" Then mLedgerPostingData += " UNION ALL "
                        mNarration = TxtV_Type.Text & " : " & Dgl1(Col1Subcode, I).Value & " deposited cash to " & TxtBank.Text & ". " & Dgl1(Col1Remark, I).Value
                        mLedgerPostingData += " Select Null as TSr, " & AgL.Chk_Text(TxtBank.Tag) & " as Subcode, Null as LinkedSubcode, " & AgL.Chk_Text(TxtPartyName.Tag) & "  as ContraAc, " & IIf(mHeaderAccountDrCr.ToUpper = "DR", Val(Dgl1(Col1PaidAmount, I).Value), 0) & " as AmtDr, " & IIf(mHeaderAccountDrCr.ToUpper = "CR", Val(Dgl1(Col1PaidAmount, I).Value), 0) & " as AmtCr, " & AgL.Chk_Text(mNarration) & " as Narration, " & AgL.Chk_Text(Dgl1(Col1ChqRefNo, I).Value) & " as ChqNo, " & AgL.Chk_Date(Dgl1(Col1ChqRefDate, I).Value) & " as ChqDate, " & AgL.Chk_Date(Dgl1(Col1EffectiveDate, I).Value) & " as EffectiveDate "


                        If mLedgerPostingData <> "" Then mLedgerPostingData += " UNION ALL "
                        mNarration = TxtV_Type.Text & " : " & Dgl1(Col1Subcode, I).Value & " deposited cash to " & TxtBank.Text & ". " & Dgl1(Col1Remark, I).Value
                        mLedgerPostingData += " Select Null as TSr, " & AgL.Chk_Text(TxtPartyName.Tag) & " as Subcode, Null as LinkedSubcode, " & AgL.Chk_Text(TxtBank.Tag) & "  as ContraAc, " & IIf(mHeaderAccountDrCr.ToUpper = "CR", Val(Dgl1(Col1PaidAmount, I).Value), 0) & " as AmtDr, " & IIf(mHeaderAccountDrCr.ToUpper = "DR", Val(Dgl1(Col1PaidAmount, I).Value), 0) & " as AmtCr, " & AgL.Chk_Text(mNarration) & " as Narration, " & AgL.Chk_Text(Dgl1(Col1ChqRefNo, I).Value) & " as ChqNo, " & AgL.Chk_Date(Dgl1(Col1ChqRefDate, I).Value) & " as ChqDate, " & AgL.Chk_Date(Dgl1(Col1EffectiveDate, I).Value) & " as EffectiveDate "
                    End If
                End If
            End If
        Next
        ...
        mLedgerPostingData = "Select TSr, SubCode, LinkedSubcode, ContraAc, Narration, AmtDr*1.0 as AmtDr, AmtCr*1.0 as AmtCr, ChqNo, ChqDate, EffectiveDate 
            ...
            For J = 0 To FGMain.AgLineGrid.Rows.Count - 1
                If FGMain.AgLineGrid.Rows(J).Visible Then
                    If AgL.XNull(FGMain.AgChargesValue(FGMain(AgStructure.AgCalcGrid.AgCalcGridColumn.Col_Charges, I).Tag, J, AgStructure.AgCalcGrid.LineColumnType.PostAc)) <> "" Then
                        If Dgl1.Item(Col1PaidAmount, J).Style.ForeColor = Color.Blue And FGMain(AgStructure.AgCalcGrid.AgCalcGridColumn.Col_Charges, I).Tag.ToString.ToUpper = "GAMT" Then
                ...
                With DsTemp.Tables(0)
                    ...
                    If .Rows.Count > 0 Then
                        For I = 0 To DsTemp.Tables(0).Rows.Count - 1
                            ...
                            Dgl1.Item(Col1PaidAmount, I).Value = Format(Math.Abs(AgL.VNull(.Rows(I)("Amount"))), "0.00")
                            ...
                            Dgl1.Item(Col1BalanceInvoiceAmount, I).Value = Format(Math.Abs(AgL.VNull(.Rows(I)("BalanceInvoiceAmount"))), "0.00")
                            Dgl1.Item(Col1BalanceAdvance, I).Value = Format(Math.Abs(AgL.VNull(.Rows(I)("BalanceAdvance"))), "0.00")
                            Dgl1.Item(Col1OtherBalanceAmount, I).Value = Format(Math.Abs(AgL.VNull(.Rows(I)("OtherBalanceAmount"))), "0.00")
                            Dgl1.Item(Col1NetPayableAmount, I).Value = Format(Math.Abs(AgL.VNull(.Rows(I)("NetPayableAmount"))), "0.00")
                            ...
                            If TxtNature.Text.ToUpper = "CASH" Then
                                ...
                                If AgL.Dman_Execute(mQry, AgL.GCn).ExecuteScalar > 0 Then
                                    Dgl1.Item(Col1PaidAmount, I).Style.ForeColor = Color.Blue
    ...
    Private Sub ShowVoucherEntryCash(mRowIndex As Integer, Optional ShowDialog As Boolean = True)
        ...
        If TxtNature.Text.ToUpper = "CASH" Then
            'If Val(Dgl1.Item(Col1PaidAmount, mRowIndex).Value) > AgL.VNull(AgL.PubDtEnviro.Rows(0)("MaximumCashTransactionLimit")) And Not AgL.XNull(DtV_TypeSettings.Rows(0)("ActionIfMaximumCashTransactionLimitExceeds")) = ActionsOfMaximumCashTransactionLimitExceeds.None Then
            If Val(Dgl1.Item(Col1PaidAmount, mRowIndex).Value) > 0 And Not AgL.XNull(DtV_TypeSettings.Rows(0)("ActionIfMaximumCashTransactionLimitExceeds")) = ActionsOfMaximumCashTransactionLimitExceeds.None Then
                If Dgl1.Item(Col1PaidAmount, mRowIndex).Tag IsNot Nothing Then
                    CType(Dgl1.Item(Col1PaidAmount, mRowIndex).Tag, FrmVoucherEntryCash).StartPosition = FormStartPosition.CenterScreen
                    CType(Dgl1.Item(Col1PaidAmount, mRowIndex).Tag, FrmVoucherEntryCash).ShowDialog()
                    Dgl1.Item(Col1PaidAmount, mRowIndex).Value = CType(Dgl1.Item(Col1PaidAmount, mRowIndex).Tag, FrmVoucherEntryCash).LblTotalAmount.Text
                    If CType(Dgl1.Item(Col1PaidAmount, mRowIndex).Tag, FrmVoucherEntryCash).IsDeleteAllButtonPressed Then
                        Dgl1.Item(Col1PaidAmount, mRowIndex).Tag = Nothing
                        Dgl1.Item(Col1PaidAmount, mRowIndex).Style.ForeColor = Color.Black
                    Else
                        Dgl1.Item(Col1PaidAmount, mRowIndex).Style.ForeColor = Color.Blue
                    End If
                Else
                    ...
                    objFrmVoucherEntryCash.TotalAmount = Val(Dgl1.Item(Col1PaidAmount, mRowIndex).Value)
                    objFrmVoucherEntryCash.Ini_Grid()
                    objFrmVoucherEntryCash.MoveRec(mSearchCode, Val(Dgl1.Item(ColSNo, mRowIndex).Tag))
                    Dgl1.Item(Col1PaidAmount, mRowIndex).Tag = objFrmVoucherEntryCash
                    If ShowDialog Then
    ...
    Private Sub FrmSaleOrder_BaseFunction_Calculation() Handles Me.BaseFunction_Calculation
        ...
        For I = 0 To Dgl1.RowCount - 1
            If Dgl1.Item(Col1Subcode, I).Value <> "" Then
                ...
                If Dgl1.Item(Col1Rate, I).Value > 0 Then
                    Dgl1.Item(Col1PaidAmount, I).Value = Format(Val(Dgl1.Item(Col1Qty, I).Value) * Val(Dgl1.Item(Col1Rate, I).Value), "0.".PadRight(CType(Dgl1.Columns(Col1PaidAmount), AgControls.AgTextColumn).AgNumberRightPlaces + 2, "0"))
                End If
        ...
        AgCalcGrid1.AgLineGrid = Dgl1
        AgCalcGrid1.AgLineGridMandatoryColumn = Dgl1.Columns(Col1PaidAmount).Index
        AgCalcGrid1.AgLineGridGrossColumn = Dgl1.Columns(Col1PaidAmount).Index
    ...
    Private Sub Dgl1_CellEnter(ByVal sender As Object, ByVal e As System.Windows.Forms.DataGridViewCellEventArgs) Handles Dgl1.CellEnter
        Try
            ...
            Select Case Dgl1.Columns(Dgl1.CurrentCell.ColumnIndex).Name
                ...
                Case Col1PaidAmount
                    Dgl1.CurrentCell.ReadOnly = IIf(Dgl1.Item(Col1PaidAmount, Dgl1.CurrentCell.RowIndex).Tag Is Nothing, False, True)
            End Select
    ...
    Private Sub Dgl1_RowEnter(sender As Object, e As DataGridViewCellEventArgs) Handles Dgl1.RowEnter
        ...
        End If
    End Sub
    Private Sub MnuImport_Click(sender As Object, e As EventArgs) Handles MnuImportFromExcel.Click, MnuImportFromDos.Click, MnuImportFromTally.Click, MnuEditSave.Click, MnuCancelEntry.Click, MnuImportGSTDataFromExcel.Click, MnuImportGSTDataFromDos.Click, MnuReport.Click, MnuPrintCheque.Click
        Select Case sender.name
                ...
                If AgL.VNull(LedgerHeadTableList(I).Line_Amount) <> 0 Or AgL.VNull(LedgerHeadTableList(I).Line_Amount_Cr) <> 0 Then
                    If Trim(LedgerHeadTableList(I).SubcodeName) <> Trim(LedgerHeadTableList(I).Line_SubCodeName) Then
                        ...
                        mQry = "Insert Into LedgerHeadDetail(DocId, Sr, Subcode, LinkedSubcode, Specification, SalesTaxGroupItem, HSN, " &
                           ...
                           " SpecificationDocId, SpecificationDocIdSr, ReferenceNo, ReferenceDate)
                            Select " & AgL.Chk_Text(LedgerHeadTableList(0).DocID) & ", 
    ...
    Private Sub Dgl1_CellDoubleClick(sender As Object, e As DataGridViewCellEventArgs) Handles Dgl1.CellDoubleClick
        If e.RowIndex >= 0 Then
            If Dgl1.Columns(e.ColumnIndex).Name = Col1PaidAmount And Dgl1.Item(Col1PaidAmount, e.RowIndex).Style.ForeColor = Color.Blue Then ShowVoucherEntryCash(e.RowIndex)
        End If
    End Sub
    Private Sub Dgl1_KeyPress(sender As Object, e As KeyPressEventArgs) Handles Dgl1.KeyPress
        If Dgl1.CurrentCell Is Nothing Then Exit Sub
        If Dgl1.CurrentCell.ColumnIndex = Dgl1.Columns(Col1PaidAmount).Index Then
            If Dgl1.Item(Col1PaidAmount, Dgl1.CurrentCell.RowIndex).Tag IsNot Nothing Then
    ...
    Private Sub FrmPaymentEntryJobWorker_BaseEvent_Topctrl_tbMore() Handles Me.BaseEvent_Topctrl_tbMore
    ...
    End Sub
    Private Sub FrmPaymentEntryJobWorker_BaseEvent_Topctrl_tbDel(ByRef Passed As Boolean) Handles Me.BaseEvent_Topctrl_tbDel
        Passed = Not FGetRelationalData()
    ...
    Private Function FGetRelationalData() As Boolean
        ...
        End Try
    End Function
    Private Sub FillJobWorkerBalance()
        Dim I As Integer = 0

        mQry = " SELECT V1.SubCode, Max(Sg.Name) AS PartyName, Sum(V1.BalanceInvoiceAmount) AS BalanceInvoiceAmount, 
                Sum(V1.BalanceAdvance) AS BalanceAdvance, 
                Sum(V1.CurrentBalance) - Sum(V1.BalanceInvoiceAmount) - Sum(V1.BalanceAdvance) AS OtherBalanceAmount
                FROM (
	                SELECT L.SubCode, IsNull(L.AmtCr,0) - IsNull(VAdj.Amount,0) AS BalanceInvoiceAmount, 0 AS BalanceAdvance, 0 AS CurrentBalance
	                FROM Ledger L
	                LEFT JOIN Voucher_Type Vt ON L.V_Type = Vt.V_Type
	                LEFT JOIN (
		                SELECT Lad.Adj_DocID, Lad.Adj_V_SNo, Sum(Lad.Amount) AS Amount
		                FROM LedgerAdj Lad
		                GROUP BY Lad.Adj_DocID, Lad.Adj_V_SNo) AS VAdj ON L.DocId = VAdj.Adj_DocID AND L.V_SNo = VAdj.Adj_V_SNo
	                ...
	                SELECT L.SubCode, 0 AS BalanceInvoiceAmount, IsNull(L.AmtDr,0) - IsNull(VAdj.Amount,0) AS BalanceAdvance, 0 AS CurrentBalance
	                FROM Ledger L
	                LEFT JOIN LedgerHead H ON L.DocId = H.DocID
	                LEFT JOIN Voucher_Type Vt ON L.V_Type = Vt.V_Type
	                LEFT JOIN (
		                ...
		                FROM LedgerAdj Lad
		                GROUP BY Lad.Adj_DocID, Lad.Adj_V_SNo) AS VAdj ON L.DocId = VAdj.Adj_DocID AND L.V_SNo = VAdj.Adj_V_SNo
	                WHERE H.Type = 'Advance'
	                AND IsNull(L.AmtDr,0) > 0
	                AND L.V_Date <= '" & TxtV_Date.Text & "'
	
	                UNION ALL
	
	                SELECT L.SubCode, 0 AS BalanceInvoiceAmount, 0 AS BalanceAdvance, IsNull(Sum(L.AmtDr),0) - IsNull(Sum(L.AmtCr),0) AS CurrentBalance
	                FROM Ledger L
	                LEFT JOIN Subgroup Sg ON L.SubCode = Sg.Subcode
	                WHERE Sg.SubgroupType = '" & SubgroupType.Jobworker & "'
	                AND L.V_Date <= '" & TxtV_Date.Text & "'
	                GROUP BY L.SubCode
	                HAVING IsNull(Sum(L.AmtDr),0) - IsNull(Sum(L.AmtCr),0) > 0
                ) AS V1
                LEFT JOIN ViewHelpSubgroup Sg ON V1.SubCode = Sg.Code
                GROUP BY V1.SubCode	"
        ...
        If DtTemp.Rows.Count > 0 Then
            For I = 0 To DtTemp.Rows.Count - 1
                ...
                Dgl1.Item(Col1Subcode, I).Value = AgL.XNull(DtTemp.Rows(I)("PartyName"))
                Dgl1.Item(Col1BalanceInvoiceAmount, I).Value = AgL.VNull(DtTemp.Rows(I)("BalanceInvoiceAmount"))
                Dgl1.Item(Col1BalanceAdvance, I).Value = AgL.VNull(DtTemp.Rows(I)("BalanceAdvance"))
                Dgl1.Item(Col1OtherBalanceAmount, I).Value = AgL.VNull(DtTemp.Rows(I)("OtherBalanceAmount"))
                Dgl1.Item(Col1NetPayableAmount, I).Value = Val(Dgl1.Item(Col1BalanceInvoiceAmount, I).Value) +
                            Val(Dgl1.Item(Col1OtherBalanceAmount, I).Value) - Dgl1.Item(Col1BalanceAdvance, I).Value
            Next I
        End If
    End Sub
    Private Sub BtnFill_Click(sender As Object, e As EventArgs) Handles BtnFill.Click
        FillJobWorkerBalance()
    End Sub
End Class
