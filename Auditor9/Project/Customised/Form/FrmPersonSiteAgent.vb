...
Public Class FrmPersonSiteAgent
    ...
    Public Const Col1Agent As String = "Agent"

    Dim mSearchCode As String
    Dim mSubgroupType As String
    ...
    Public Sub IniGrid(DocID As String)
        ...
        With AgCL
            ...
            .AddAgTextColumn(Dgl1, Col1Agent, 400, 255, Col1Agent, True, False)
        End With
    ...
    Public Sub FMoverec(DocID As String)
        ...
        If DocID = "" Then
            If AgL.VNull(DtSubgroupTypeSettings.Rows(0)("PersonCanHaveDivisionWiseAgentYn")) = True And AgL.VNull(DtSubgroupTypeSettings.Rows(0)("PersonCanHaveSiteWiseAgentYn")) = True Then
                mQry = "Select D.Div_Code, D.Div_Name, S.Code as Site_Code, S.Name as Site_Name, Null as Agent, Null as AgentName
                From Division D, SiteMast S Order By D.Div_Name, S.Site_Name"
            ElseIf AgL.VNull(DtSubgroupTypeSettings.Rows(0)("PersonCanHaveDivisionWiseAgentYn")) = True Then
                mQry = "Select D.Div_Code, D.Div_Name, Null as Site_Code, Null as Site_Name, Null as Agent, Null as AgentName
                From Division D "
            ElseIf AgL.VNull(DtSubgroupTypeSettings.Rows(0)("PersonCanHaveSiteWiseAgentYn")) = True Then
                mQry = "Select Null as Div_Code, Null as Div_Name, S.Code as Site_Code, S.Name as Site_Name, Null as Agent, Null as AgentName
                From SiteMast S "
            End If
        Else
            If AgL.VNull(DtSubgroupTypeSettings.Rows(0)("PersonCanHaveDivisionWiseAgentYn")) = True And AgL.VNull(DtSubgroupTypeSettings.Rows(0)("PersonCanHaveSiteWiseAgentYn")) = True Then
                mQry = "Select D.Div_Code, D.Div_Name, S.Code as Site_Code, S.Name as Site_Name, L.Agent, Rt.Name as AgentName
                ...
                Left Join viewHelpSubgroup Rt On L.Agent = Rt.Code"
            ElseIf AgL.VNull(DtSubgroupTypeSettings.Rows(0)("PersonCanHaveDivisionWiseAgentYn")) = True Then
                mQry = "Select Null as Div_Code, Null as Div_Name, S.Code as Site_Code, S.Name as Site_Name, L.Agent, Rt.Name as AgentName
                From Division D  With (NoLock)                
                Left Join SubgroupSiteDivisionDetail L With (NoLock) On D.Div_Code = L.Div_Code And L.Subcode = '" & DocID & "'  
                Left Join viewHelpSubgroup Rt On L.Agent = Rt.Code"
            ElseIf AgL.VNull(DtSubgroupTypeSettings.Rows(0)("PersonCanHaveSiteWiseAgentYn")) = True Then
                mQry = "Select Null as Div_Code, Null as Div_Name, Site.Code as Site_Code, Site.Name as Site_Name, L.Agent, Rt.Name as AgentName
        ...
        With DsTemp.Tables(0)
            ...
            If .Rows.Count > 0 Then
                For I = 0 To DsTemp.Tables(0).Rows.Count - 1
                    ...
                    Dgl1.Item(Col1Agent, I).Tag = AgL.XNull(.Rows(I)("Agent"))
                    Dgl1.Item(Col1Agent, I).Value = AgL.XNull(.Rows(I)("AgentName"))
                Next I
            End If
        End With
        Calculation()
    ...
    Function FData_Validation() As String
        ...
        '    If Dgl1.Item(Col1Agent, I).Value = "" Then
        ...
        '                Dgl1.CurrentCell = Dgl1.Item(Col1Agent, I) : Dgl1.Focus()
        ...
        If AgL.VNull(DtSubgroupTypeSettings.Rows(0)("PersonCanHaveDivisionWiseAgentYn")) = True And AgL.VNull(DtSubgroupTypeSettings.Rows(0)("PersonCanHaveSiteWiseAgentYn")) = True Then
            For I = 0 To Dgl1.RowCount - 1
                If Dgl1.Rows(I).Visible Then
                    mQry = " Update SubgroupSiteDivisionDetail Set Agent =" & AgL.Chk_Text(Dgl1.Item(Col1Agent, I).Tag) & "  
                             Where Div_Code = '" & Dgl1.Item(Col1Division, I).Tag & "' And Site_Code = '" & Dgl1.Item(Col1Site, I).Tag & "' And Subcode = '" & DocId & "' "
                    AgL.Dman_ExecuteNonQry(mQry, Conn, Cmd)

                    If mSubgroupType.ToUpper = "MASTER CUSTOMER" Then
                        mQry = " Update SubgroupSiteDivisionDetail Set Agent =" & AgL.Chk_Text(Dgl1.Item(Col1Agent, I).Tag) & "  
                             Where Div_Code = '" & Dgl1.Item(Col1Division, I).Tag & "' And Site_Code = '" & Dgl1.Item(Col1Site, I).Tag & "' And Subcode In (Select Subcode From Subgroup Where Subcode = '" & DocId & "') "
                        AgL.Dman_ExecuteNonQry(mQry, Conn, Cmd)
                    End If
    ...
    Private Sub FrmPersonSiteAgent_Closing(sender As Object, e As CancelEventArgs) Handles Me.Closing
        ...
        For I = 1 To Dgl1.Rows.Count - 1
            If Dgl1.Item(Col1Agent, I).Value <> Dgl1.Item(Col1Agent, I - 1).Value Then
                mDistinctData += 1
            End If
        Next
