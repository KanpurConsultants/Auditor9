...
Public Class FrmPersonWiseExtraDiscount
    ...
    Public Sub IniGrid(DocID As String)
        ...
        With AgCL
            ...
            .AddAgTextColumn(Dgl1, Col1xItemGroup, 260, 255, Col1xItemGroup, False, False)
            ...
            .AddAgTextColumn(Dgl1, Col1ItemGroup, 260, 255, Col1ItemGroup, CBool(AgL.VNull(DtSubgroupTypeSettings.Rows(0)("PersonCanHaveItemGroupWiseDiscountYn"))), False)
            .AddAgTextColumn(Dgl1, Col1ExtraDiscountPattern, 100, 255, Col1ExtraDiscountPattern, False, False)
            .AddAgNumberColumn(Dgl1, Col1ExtraDiscountPer, 100, 5, 2, False, Col1ExtraDiscountPer, True, False, True)
        End With
    ...
    Public Sub FSave(DocId As String, ByVal Conn As Object, ByVal Cmd As Object)
        ...
        mQry = " Delete From PersonExtraDiscount Where Person='" & DocId & "' And (ItemGroup Is Not NUll Or ItemCategory Is Not Null )"
