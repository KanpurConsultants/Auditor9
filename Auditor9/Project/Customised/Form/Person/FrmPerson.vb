...
Public Class FrmPerson
    ...
    Public Const rowIsMSMERegistred As Integer = 61
    Public Const rowMSMEType As Integer = 62
    Public Const rowTradeType As Integer = 63
    Public Const rowUdyamNo As Integer = 64
    Public Const rowRemarks As Integer = 65
...
#End Region
    ...
    Private Sub FrmQuality1_BaseFunction_MoveRec(ByVal SearchCode As String) Handles Me.BaseFunction_MoveRec
        ...
        With DsTemp.Tables(0)
            If .Rows.Count > 0 Then
                ...
                If AgL.XNull(.Rows(0)("SubgroupTypeDesc")) <> "" Then
                    Dgl1(Col1Value, rowSubgroupType).Value = AgL.XNull(.Rows(0)("SubgroupTypeDesc"))
                Else
                ...
                Dgl1(Col1Value, rowReligion).Tag = AgL.XNull(.Rows(0)("Religion"))
                Dgl1(Col1Value, rowReligion).Value = AgL.XNull(.Rows(0)("ReligionName"))
                Dgl1(Col1Value, rowCaste).Tag = AgL.XNull(.Rows(0)("Caste"))
                Dgl1(Col1Value, rowCaste).Value = AgL.XNull(.Rows(0)("CasteName"))
        ...
        Topctrl1.tPrn = False
        If AgL.StrCmp(Dgl1.Item(Col1Value, rowSubgroupType).Tag, AgLibrary.ClsMain.agConstants.SubgroupType.Process) And
        ...
        Try
            ...
            If Topctrl1.Mode = "Add" Then
                mQry = "INSERT INTO SubGroup(SubCode, Site_Code, Name, DispName, " &
                        ...
                        " Religion, Caste, ReconciliationUpToDate, IsMSMERegistred, MSMEType, TradeType, UdyamNo, Tags, Remarks, " &
            ...
            Else
                mQry = "UPDATE SubGroup " &
                        ...
                        " Religion = " & AgL.Chk_Text(Dgl1(Col1Value, rowReligion).Tag) & ", " &
            ...
            If Dgl1.Item(Col1Value, rowSubgroupType).Tag = AgLibrary.ClsMain.agConstants.SubgroupType.Process Then
            ...
            If Val(Dgl1.Item(Col1BtnDetail, rowAgent).Value) = 0 Then
                ...
                If Dgl1.Item(Col1Value, rowSubgroupType).Tag.ToString.ToUpper = "MASTER CUSTOMER" Then
                    mQry = "Update SubgroupSiteDivisionDetail Set 
                        Agent = " & AgL.Chk_Text(Dgl1.Item(Col1Value, rowAgent).Tag) & " 
    ...
    Public Function FOpenPersonMaster(SubgroupType As String) As String
        ...
        frmObj.Dgl1(Col1Value, rowSubgroupType).Value = AgL.XNull(AgL.Dman_Execute(" Select IfNull(Description,SubGroupType) 
                                                From SubGroupType Where SubGroupType ='" & frmObj.Dgl1(Col1Value, rowSubgroupType).Tag & "'", AgL.GCn).ExecuteScalar())
    ...
    Private Sub FrmParty_BaseEvent_Topctrl_tbAdd() Handles Me.BaseEvent_Topctrl_tbAdd
        ...
        If Dgl1(Col1LastValue, rowSubgroupType).Value = "" Then
            ...
            End If
            Dgl1(Col1Value, rowSubgroupType).Value = AgL.XNull(AgL.Dman_Execute(" Select IfNull(Description,SubGroupType) 
                                                From SubGroupType Where SubGroupType ='" & Dgl1(Col1Value, rowSubgroupType).Tag & "'", AgL.GCn).ExecuteScalar())
        Else
    ...
    Private Sub FrmPerson_BaseFunction_IniGrid() Handles Me.BaseFunction_IniGrid
        ...
        Dgl1.Item(Col1Head, rowReligion).Value = hcReligion
        Dgl1.Item(Col1Head, rowCaste).Value = hcCaste
    ...
    Private Sub Dgl1_EditingControl_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles Dgl1.EditingControl_KeyDown
        ...
        Try
            ...
            Select Case Dgl1.CurrentCell.RowIndex
                ...
                Case rowParent
                    If e.KeyCode = Keys.Insert Then
                        bNewMasterCode = FOpenPersonMaster(Dgl1(Col1Value, rowSubgroupType).Tag)
                ...
                Case rowAgent
                    If Dgl1.Item(Col1Head, Dgl1.CurrentCell.RowIndex).Tag Is Nothing Then
                        If Dgl1(Col1Value, rowSubgroupType).Tag = AgLibrary.ClsMain.agConstants.SubgroupType.Supplier Then
    ...
    Public Sub FImportFromExcel(bImportFor As ImportFor)
        ...
        Try
            ...
            For I = 0 To DtTemp.Rows.Count - 1
                ...
                SubGroupTable.ParentCode = AgL.XNull(DtTemp.Rows(I)(GetFieldAliasName(bImportFor, "Master Party"))).ToString.Trim
                ...
                SubGroupTable.Cnt = I
                ImportSubgroupTable(SubGroupTable, True)
    ...
    Public Shared Function ImportSubgroupTable(SubGroupTable As StructSubGroupTable, Optional UpdateIfExists As Boolean = False) As String
        ...
        If AgL.Dman_Execute("SELECT Count(*) From Subgroup With (NoLock) where Name = " & AgL.Chk_Text(SubGroupTable.Name) & " ", IIf(AgL.PubServerName = "", AgL.GCn, AgL.GcnRead)).ExecuteScalar = 0 Then
            ...
            If SubGroupTable.AreaCode = "" Then
            ...
            If SubGroupTable.TransporterCode = "" Then
            ...
            If SubGroupTable.AgentCode = "" Then
            ...
            If SubGroupTable.ParentCode = "" Then
            ...
            If SubGroupTable.SubgroupType = "" Then
                If SubGroupTable.Nature.ToUpper = "CUSTOMER" Or SubGroupTable.AccountGroup.ToUpper.Contains("DEBTOR") Then
                    SubGroupTable.SubgroupType = AgLibrary.ClsMain.agConstants.SubgroupType.Customer
                ElseIf SubGroupTable.Nature.ToUpper = "SUPPLIER" Or SubGroupTable.AccountGroup.ToUpper.Contains("CREDITOR") Then
                    SubGroupTable.SubgroupType = AgLibrary.ClsMain.agConstants.SubgroupType.Supplier
                ElseIf SubGroupTable.Nature.ToUpper = "TRANSPORT" Or SubGroupTable.AccountGroup.ToUpper.Contains("TRANSPORT") Then
                    SubGroupTable.SubgroupType = AgLibrary.ClsMain.agConstants.SubgroupType.Transporter
                ElseIf (SubGroupTable.Nature.ToUpper = "BROKER" Or SubGroupTable.AccountGroup.ToUpper.Contains("BROKER")) And SubGroupTable.AccountGroup.ToUpper.Contains("SAL") Then
                    SubGroupTable.SubgroupType = AgLibrary.ClsMain.agConstants.SubgroupType.SalesAgent
                ElseIf (SubGroupTable.Nature.ToUpper = "BROKER" Or SubGroupTable.AccountGroup.ToUpper.Contains("BROKER")) And SubGroupTable.AccountGroup.ToUpper.Contains("PUR") Then
                    SubGroupTable.SubgroupType = AgLibrary.ClsMain.agConstants.SubgroupType.PurchaseAgent
                ElseIf SubGroupTable.Nature.ToUpper = "BROKER" Or SubGroupTable.AccountGroup.ToUpper.Contains("BROKER") Then
                    SubGroupTable.SubgroupType = AgLibrary.ClsMain.agConstants.SubgroupType.SalesAgent
                End If
            End If
            ...
            mQry = "INSERT INTO SubGroup(SubCode, Site_Code, Name, DispName, " &
                    ...
                    " " & AgL.Chk_Text(SubGroupTable.ParentCode) & ", " & AgL.Chk_Text(SubGroupTable.SalesTaxPostingGroup) & ", " & AgL.Chk_Text(SubGroupTable.InterestSlab) & "," &
        ...
        Else
            If UpdateIfExists = True Then
                ...
                SubGroupTable.CityCode = AgL.XNull(AgL.Dman_Execute("Select CityCode From City With (NoLock) 
                        Where CityName = '" & SubGroupTable.CityName & "'", IIf(AgL.PubServerName = "", AgL.GCn, AgL.GcnRead)).ExecuteScalar())

                mQry = " UPDATE Subgroup
                SET Address = " & AgL.Chk_Text(SubGroupTable.Address) & ",
                    CityCode = " & AgL.Chk_Text(SubGroupTable.CityCode) & ",
    ...
    Private Sub FrmPerson_BaseEvent_ApproveDeletion_InTrans(SearchCode As String, Conn As Object, Cmd As Object) Handles Me.BaseEvent_ApproveDeletion_InTrans
        ...
        mQry = " Delete from HRM_Employee Where SubCode = '" & SearchCode & "'"
        AgL.Dman_ExecuteNonQry(mQry, Conn, Cmd)
