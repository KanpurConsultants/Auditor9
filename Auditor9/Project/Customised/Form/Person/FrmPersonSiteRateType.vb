...
Public Class FrmPersonSiteRateType
    ...
    Public Sub IniGrid(DocID As String)
        ...
        With AgCL
            ...
            .AddAgTextColumn(Dgl1, Col1RateType, 200, 255, Col1RateType, True, False)
        End With
    ...
    Public Sub FMoverec(DocID As String)
        ...
        If DocID = "" Then
            If AgL.VNull(DtSubgroupTypeSettings.Rows(0)("PersonCanHaveDivisionWiseRateTypeYn")) = True And AgL.VNull(DtSubgroupTypeSettings.Rows(0)("PersonCanHaveSiteWiseRateTypeYn")) = True Then
                mQry = "Select D.Div_Code, D.Div_Name, S.Code as Site_Code, S.Name as Site_Name, Null as RateType, Null as RateTypeName
                From Division D, SiteMast S Order By D.Div_Name, S.Site_Name"
            ElseIf AgL.VNull(DtSubgroupTypeSettings.Rows(0)("PersonCanHaveDivisionWiseRateTypeYn")) = True Then
                mQry = "Select D.Div_Code, D.Div_Name, Null as Site_Code, Null as Site_Name, Null as RateType, Null as RateTypeName
                From Division D "
            ElseIf AgL.VNull(DtSubgroupTypeSettings.Rows(0)("PersonCanHaveSiteWiseRateTypeYn")) = True Then
                mQry = "Select Null as Div_Code, Null as Div_Name, S.Code as Site_Code, S.Name as Site_Name, Null as RateType, Null as RateTypeName
                From SiteMast S "
            End If
        Else
            If AgL.VNull(DtSubgroupTypeSettings.Rows(0)("PersonCanHaveDivisionWiseRateTypeYn")) = True And AgL.VNull(DtSubgroupTypeSettings.Rows(0)("PersonCanHaveSiteWiseRateTypeYn")) = True Then
                mQry = "Select D.Div_Code, D.Div_Name, S.Code as Site_Code, S.Name as Site_Name, L.RateType, Rt.Description as RateTypeName
            ...
            ElseIf AgL.VNull(DtSubgroupTypeSettings.Rows(0)("PersonCanHaveDivisionWiseRateTypeYn")) = True Then
                mQry = "Select Null as Div_Code, Null as Div_Name, S.Code as Site_Code, S.Name as Site_Name, L.RateType, Rt.Description as RateTypeName
                From Division D  With (NoLock)                
                Left Join SubgroupSiteDivisionDetail L With (NoLock) On D.Div_Code = L.Div_Code And L.Subcode = '" & DocID & "'  
                Left Join RateType Rt On L.RateType = Rt.Code"
            ElseIf AgL.VNull(DtSubgroupTypeSettings.Rows(0)("PersonCanHaveSiteWiseRateTypeYn")) = True Then
                mQry = "Select Null as Div_Code, Null as Div_Name, Site.Code as Site_Code, Site.Name as Site_Name, L.RateType, Rt.Description as RateTypeName
        ...
        With DsTemp.Tables(0)
            ...
            If .Rows.Count > 0 Then
                For I = 0 To DsTemp.Tables(0).Rows.Count - 1
                    ...
                    Dgl1.Item(Col1RateType, I).Value = AgL.XNull(.Rows(I)("RateTypeName"))
                Next I
            End If
        End With
        Calculation()
    ...
    Function FData_Validation() As String
        ...
        '    If Dgl1.Item(Col1RateType, I).Value = "" Then
        ...
        '                Dgl1.CurrentCell = Dgl1.Item(Col1RateType, I) : Dgl1.Focus()
        ...
        If AgL.VNull(DtSubgroupTypeSettings.Rows(0)("PersonCanHaveDivisionWiseRateTypeYn")) = True And AgL.VNull(DtSubgroupTypeSettings.Rows(0)("PersonCanHaveSiteWiseRateTypeYn")) = True Then
            For I = 0 To Dgl1.RowCount - 1
                If Dgl1.Rows(I).Visible Then
                    mQry = " Update SubgroupSiteDivisionDetail Set RateType =" & AgL.Chk_Text(Dgl1.Item(Col1RateType, I).Tag) & "  
    ...
    Private Sub FrmPersonSiteRateType_Closing(sender As Object, e As CancelEventArgs) Handles Me.Closing
        ...
        For I = 1 To Dgl1.Rows.Count - 1
            If Dgl1.Item(Col1RateType, I).Value <> Dgl1.Item(Col1RateType, I - 1).Value Then
                mDistinctData += 1
            End If
        Next
