...
#Region "Form Designer Code"
    Private Sub InitializeComponent()
        ...
        Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(FrmExpenseEntry))
        ...
        Me.TabControl1.Size = New System.Drawing.Size(992, 162)
        ...
        Me.TP1.Size = New System.Drawing.Size(984, 136)
        ...
        Me.Pnl1.Name = "Pnl1"
        Me.Pnl1.Size = New System.Drawing.Size(973, 184)
        Me.Pnl1.TabIndex = 9
        '
        'PnlCustomGrid
        '
        ...
        Me.TxtRemarks.Location = New System.Drawing.Point(380, 118)
        ...
        Me.Label30.Location = New System.Drawing.Point(258, 119)
        ...
        Me.LinkLabel1.Location = New System.Drawing.Point(4, 180)
        ...
        Me.LblCurrentBalance.Location = New System.Drawing.Point(379, 181)
        ...
        Me.Label3.Location = New System.Drawing.Point(261, 181)
        ...
        Me.LblPartyDocNo.Location = New System.Drawing.Point(258, 63)
        ...
        Me.Label5.Location = New System.Drawing.Point(363, 104)
        ...
        Me.TxtLinkedParty.Location = New System.Drawing.Point(380, 81)
        Me.TxtLinkedParty.MaxLength = 0
        Me.TxtLinkedParty.Name = "TxtLinkedParty"
        Me.TxtLinkedParty.Size = New System.Drawing.Size(414, 16)
        ...
        Me.LblLinkedParty.Location = New System.Drawing.Point(258, 80)
...
#End Region
    ...
    Private Sub FrmSaleOrder_BaseEvent_Save_InTrans(ByVal SearchCode As String, ByVal Conn As Object, ByVal Cmd As Object) Handles Me.BaseEvent_Save_InTrans
        ...
        If LblV_Type.Tag = Ncat.IncomeVoucher Then
        ...
        If TxtPartyDocNo.Text <> "" Then
            mNarrParty = TxtV_Type.Text & " : Invoice No. " & TxtPartyDocNo.Text & " Dated " & TxtPartyDocDate.Text
            mNarr = TxtV_Type.Text & " : " & TxtPartyName.Text & " Invoice No. " & TxtPartyDocNo.Text & " Dated " & TxtPartyDocDate.Text
        Else
            mNarrParty = TxtV_Type.Text
            mNarr = TxtV_Type.Text & " : " & TxtPartyName.Text & ""
        End If
        ...
        For I = 0 To Dgl1.Rows.Count - 1
            If Dgl1.Rows(I).Visible = True Then
                If AgL.XNull(Dgl1.Item(Col1Remark, I).Value) <> "" Then
                    If mRemarks = "" Then
                        mRemarks += AgL.XNull(Dgl1.Item(Col1Remark, I).Value)
                    Else
                        mRemarks += vbCrLf
                        mRemarks += AgL.XNull(Dgl1.Item(Col1Remark, I).Value)
                    End If
        ...
        If TxtRemarks.Text <> "" Then
            If mRemarks <> "" Then
                mRemarks = TxtRemarks.Text & vbCrLf & mRemarks
            Else
                mRemarks = TxtRemarks.Text
            End If
        End If

        mNarrParty = mNarrParty & vbCrLf & mRemarks
        mNarr = mNarr & vbCrLf & mRemarks
        ...
        If TxtStructure.Tag <> "" Then
            Call PostStructureLineToAccounts(AgCalcGrid1, mNarrParty, mNarr, mSearchCode, TxtDivision.AgSelectedValue, TxtSite_Code.AgSelectedValue, TxtDivision.AgSelectedValue,
                               TxtV_Type.AgSelectedValue, LblPrefix.Text, TxtV_No.Text, TxtReferenceNo.Text, TxtPartyName.AgSelectedValue, TxtV_Date.Text, Conn, Cmd,, mMultiplyWithMinus, TxtLinkedParty.Tag)
        End If
    ...
    Sub PostGridToAccounts(DocID As String, MultiplyWithMinus As Boolean, ByRef Conn As Object, ByRef Cmd As Object)
        ...
        Dim mMaxSr As Integer

        If TxtPaymentMode.Text.ToUpper <> "CREDIT" And TxtPaymentMode.Text <> "" Then
            mAmount = Math.Round(Val(AgCalcGrid1.AgChargesValue(AgTemplate.ClsMain.Charges.NETAMOUNT, AgStructure.AgCalcGrid.AgCalcGridColumn.Col_Amount)), 2)
            If mAmount > 0 Then
                ...
                If DtTemp.Rows.Count > 0 Then
                    ...
                    mNarration = TxtV_Type.Text & " : " & mPaymentModeAcName & ". " & Dgl1(Col1Remark, I).Value
                    mLedgerPostingData += " Select " & AgL.Chk_Text(TxtPartyName.Tag) & " as Subcode, " & AgL.Chk_Text(TxtLinkedParty.Tag) & " as LinkedSubcode, " & AgL.Chk_Text(mPaymentModeAc) & "  as ContraAc, " & mAmount & " as AmtDr, 0 as AmtCr, " & AgL.Chk_Text(mNarration) & " as Narration, " & AgL.Chk_Text(Dgl1(Col1ChqRefNo, I).Value) & " as ChqNo, " & AgL.Chk_Date(Dgl1(Col1ChqRefDate, I).Value) & " as ChqDate, " & AgL.Chk_Date(Dgl1(Col1EffectiveDate, I).Value) & " as EffectiveDate "

                    If mLedgerPostingData <> "" Then mLedgerPostingData += " UNION ALL "
                    mNarration = TxtV_Type.Text & " : " & TxtPartyName.Text & ". " & Dgl1(Col1Remark, I).Value
                    mLedgerPostingData += " Select " & AgL.Chk_Text(mPaymentModeAc) & " as Subcode, Null as LinkedSubcode, " & AgL.Chk_Text(TxtPartyName.Tag) & "  as ContraAc, 0 as AmtDr, " & mAmount & " as AmtCr, " & AgL.Chk_Text(mNarration) & " as Narration, " & AgL.Chk_Text(Dgl1(Col1ChqRefNo, I).Value) & " as ChqNo, " & AgL.Chk_Date(Dgl1(Col1ChqRefDate, I).Value) & " as ChqDate, " & AgL.Chk_Date(Dgl1(Col1EffectiveDate, I).Value) & " as EffectiveDate "
        ...
        mMaxSr = AgL.Dman_Execute("Select IfNull(Max(V_SNo),0) From Ledger With (NoLock) Where DocId = '" & DocID & "'", IIf(AgL.PubServerName = "", AgL.GCn, AgL.GcnRead)).ExecuteScalar()
        ...
        If DtTemp.Rows.Count > 0 Then
            For I = 0 To DtTemp.Rows.Count - 1
                mQry = "INSERT INTO Ledger
                        ...
                        U_Name, U_EntDt, U_AE)
                        VALUES('" & DocID & "', " & mMaxSr + I + 1 & ", " & Val(TxtV_No.Text) & ", " & AgL.Chk_Text(TxtV_Type.Tag) & ", " & AgL.Chk_Text(TxtReferenceNo.Text) & ", " & AgL.Chk_Text(LblPrefix.Text) & ",
            ...
            For I = 0 To .Rows.Count - 1
                If Trim(AgL.XNull(.Rows(I)("PostAc"))) <> "" And Val(AgL.VNull(.Rows(I)("Amount"))) <> 0 Then
                    ...
                    mQry = "Insert Into Ledger(DocId,RecId,V_SNo,V_Date,SubCode,ContraSub,AmtDr,AmtCr," &
                         ...
                         " TDSPer,TDS_Of_V_SNo,System_Generated,FormulaString,ContraText, CostCenter,EffectiveDate, LinkedSubCode) Values " &
    ...
    Private Sub FrmSaleOrder_BaseFunction_MoveRec(ByVal SearchCode As String) Handles Me.BaseFunction_MoveRec
        ...
        mQry = " Select H.*, Sg.Name as AccountName, Sg.Nature, VT.Category as VoucherCategory, Bank.Name as BankAcName, PM.Description as PaymentModeDesc, LSg.Name As LinkedPartyName, HC.*                                 
    ...
    Sub Party_Validating()
        ...
        ShowLedgerHeadParty("", TxtPartyName.Tag, TxtNature.Text, True)
        ShowChqRefNo()

        mQry = " Select PSg.Code, PSg.Name 
                            From SubGroup Sg
                            LEFT JOIN ViewHelpSubgroup PSg On Sg.Parent = PSg.Code
                            Where Sg.SubCode = '" & TxtPartyName.Tag & "'
        ...
        End If
        HandlePendingLR(TxtPartyName.Tag)
    End Sub
    ...
    Private Function FGetCurrBal(Subcode As String, V_Date As Date) As Double
        mQry = " Select IfNull(Sum(AmtDr),0) - IfNull(Sum(AmtCr),0) As CurrBal From Ledger  With (NoLock) Where SubCode = '" & Subcode & "' And V_Date <= '" & CDate(TxtV_Date.Text).ToString("s") & "'"
    ...
    Private Sub TxtBuyer_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles TxtPartyName.KeyDown, TxtPaymentMode.KeyDown, TxtLinkedParty.KeyDown
        Try
                    ...
                    If e.KeyCode <> Keys.Enter Then
                        If sender.AgHelpDataset Is Nothing Then
                            mQry = " Select H.Code, H.Description 
                                     ...
                                     Where IfNull(L.Site_Code,'" & TxtSite_Code.Tag & "') = '" & TxtSite_Code.Tag & "' 
    ...
    Private Sub FCreateHelpReferenceNoDebitNote()
        ...
        If Dgl1.AgHelpDataSet(Col1Specification) Is Nothing Then
            ...
            If TxtVoucherCategory.Text.ToUpper = "PURCH" Then
                ...
                And L.V_Date<=" & AgL.Chk_Text(CDate(TxtV_Date.Text).ToString("s")) & "                 
                And L.AmtCr > 0 
                "
            Else
                ...
                And  L.Subcode = '" & TxtPartyName.Tag & "' 
                And L.V_Date<=" & AgL.Chk_Date(CDate(TxtV_Date.Text).ToString("s")) & " 
                And L.AmtDr > 0 
                "
            End If
    ...
    Sub FGetPrintCrystal(ByVal SearchCode As String, mPrintFor As ClsMain.PrintFor, Optional ByVal IsPrintToPrinter As Boolean = False, Optional BulkCondStr As String = "")
        ...
        For I = 1 To PrintingCopies.Length
            ...
            mQry = mQry + "
                ...
                (Case When BP.Nature = 'Cash' Then BP.DispName || ' - ' || IsNull(H.PartyName,'') Else H.PartyName End) as PartyName, 
                IfNull(H.PartyAddress,'') as PartyAddress, IfNull(C.CityName,'') as CityName, IfNull(H.PartyPincode,'') as PartyPincode, 
                IfNull(State.ManualCode,'') as StateCode, IfNull(State.Description,'')  as StateName, 
                IfNull(H.PartyMobile,'') as PartyMobile, BP.ContactPerson, IfNull(H.PartySalesTaxNo,'') as PartySalesTaxNo, 
                IfNull(H.PartyAadharNo,'') as PartyAadharNo, IfNull(H.PartyPanNo,'') as PartyPanNo,
                ...
                I.Name as LineAccountName, L.Specification as LineSpecification, IfNull(L.HSN,'') as HSN, 
                L.SalesTaxGroupItem, STGI.GrossTaxRate,         
                L.Qty, L.Rate as Rate, 
                L.Unit, U.DecimalPlaces as UnitDecimalPlaces,                 
                abs(L.Amount) as Amount,Abs(LC.Taxable_Amount) as Taxable_Amount,Abs(LC.Tax1_Per) as Tax1_Per, abs(LC.Tax1) as Tax1, 
                abs(LC.Tax2_Per) as Tax2_Per, abs(LC.Tax2) as Tax2, abs(LC.Tax3_Per) as Tax3_Per, abs(LC.Tax3) as Tax3, 
                ...
                HC.Tax5_Per as H_Tax5_Per, abs(HC.Tax5) as H_Tax5, HC.Deduction_Per as H_Deduction_Per, HC.Deduction as H_Deduction, 
                HC.Other_Charge_Per as H_Other_Charge_Per, HC.Other_Charge as H_Other_Charge, HC.Round_Off, abs(HC.Net_Amount) as H_Net_Amount, 
                ...
                Left Join viewHelpSubgroup I  With (NoLock) On L.Subcode = I.Code
                Left Join Unit U  With (NoLock) On L.Unit = U.Code
                ...
                Left Join Subgroup BP With (NoLock) On H.Subcode = BP.Subcode                                
                Left Join Voucher_Type Vt  With (NoLock) On H.V_Type = Vt.V_Type
        ...
        ClsMain.FPrintThisDocument(Me, objRepPrint, TxtV_Type.Tag, mQry, "ExpenseVoucher_Print.rpt", mPrintTitle, , , , TxtPartyName.Tag, TxtV_Date.Text, IsPrintToPrinter)
        'Else
    ...
    Private Sub Dgl1_RowEnter(sender As Object, e As DataGridViewCellEventArgs) Handles Dgl1.RowEnter
        ...
        End If
    End Sub
    Private Sub MnuImport_Click(sender As Object, e As EventArgs) Handles MnuImportFromExcel.Click, MnuImportFromDos.Click, MnuImportFromTally.Click, MnuEditSave.Click, MnuImportGSTDataFromExcel.Click, MnuImportGSTDataFromDos.Click, MnuReport.Click, MnuShowLedgerPosting.Click
        Select Case sender.name
            ...
            Case MnuReport.Name
                ...
                Dim StrSenderText As String = "Expense Income Report"
                ...
                If LedgerHeadElementList(I).SelectNodes("ALLINVENTORYENTRIES.LIST") IsNot Nothing Then
                    For J = 0 To LedgerHeadElementList(I).SelectNodes("ALLINVENTORYENTRIES.LIST").Count - 1
                        ...
                        Dim mManualrefNoPrefix As String = AgL.Dman_Execute("Select Ref_Prefix From Voucher_Prefix Where V_Type = '" & LedgerHeadTable.V_Type & "' 
                                And " & AgL.Chk_Date(LedgerHeadTable.V_Date) & " >= Date_From 
                                And " & AgL.Chk_Date(LedgerHeadTable.V_Date) & " <= Date_To ", AgL.GCn).ExecuteScalar()
