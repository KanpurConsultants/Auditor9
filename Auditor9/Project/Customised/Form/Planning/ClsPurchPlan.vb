...
Public Class ClsPurchPlan
    ...
    Public Const Col1SaleOrder As String = "Purch Plan"
    Public Const Col1SaleOrderSr As String = "Purch Plan Sr"
    ...
    Private Const mFormat_SaleOrderPendingForPlan As String = "PurchPlanPendingForPlan"
    ...
    Public Sub ProcSaleOrderPlan(Optional mFilterGrid As AgControls.AgDataGrid = Nothing,
        ...
        Try
            ...
            mQry = " SELECT 'o' As Tick, VSaleOrder.SaleOrder, VSaleOrder.SaleOrderSr, VSaleOrder.Party, 
                    ...
                    VSaleOrder.Item AS Item, VSaleOrder.Specification AS Specification, 
                    VSaleOrder.Dimension1 AS Dimension1, VSaleOrder.Dimension2 AS Dimension2,
                    VSaleOrder.Dimension3 AS Dimension3, VSaleOrder.Dimension4 AS Dimension4, 
                    I.Description AS ItemDesc, VSaleOrder.Specification AS Specification, 
                    ...
                    FROM (
	                    ...
	                    MAx(L.Item) AS Item, Max(L.Specification) AS Specification, 
	                    Max(L.Dimension1) AS Dimension1, Max(L.Dimension2) AS Dimension2, 
	                    Max(L.Dimension3) AS Dimension3, Max(L.Dimension4) AS Dimension4,
                    ...
                    LEFT JOIN Item I ON VSaleOrder.Item = I.Code
                    LEFT JOIN Dimension1 D1 ON VSaleOrder.Dimension1 = D1.Code
                    LEFT JOIN Dimension2 D2 ON VSaleOrder.Dimension2 = D2.Code
                    LEFT JOIN Dimension3 D3 ON VSaleOrder.Dimension3 = D3.Code
                    LEFT JOIN Dimension4 D4 ON VSaleOrder.Dimension4 = D4.Code
                    ...
                    I.Description, VSaleOrder.Specification, D1.Description, D2.Description, D3.Description, D4.Description "
        ...
        If mFormat = mFormat_SaleOrderPendingForPlan Then
            ...
            For I As Integer = 0 To ReportFrm.DGL1.Rows.Count - 1
                If ReportFrm.DGL1.Item(Col1Select, I).Value = "þ" Then
                    mQry = " INSERT INTO [#" & bTempTable & "](SaleOrder, SaleOrderSr, 
                        ...
                        " & AgL.Chk_Text(ReportFrm.DGL1.Item(Col1Item, I).Value) & " As Item,
                        " & AgL.Chk_Text(ReportFrm.DGL1.Item(Col1Specification, I).Value) & " As Specification,
                        " & AgL.Chk_Text(ReportFrm.DGL1.Item(Col1Dimension1, I).Value) & " As Dimension1,
                        " & AgL.Chk_Text(ReportFrm.DGL1.Item(Col1Dimension2, I).Value) & " As Dimension2,
                        " & AgL.Chk_Text(ReportFrm.DGL1.Item(Col1Dimension3, I).Value) & " As Dimension3,
                        " & AgL.Chk_Text(ReportFrm.DGL1.Item(Col1Dimension4, I).Value) & " As Dimension4,
