...
#Region "Designer Code"
    Private Sub InitializeComponent()
        ...
        Me.PnlRateType.Location = New System.Drawing.Point(2, 301)
        Me.PnlRateType.Name = "PnlRateType"
        Me.PnlRateType.Size = New System.Drawing.Size(959, 233)
...
#End Region
    ...
    Private Sub SetBomSkuName()
        ...
        If Dgl1.Item(Col1Value, rowItem).Value <> "" Then
            If mBomSkuName <> "" Then mBomSkuName += "-"
            mBomSkuName += Dgl1.Item(Col1Value, rowItem).Value
        End If
        If Dgl1.Item(Col1Value, rowItemCategory).Value <> "" And Dgl1.Item(Col1Value, rowItem).Value = "" Then
            If mBomSkuName <> "" Then mBomSkuName += "-"
            mBomSkuName += Dgl1.Item(Col1Value, rowItemCategory).Value
        End If
        If Dgl1.Item(Col1Value, rowItemGroup).Value <> "" Then
            If mBomSkuName <> "" Then mBomSkuName += "-"
            mBomSkuName += Dgl1.Item(Col1Value, rowItemGroup).Value
        End If
        If Dgl1.Item(Col1Value, rowDimension1).Value <> "" Then
            If mBomSkuName <> "" Then mBomSkuName += "-"
            mBomSkuName += Dgl1.Item(Col1Value, rowDimension1).Value
        End If
        If Dgl1.Item(Col1Value, rowDimension2).Value <> "" Then
            If mBomSkuName <> "" Then mBomSkuName += "-"
            mBomSkuName += Dgl1.Item(Col1Value, rowDimension2).Value
        End If
        If Dgl1.Item(Col1Value, rowDimension3).Value <> "" Then
            If mBomSkuName <> "" Then mBomSkuName += "-"
            mBomSkuName += Dgl1.Item(Col1Value, rowDimension3).Value
        End If
        If Dgl1.Item(Col1Value, rowDimension4).Value <> "" Then
            If mBomSkuName <> "" Then mBomSkuName += "-"
            mBomSkuName += Dgl1.Item(Col1Value, rowDimension4).Value
        End If
        If Dgl1.Item(Col1Value, rowSize).Value <> "" Then
            If mBomSkuName <> "" Then mBomSkuName += "-"
            mBomSkuName += Dgl1.Item(Col1Value, rowSize).Value
        End If


        Dgl1(Col1Value, rowSKU).Value = mBomSkuName & "-BOM"
    End Sub
    ...
    Private Sub FrmYarn_BaseEvent_Data_Validation(ByRef passed As Boolean) Handles Me.BaseEvent_Data_Validation
        ...
        If Topctrl1.Mode = "Add" Then
            mQry = "Select count(*) From Item Where Description='" & Dgl1.Item(Col1Value, rowSKU).Value & "'  "
            If AgL.Dman_Execute(mQry, AgL.GCn).ExecuteScalar > 0 Then Err.Raise(1, , "Description Already Exist!")
        Else
            mQry = "Select count(*) From Item Where Description='" & Dgl1.Item(Col1Value, rowSKU).Value & "' And Code<>'" & mInternalCode & "' "
            If AgL.Dman_Execute(mQry, AgL.GCn).ExecuteScalar > 0 Then Err.Raise(1, , "Description Already Exist!")
        End If
        ...
        For I = 0 To Dgl2.Rows.Count - 1
            If AgL.XNull(Dgl2.Item(Col1ItemCategory, I).Value) <> "" _
                        Or AgL.XNull(Dgl2.Item(Col1ItemGroup, I).Value) <> "" _
                        Or AgL.XNull(Dgl2.Item(Col1Item, I).Value) <> "" _
                        Or AgL.XNull(Dgl2.Item(Col1Dimension1, I).Value) <> "" _
                        Or AgL.XNull(Dgl2.Item(Col1Dimension2, I).Value) <> "" _
                        Or AgL.XNull(Dgl2.Item(Col1Dimension3, I).Value) <> "" _
                        Or AgL.XNull(Dgl2.Item(Col1Dimension4, I).Value) <> "" _
                        Or AgL.XNull(Dgl2.Item(Col1Size, I).Value) <> "" _
                       Then
                Dgl2.Item(Col1SKU, I).Tag = ClsMain.FGetSKUCode(Dgl2.Item(ColSNo, I).Value, ItemTypeCode.InternalProduct, Dgl2.Item(Col1ItemCategory, I).Tag, Dgl2.Item(Col1ItemCategory, I).Value _
                                   , Dgl2.Item(Col1ItemGroup, I).Tag, Dgl2.Item(Col1ItemGroup, I).Value _
                                   , Dgl2.Item(Col1Item, I).Tag, Dgl2.Item(Col1Item, I).Value _
                                   , Dgl2.Item(Col1Dimension1, I).Tag, Dgl2.Item(Col1Dimension1, I).Value _
                                   , Dgl2.Item(Col1Dimension2, I).Tag, Dgl2.Item(Col1Dimension2, I).Value _
                                   , Dgl2.Item(Col1Dimension3, I).Tag, Dgl2.Item(Col1Dimension3, I).Value _
                                   , Dgl2.Item(Col1Dimension4, I).Tag, Dgl2.Item(Col1Dimension4, I).Value _
                                   , Dgl2.Item(Col1Size, I).Tag, Dgl2.Item(Col1Size, I).Value _
                                   , Dgl2.Item(Col1MItemCategory, I).Value _
                                   , Dgl2.Item(Col1MItemGroup, I).Value _
                                   , Dgl2.Item(Col1MItemSpecification, I).Value _
                                   , Dgl2.Item(Col1MDimension1, I).Value _
                                   , Dgl2.Item(Col1MDimension2, I).Value _
                                   , Dgl2.Item(Col1MDimension3, I).Value _
                                   , Dgl2.Item(Col1MDimension4, I).Value _
                                   , Dgl2.Item(Col1MSize, I).Value
                                   )
                If Dgl2.Item(Col1SKU, I).Tag = "" Then
                    passed = False
                    Exit Sub
                End If
            End If
    ...
    Private Sub FrmYarn_BaseEvent_Save_InTrans(ByVal SearchCode As String, ByVal Conn As Object, ByVal Cmd As Object) Handles Me.BaseEvent_Save_InTrans
        ...
        mQry = "UPDATE Item 
                Set 
                Description=" & AgL.Chk_Text(Dgl1.Item(Col1Value, rowSKU).Value) & ",
                BaseItem=" & AgL.Chk_Text(Dgl1.Item(Col1Value, rowItem).Tag) & ",
                ...
                DealQty = " & Val(Dgl1.Item(Col1Value, rowBatchQty).Value) & ",                 
                DealUnit = " & AgL.Chk_Text(Dgl1.Item(Col1Value, rowBatchUnit).Value) & ",                 
                WastagePer = " & Val(Dgl1.Item(Col1Value, rowWastagePer).Value) & ",                 
                WeightForPer = " & Val(Dgl1.Item(Col1Value, rowWeightForPer).Value) & "                 
        ...
        For I = 0 To Dgl2.Rows.Count - 1
            If Dgl2.Item(Col1Item, I).Value <> "" And Val(Dgl2.Item(Col1Qty, I).Value) > 0 Then
                mQry = "INSERT INTO BOMDetail (Code, Sr, Process, Item, Qty, Unit, ConsumptionPer, FaceConsumptionPer)
                        VALUES ('" & SearchCode & "', " & I + 1 & ", " & AgL.Chk_Text(Dgl2.Item(Col1Process, I).Tag) & ", " & AgL.Chk_Text(Dgl2.Item(Col1SKU, I).Tag) & "                                                 
                        ," & Val(Dgl2.Item(Col1Qty, I).Value) & ", 
                        " & AgL.Chk_Text(Dgl2.Item(Col1Unit, I).Value) & ",   
                        " & Val(Dgl2.Item(Col1ConsumptionPer, I).Value) & ",   
    ...
    Private Sub FrmQuality1_BaseFunction_MoveRec(ByVal SearchCode As String) Handles Me.BaseFunction_MoveRec
        ...
        With DsTemp.Tables(0)
            If .Rows.Count > 0 Then
                ...
                Dgl1.Item(Col1Value, rowSKU).Value = AgL.XNull(.Rows(0)("Description"))
                Dgl1.Item(Col1Value, rowSKU).Tag = AgL.XNull(.Rows(0)("Code"))
                Dgl1.Item(Col1Value, rowItem).Value = AgL.XNull(.Rows(0)("ItemName"))
                Dgl1.Item(Col1Value, rowItem).Tag = AgL.XNull(.Rows(0)("BaseItem"))
                Dgl1.Item(Col1Value, rowItemGroup).Tag = AgL.XNull(.Rows(0)("ItemGroup"))
                Dgl1.Item(Col1Value, rowItemGroup).Value = AgL.XNull(.Rows(0)("ItemGroupName"))
                Dgl1.Item(Col1Value, rowItemCategory).Tag = AgL.XNull(.Rows(0)("ItemCategory"))
                Dgl1.Item(Col1Value, rowItemCategory).Value = AgL.XNull(.Rows(0)("ItemCategoryName"))
                ...
                Dgl1.Item(Col1Value, rowDimension3).Tag = AgL.XNull(.Rows(0)("Dimension3"))
                Dgl1.Item(Col1Value, rowDimension3).Value = AgL.XNull(.Rows(0)("Dimension3Name"))
                Dgl1.Item(Col1Value, rowDimension4).Tag = AgL.XNull(.Rows(0)("Dimension4"))
                Dgl1.Item(Col1Value, rowDimension4).Value = AgL.XNull(.Rows(0)("Dimension4Name"))
                Dgl1.Item(Col1Value, rowSize).Tag = AgL.XNull(.Rows(0)("Size"))
                Dgl1.Item(Col1Value, rowSize).Value = AgL.XNull(.Rows(0)("SizeName"))
                Dgl1.Item(Col1Value, rowBatchQty).Value = AgL.VNull(.Rows(0)("DealQty"))
                Dgl1.Item(Col1Value, rowBatchUnit).Value = AgL.XNull(.Rows(0)("DealUnit"))
                Dgl1.Item(Col1Value, rowWastagePer).Value = AgL.VNull(.Rows(0)("WastagePer"))
                Dgl1.Item(Col1Value, rowWeightForPer).Value = AgL.VNull(.Rows(0)("WeightForPer"))
        ...
        Dim I As Integer
        mQry = "SELECT H.*, 
                Sku.BaseItem, Sku.Description, Sku.ItemCategory, Sku.ItemGroup, SKU.Dimension1, SKU.Dimension2, Sku.Dimension3, Sku.Dimension4, Sku.Size, 
                IC.Description as ItemCategoryName, IG.Description as ItemGroupName,
                D1.Description as Dimension1Name,D2.Description as Dimension2Name,
                D3.Description as Dimension3Name,D4.Description as Dimension4Name,
                Size.Description as SizeName, P.Name as ProcessName, I.Code as ItemCode, I.Description as ItemName,                
        ...
        With DsTemp.Tables(0)
            ...
            If .Rows.Count > 0 Then
                For I = 0 To DsTemp.Tables(0).Rows.Count - 1
                    ...
                    Dgl2.Item(Col1Process, I).Tag = AgL.XNull(.Rows(I)("Process"))
                    Dgl2.Item(Col1Process, I).Value = AgL.XNull(.Rows(I)("ProcessName"))
                    Dgl2.Item(Col1Item, I).Tag = AgL.XNull(.Rows(I)("ItemCode"))
                    Dgl2.Item(Col1Item, I).Value = AgL.XNull(.Rows(I)("ItemName"))
                    Dgl2.Item(Col1ItemCategory, I).Tag = AgL.XNull(.Rows(I)("ItemCategory"))
                    Dgl2.Item(Col1ItemCategory, I).Value = AgL.XNull(.Rows(I)("ItemCategoryName"))
                    Dgl2.Item(Col1ItemGroup, I).Tag = AgL.XNull(.Rows(I)("ItemGroup"))
                    Dgl2.Item(Col1ItemGroup, I).Value = AgL.XNull(.Rows(I)("ItemGroupName"))
                    ...
                    Dgl2.Item(Col1Dimension4, I).Tag = AgL.XNull(.Rows(I)("Dimension4"))
                    Dgl2.Item(Col1Dimension4, I).Value = AgL.XNull(.Rows(I)("Dimension4Name"))
                    ...
                    Dgl2.Item(Col1MItemSpecification, I).Value = AgL.XNull(.Rows(I)("MItemSpecification"))
                    ...
                    LblTotalQty.Text = Val(LblTotalQty.Text) + Val(Dgl2.Item(Col1Qty, I).Value)
                Next I
                Dgl2.Visible = True
            Else
                Dgl2.Visible = False
    ...
    Private Sub Validating_ItemCode(ItemCode As String, ByVal mColumn As Integer, ByVal mRow As Integer)
        ...
        Try
            ...
            If DtItem.Rows.Count > 0 Then
                ...
                Dgl2.Item(Col1ItemCategory, mRow).Tag = AgL.XNull(DtItem.Rows(0)("ItemCategory"))
                Dgl2.Item(Col1ItemCategory, mRow).Value = AgL.XNull(DtItem.Rows(0)("ItemCategoryName"))

                If AgL.XNull(DtItem.Rows(0)("ItemGroup")) <> "" Then
                    Dgl2.Item(Col1ItemGroup, mRow).Tag = AgL.XNull(DtItem.Rows(0)("ItemGroup"))
                    Dgl2.Item(Col1ItemGroup, mRow).Value = AgL.XNull(DtItem.Rows(0)("ItemGroupName"))
                End If

                Dgl2.Item(Col1MItemSpecification, mRow).Value = AgL.XNull(DtItem.Rows(0)("Specification"))
                If AgL.XNull(DtItem.Rows(0)("Dimension1")) <> "" Then
                    Dgl2.Item(Col1Dimension1, mRow).Tag = AgL.XNull(DtItem.Rows(0)("Dimension1"))
                    Dgl2.Item(Col1Dimension1, mRow).Value = AgL.XNull(DtItem.Rows(0)("Dimension1Name"))
                End If
                If AgL.XNull(DtItem.Rows(0)("Dimension2")) <> "" Then
                    Dgl2.Item(Col1Dimension2, mRow).Tag = AgL.XNull(DtItem.Rows(0)("Dimension2"))
                    Dgl2.Item(Col1Dimension2, mRow).Value = AgL.XNull(DtItem.Rows(0)("Dimension2Name"))
                End If
                If AgL.XNull(DtItem.Rows(0)("Dimension3")) <> "" Then
                    Dgl2.Item(Col1Dimension3, mRow).Tag = AgL.XNull(DtItem.Rows(0)("Dimension3"))
                    Dgl2.Item(Col1Dimension3, mRow).Value = AgL.XNull(DtItem.Rows(0)("Dimension3Name"))
                End If
                If AgL.XNull(DtItem.Rows(0)("Dimension4")) <> "" Then
                    Dgl2.Item(Col1Dimension4, mRow).Tag = AgL.XNull(DtItem.Rows(0)("Dimension4"))
                    Dgl2.Item(Col1Dimension4, mRow).Value = AgL.XNull(DtItem.Rows(0)("Dimension4Name"))
                End If
                If AgL.XNull(DtItem.Rows(0)("Size")) <> "" Then
                    Dgl2.Item(Col1Size, mRow).Tag = AgL.XNull(DtItem.Rows(0)("Size"))
                    Dgl2.Item(Col1Size, mRow).Value = AgL.XNull(DtItem.Rows(0)("SizeName"))
                End If
    ...
    Private Sub Validating_ItemHeader(ItemCode As String)
        ...
        Try
            ...
            DtItem = AgL.FillData(mQry, AgL.GCn).Tables(0)
            If DtItem.Rows.Count > 0 Then
                Dgl1.Item(Col1Value, rowBatchUnit).Value = AgL.XNull(DtItem.Rows(0)("Unit"))
                Dgl1.Item(Col1Value, rowBatchUnit).Tag = AgL.XNull(DtItem.Rows(0)("Unit"))


                Dgl1.Item(Col1Value, rowItemCategory).Tag = AgL.XNull(DtItem.Rows(0)("ItemCategory"))
                Dgl1.Item(Col1Value, rowItemCategory).Value = AgL.XNull(DtItem.Rows(0)("ItemCategoryName"))

                If AgL.XNull(DtItem.Rows(0)("ItemGroup")) <> "" Then
                    Dgl1.Item(Col1Value, rowItemGroup).Tag = AgL.XNull(DtItem.Rows(0)("ItemGroup"))
                    Dgl1.Item(Col1Value, rowItemGroup).Value = AgL.XNull(DtItem.Rows(0)("ItemGroupName"))
                End If

                Dgl1.Item(Col1Value, rowSpecification).Tag = AgL.XNull(DtItem.Rows(0)("Specification"))
                If AgL.XNull(DtItem.Rows(0)("Dimension1")) <> "" Then
                    Dgl1.Item(Col1Value, rowDimension1).Tag = AgL.XNull(DtItem.Rows(0)("Dimension1"))
                    Dgl1.Item(Col1Value, rowDimension1).Value = AgL.XNull(DtItem.Rows(0)("Dimension1Name"))
                End If
                If AgL.XNull(DtItem.Rows(0)("Dimension2")) <> "" Then
                    Dgl1.Item(Col1Value, rowDimension2).Tag = AgL.XNull(DtItem.Rows(0)("Dimension2"))
                    Dgl1.Item(Col1Value, rowDimension2).Value = AgL.XNull(DtItem.Rows(0)("Dimension2Name"))
                End If
                If AgL.XNull(DtItem.Rows(0)("Dimension3")) <> "" Then
                    Dgl1.Item(Col1Value, rowDimension3).Tag = AgL.XNull(DtItem.Rows(0)("Dimension3"))
                    Dgl1.Item(Col1Value, rowDimension3).Value = AgL.XNull(DtItem.Rows(0)("Dimension3Name"))
                End If
                If AgL.XNull(DtItem.Rows(0)("Dimension4")) <> "" Then
                    Dgl1.Item(Col1Value, rowDimension4).Tag = AgL.XNull(DtItem.Rows(0)("Dimension4"))
                    Dgl1.Item(Col1Value, rowDimension4).Value = AgL.XNull(DtItem.Rows(0)("Dimension4Name"))
                End If
                If AgL.XNull(DtItem.Rows(0)("Size")) <> "" Then
                    Dgl1.Item(Col1Value, rowDimension4).Tag = AgL.XNull(DtItem.Rows(0)("Size"))
                    Dgl1.Item(Col1Value, rowDimension4).Value = AgL.XNull(DtItem.Rows(0)("SizeName"))
                End If
    ...
    Private Sub FrmItemBOM_BaseEvent_Topctrl_tbAdd() Handles Me.BaseEvent_Topctrl_tbAdd
        ...
        If Dgl1.Rows(rowItem).Visible Then Dgl1.CurrentCell = Dgl1(Col1Value, rowItem)
    ...
    Private Sub FrmItemBOM_BaseFunction_IniGrid() Handles Me.BaseFunction_IniGrid
        ...
        With AgCL
            ...
            .AddAgTextColumn(Dgl2, Col1Process, 120, 0, Col1Process, True, False, False)
            .AddAgTextColumn(Dgl2, Col1ItemCategory, 180, 0, Col1ItemCategory, True, False, False)
            .AddAgTextColumn(Dgl2, Col1ItemGroup, 180, 0, Col1ItemGroup, True, False, False)
            .AddAgTextColumn(Dgl2, Col1Item, 300, 0, Col1Item, True, False, False)
            .AddAgTextColumn(Dgl2, Col1Dimension1, 150, 0, AgL.PubCaptionDimension1, True, False, False)
            .AddAgTextColumn(Dgl2, Col1Dimension2, 150, 0, AgL.PubCaptionDimension2, True, False, False)
            .AddAgTextColumn(Dgl2, Col1Dimension3, 150, 0, AgL.PubCaptionDimension3, True, False, False)
            .AddAgTextColumn(Dgl2, Col1Dimension4, 150, 0, AgL.PubCaptionDimension4, True, False, False)
            .AddAgTextColumn(Dgl2, Col1Size, 120, 0, Col1Size, True, False, False)
            ...
            .AddAgTextColumn(Dgl2, Col1MItemCategory, 100, 0, Col1MItemCategory, True, False, False)
            .AddAgTextColumn(Dgl2, Col1MItemGroup, 100, 0, Col1MItemGroup, True, False, False)
            .AddAgTextColumn(Dgl2, Col1MItemSpecification, 100, 0, Col1MItemSpecification, True, False, False)
            .AddAgTextColumn(Dgl2, Col1MDimension1, 100, 0, "M " & AgL.PubCaptionDimension1, True, False, False)
            .AddAgTextColumn(Dgl2, Col1MDimension2, 100, 0, "M " & AgL.PubCaptionDimension2, True, False, False)
            .AddAgTextColumn(Dgl2, Col1MDimension3, 100, 0, "M " & AgL.PubCaptionDimension3, True, False, False)
            .AddAgTextColumn(Dgl2, Col1MDimension4, 100, 0, "M " & AgL.PubCaptionDimension4, True, False, False)
        ...
        Dgl1.Item(Col1Head, rowSKU).Value = hcSKU
    ...
    Private Sub Calculation()
        ...
        For I = 0 To Dgl2.RowCount - 1
            If Dgl2.Item(Col1Item, I).Value <> "" And Dgl2.Rows(I).Visible Then
                ...
                If Val(Dgl1.Item(Col1Value, rowWeightForPer).Value) > 0 Then
    ...
    Private Sub ApplyUISetting()
        ...
        Try
            ...
            mQry = "Select H.*
                    ...
                    Where EntryName='FrmConsumption' And GridName ='Dgl1' And V_Type = '" & ItemV_Type.BOM & "' "
            ...
            mQry = "Select H.*
                    ...
                    Where EntryName='FrmConsumption' And GridName ='Dgl2'  And V_Type = '" & ItemV_Type.BOM & "' "
            DtTemp = AgL.FillData(mQry, AgL.GCn).Tables(0)
            ...
            Dgl1.Item(Col1Head, rowDimension1).Value = AgL.PubCaptionDimension1
            Dgl1.Item(Col1Head, rowDimension2).Value = AgL.PubCaptionDimension2
            Dgl1.Item(Col1Head, rowDimension3).Value = AgL.PubCaptionDimension3
            Dgl1.Item(Col1Head, rowDimension4).Value = AgL.PubCaptionDimension4
        Catch ex As Exception
                ...
                Case rowItem
                    If Dgl1.Item(Col1Head, Dgl1.CurrentCell.RowIndex).Tag Is Nothing Then
                        mQry = " Select I.Code, I.Description, IT.Name as ItemType 
                                     ...
                                     Where IfNull(I.Status,'Active') = 'Active' And I.V_Type In ('" & ItemV_Type.Item & "', '" & ItemV_Type.ItemCategory & "')
    ...
    Private Sub FCreateHelpItemHead()
        ...
        If Dgl1.Item(Col1Value, rowItemType).Value <> "" And Dgl1.Rows(rowItemType).Visible Then
            strCond += " And (I.ItemType = '" & Dgl1.Item(Col1Value, rowItemType).Tag & "' or I.ItemType Is Null) "
        End If

        If Dgl1.Item(Col1Value, rowItemCategory).Value <> "" And Dgl1.Rows(rowItemCategory).Visible Then
            strCond += " And (I.ItemCategory = '" & Dgl1.Item(Col1Value, rowItemCategory).Tag & "' or I.ItemCategory Is Null) "
        End If

        If Dgl1.Item(Col1Value, rowItemGroup).Value <> "" And Dgl1.Rows(rowItemGroup).Visible Then
            strCond += " And (I.ItemGroup = '" & Dgl1.Item(Col1Value, rowItemGroup).Tag & "' or I.ItemGroup Is Null) "
        End If
        ...
        mQry = " Select I.Code, I.Description, IT.Name as ItemType 
                                     ...
                                     Order By I.Description"
        Dgl1.Item(Col1Head, rowItemCategory).Tag = AgL.FillData(mQry, AgL.GCn)
    End Sub
    ...
    Private Sub FCreateHelpDimension1Head()
        ...
        mQry = " Select I.Code, I.Description, IT.Name as ItemType 
                                     ...
                                     Order By I.Description"
        Dgl1.Item(Col1Head, rowDimension1).Tag = AgL.FillData(mQry, AgL.GCn)
    End Sub
    ...
    Private Sub FCreateHelpDimension2Head()
        ...
        mQry = " Select I.Code, I.Description, IT.Name as ItemType 
                                     ...
                                     Order By I.Description"
        Dgl1.Item(Col1Head, rowDimension2).Tag = AgL.FillData(mQry, AgL.GCn)
    End Sub
    ...
    Private Sub FCreateHelpDimension3Head()
        ...
        mQry = " Select I.Code, I.Description, IT.Name as ItemType 
                                     ...
                                     Order By I.Description"
        Dgl1.Item(Col1Head, rowDimension3).Tag = AgL.FillData(mQry, AgL.GCn)
    End Sub
    ...
    Private Sub FCreateHelpDimension4Head()
        ...
        mQry = " Select I.Code, I.Description, IT.Name as ItemType 
                                     ...
                                     Order By I.Description"
        Dgl1.Item(Col1Head, rowDimension4).Tag = AgL.FillData(mQry, AgL.GCn)
    End Sub
    ...
    Private Sub FCreateHelpSizeHead()
        ...
        mQry = " Select I.Code, I.Description, IT.Name as ItemType 
                                     ...
                                     Order By I.Description"
        Dgl1.Item(Col1Head, rowSize).Tag = AgL.FillData(mQry, AgL.GCn)
    End Sub
    ...
    Private Sub FCreateHelpItem(mRowIndex As Integer)
        ...
        If FGetSettings(SettingFields.FilterInclude_ItemV_Type, SettingType.General) <> "" Then
            ...
            End If
        Else
            strCond += " And I.V_Type in ('" & ItemV_Type.Item & "','" & ItemV_Type.ItemCategory & "') "
        End If
        ...
        If Dgl2.Item(Col1ItemCategory, mRowIndex).Value <> "" And Dgl2.Columns(Col1ItemCategory).Visible Then
            strCond += " And (I.ItemCategory = '" & Dgl2.Item(Col1ItemCategory, mRowIndex).Tag & "' or I.ItemCategory Is Null) "
        End If

        If Dgl2.Item(Col1ItemGroup, mRowIndex).Value <> "" And Dgl2.Columns(Col1ItemGroup).Visible Then
            strCond += " And (I.ItemGroup = '" & Dgl2.Item(Col1ItemGroup, mRowIndex).Tag & "' or I.ItemGroup Is Null) "
        End If
        ...
        mQry = " Select I.Code, I.Description, IT.Name as ItemType 
                                     ...
                                     Where IfNull(I.Status,'Active') = 'Active' " & strCond & "
                                     Order By I.Description"
        Dgl2.AgHelpDataSet(Col1Item) = AgL.FillData(mQry, AgL.GCn)
    End Sub
    ...
    Private Sub FCreateHelpDimension4(mRowIndex As Integer)
        ...
        mQry = " Select I.Code, I.Description, IT.Name as ItemType 
                                     ...
                                     Where IfNull(I.Status,'Active') = 'Active' And I.V_Type = '" & ItemV_Type.Dimension4 & "' " & strCond & "
                                     Order By I.Description"
        Dgl2.AgHelpDataSet(Col1Dimension4) = AgL.FillData(mQry, AgL.GCn)
    End Sub
        ...
        If mColumn = Dgl1.Columns(Col1Value).Index Then
            ...
            Select Case mRow
                ...
                Case rowItemCategory
                    ...
                    End If
                    Dgl1.Item(Col1Head, rowItemGroup).Tag = Nothing
                    Dgl1.Item(Col1Value, rowItemGroup).Value = ""
                    Dgl1.Item(Col1Value, rowItemGroup).Tag = ""
                    Dgl1.Item(Col1Head, rowDimension1).Tag = Nothing
                    Dgl1.Item(Col1Value, rowDimension1).Value = ""
                    Dgl1.Item(Col1Value, rowDimension1).Tag = ""
                    Dgl1.Item(Col1Head, rowDimension2).Tag = Nothing
                    Dgl1.Item(Col1Value, rowDimension2).Value = ""
                    Dgl1.Item(Col1Value, rowDimension2).Tag = ""
                    Dgl1.Item(Col1Head, rowDimension3).Tag = Nothing
                    Dgl1.Item(Col1Value, rowDimension3).Value = ""
                    Dgl1.Item(Col1Value, rowDimension3).Tag = ""
                    Dgl1.Item(Col1Head, rowDimension4).Tag = Nothing
                    Dgl1.Item(Col1Value, rowDimension4).Value = ""
                    Dgl1.Item(Col1Value, rowDimension4).Tag = ""
                    Dgl1.Item(Col1Head, rowSize).Tag = Nothing
                    Dgl1.Item(Col1Value, rowSize).Value = ""
                    Dgl1.Item(Col1Value, rowSize).Tag = ""
            End Select
        End If
        Calculation()
    End Sub
    ...
    Private Sub Dgl1_EditingControlShowing(sender As Object, e As DataGridViewEditingControlShowingEventArgs) Handles Dgl1.EditingControlShowing, Dgl2.EditingControlShowing
        If FGetSettings(SettingFields.DefaultTextCaseInMasters, SettingType.General) = TextCase.Upper Then
    ...
    Private Sub FrmSaleOrder_BaseFunction_Calculation() Handles Me.BaseFunction_Calculation
        ...
        For I = 0 To Dgl1.RowCount - 1
            If Dgl1.Item(Col1SKU, I).Value <> "" And Dgl1.Rows(I).Visible Then
                ...
                LblPercentage.Text = Val(LblPercentage.Text) + Val(Dgl1.Item(Col1ConsumptionPer, I).Value)
            End If
        Next
        LblTotalQty.Text = Val(LblTotalQty.Text)
        LblPercentage.Text = Val(LblPercentage.Text)
    End Sub
    Private Sub FrmConsumption_BaseEvent_Topctrl_tbRef() Handles Me.BaseEvent_Topctrl_tbRef
        If Dgl2.AgHelpDataSet(Col1ItemCategory) IsNot Nothing Then Dgl2.AgHelpDataSet(Col1ItemCategory).Dispose() : Dgl2.AgHelpDataSet(Col1ItemCategory) = Nothing
        If Dgl2.AgHelpDataSet(Col1ItemGroup) IsNot Nothing Then Dgl2.AgHelpDataSet(Col1ItemGroup).Dispose() : Dgl2.AgHelpDataSet(Col1ItemGroup) = Nothing
        If Dgl2.AgHelpDataSet(Col1Item) IsNot Nothing Then Dgl2.AgHelpDataSet(Col1Item).Dispose() : Dgl2.AgHelpDataSet(Col1Item) = Nothing
        If Dgl2.AgHelpDataSet(Col1Dimension1) IsNot Nothing Then Dgl2.AgHelpDataSet(Col1Dimension1).Dispose() : Dgl2.AgHelpDataSet(Col1Dimension1) = Nothing
        If Dgl2.AgHelpDataSet(Col1Dimension2) IsNot Nothing Then Dgl2.AgHelpDataSet(Col1Dimension2).Dispose() : Dgl2.AgHelpDataSet(Col1Dimension2) = Nothing
        If Dgl2.AgHelpDataSet(Col1Dimension3) IsNot Nothing Then Dgl2.AgHelpDataSet(Col1Dimension3).Dispose() : Dgl2.AgHelpDataSet(Col1Dimension3) = Nothing
        If Dgl2.AgHelpDataSet(Col1Dimension4) IsNot Nothing Then Dgl2.AgHelpDataSet(Col1Dimension4).Dispose() : Dgl2.AgHelpDataSet(Col1Dimension4) = Nothing
        If Dgl2.AgHelpDataSet(Col1Size) IsNot Nothing Then Dgl2.AgHelpDataSet(Col1Size).Dispose() : Dgl2.AgHelpDataSet(Col1Size) = Nothing
