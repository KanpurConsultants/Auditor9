...
Public Class FrmImportData_SadhviMain
    Dim mQry As String = ""
    ...
    Private Function FGetUpdateClauseForCodes(DtExternalData As DataTable, RowIndexExternalData As Integer,
                                      DtLocalData As DataTable, RowIndexLocalData As Integer,
                                      FieldName As String, PrimaryKeyFieldName As String, DtTable As DataTable)
    ...
    Public Sub FAddSubGroup(DtExternalData_Header As DataTable)
        ...
        For I = 0 To DtCityToImport.Rows.Count - 1
            If DtCity.Select("OMSId = '" & AgL.XNull(DtCityToImport.Rows(I)("CityCode")) & "'").Length = 0 Then
                If AgL.XNull(DtCityToImport.Rows(I)("CityName")) <> "" Then
                    Dim CityTable As New FrmPerson.StructCity
                    ...
                    FrmPerson.ImportCityTable(CityTable)
        ...
        For I = 0 To DtExternalData_Header.Rows.Count - 1
            ...
            If DtSubGroup.Select("OMSId = '" & DtExternalData_Header.Rows(I)("SubCode") & "'").Length = 0 Then
                ...
                SubGroupTable.Parent = FGetCodeFromOMSId(AgL.XNull(DtExternalData_Header.Rows(I)("Parent")), DtSubGroup, "SubCode")
                ...
                If AgL.XNull(DtExternalData_Header.Rows(I)("SubCode")) = AgL.XNull(DtHeaderLocal.Rows(J)("OMSId")) Then
                    ...
                    For F As Integer = 0 To DtFieldList_Header.Rows.Count - 1
                        ...
                        ElseIf DtFieldList_Header.Rows(F)("Name") = "CityCode" Then
                            bUpdateClauseQry += FGetUpdateClauseForCodes(DtExternalData_Header, I, DtHeaderLocal, J, DtFieldList_Header.Rows(F)("Name"), "CityCode", DtCity)
                        ElseIf DtFieldList_Header.Rows(F)("Name") = "Area" Then
                            bUpdateClauseQry += FGetUpdateClauseForCodes(DtExternalData_Header, I, DtHeaderLocal, J, DtFieldList_Header.Rows(F)("Name"), "Code", DtArea)
                        ElseIf DtFieldList_Header.Rows(F)("Name") = "Parent" Then
                            bUpdateClauseQry += FGetUpdateClauseForCodes(DtExternalData_Header, I, DtHeaderLocal, J, DtFieldList_Header.Rows(F)("Name"), "SubCode", DtSubGroup)
                        Else
    ...
    Public Sub FAddItem(DtExternalData_Header As DataTable)
        ...
        For I = 0 To DtExternalData_Header.Rows.Count - 1
            ...
            If DtItem.Select("OMSId = '" & AgL.XNull(DtExternalData_Header.Rows(I)("Code")) & "'").Length = 0 Then
                ...
                ItemTable.ItemGroup = AgL.XNull(DtExternalData_Header.Rows(I)("ItemGroupDesc"))
                ItemTable.ItemCategory = AgL.XNull(DtExternalData_Header.Rows(I)("ItemCategoryDesc"))
                ...
                If AgL.XNull(DtExternalData_Header.Rows(I)("Code")) = AgL.XNull(DtHeaderLocal.Rows(J)("OMSId")) Then
                    ...
                    For F As Integer = 0 To DtFieldList_Header.Rows.Count - 1
                        ...
                        ElseIf DtFieldList_Header.Rows(F)("Name") = "ItemCategory" Or DtFieldList_Header.Rows(F)("Name") = "ItemGroup" Then
                            bUpdateClauseQry += FGetUpdateClauseForCodes(DtExternalData_Header, I, DtHeaderLocal, J, DtFieldList_Header.Rows(F)("Name"), "Code", DtItem)
                        Else
                            bUpdateClauseQry += FGetUpdateClause(DtExternalData_Header, I, DtHeaderLocal, J, DtFieldList_Header.Rows(F)("Name"), DtFieldList_Header.Rows(F)("Type"))
                        End If
                    Next
                ...
                If AgL.XNull(DtExternalData_Header.Rows(I)("DocId")) = AgL.XNull(DtLocalData_Header.Rows(J)("OMSId")) Then
                    ...
                    For F As Integer = 0 To DtFieldList_Header.Rows.Count - 1
                        ...
                        ElseIf DtFieldList_Header.Rows(F)("Name") = "SaleToParty" Or DtFieldList_Header.Rows(F)("Name") = "BillToParty" Then
                            bUpdateClauseQry += FGetUpdateClauseForCodes(DtExternalData_Header, I, DtLocalData_Header, J, DtFieldList_Header.Rows(F)("Name"), "SubCode", DtSubGroup)
                        ElseIf DtFieldList_Header.Rows(F)("Name") = "SaleToPartyCity" Then
                            bUpdateClauseQry += FGetUpdateClauseForCodes(DtExternalData_Header, I, DtLocalData_Header, J, DtFieldList_Header.Rows(F)("Name"), "CityCode", DtCity)
                        Else
                                ...
                                If AgL.XNull(DtExternalData_Line.Rows(K)("DocId")) +
                                    ...
                                    For F As Integer = 0 To DtFieldList_Line.Rows.Count - 1
                                        ...
                                        ElseIf DtFieldList_Line.Rows(F)("Name") = "Godown" Or DtFieldList_Line.Rows(F)("Name") = "SalesRepresentative" Then
                                            bUpdateClauseQry += FGetUpdateClauseForCodes(DtExternalData_Line, K, DtLocalData_Line, L, DtFieldList_Line.Rows(F)("Name"), "SubCode", DtSubGroup)
                                        Else
    ...
    Private Sub FGetDataExternal()
        ...
        mParentPrgBarMaxVal = (DtExternalData_Item.Rows.Count +
                            ...
                            DtExternalData_LedgerHead.Rows.Count) * 2
    ...
    Private Sub FReverseEffectOnHOSite(SearchCode As String, Conn As Object, Cmd As Object)
        If ClsMain.FDivisionNameForCustomization(6) = "SADHVI" And AgL.StrCmp(AgL.PubDBName, "Sadhvi") Then
            If AgL.Dman_Execute(" Select Count(*) From LedgerHead H With (NoLock)
                        Where H.GenDocId = '" & SearchCode & "'", IIf(AgL.PubServerName = "", Conn, AgL.GcnRead)).ExecuteScalar() = 0 Then
                ...
                If AgL.StrCmp(AgL.XNull(DtHeader.Rows(0)("NCat")), Ncat.Receipt) And AgL.StrCmp(AgL.XNull(DtHeader.Rows(0)("SubGroupNature")), "BANK") Then
                    Dim bSadhviBranch As String = AgL.XNull(AgL.Dman_Execute("Select SubCode From SubGroup With (NoLock)
    ...
    Private Sub FPostReverEffectInBranchSite(SearchCode As String, Conn As Object, Cmd As Object)
        ...
        If ClsMain.FDivisionNameForCustomization(6) = "SADHVI" And AgL.StrCmp(AgL.PubDBName, "SADHVI") Then
            ...
            If (AgL.XNull(DtHeader.Rows(0)("NCat")) = Ncat.Receipt Or AgL.XNull(DtHeader.Rows(0)("NCat")) = Ncat.VisitReceipt) And AgL.XNull(DtHeader.Rows(0)("SubGroupNature")).ToString.ToUpper = "BANK" Then
                Dim bSadhviHO As String = AgL.XNull(AgL.Dman_Execute("Select SubCode From SubGroup With (NoLock)
                ...
                If dtLine.Rows.Count > 0 Then
                    For I As Integer = 0 To dtLine.Rows.Count - 1
                        ...
                        Sum(L.Amount) AS AmtDr, 0 AS AmtCr, 'Being Payment Transfered To HO' AS Narration, 
                        ...
                        0 AS AmtDr, Sum(L.Amount) AS AmtCr, 'Being Payment Transfered To HO' AS Narration, 
                        Max(H.Site_Code) AS Site_Code, Max(H.EntryBy) AS U_Name, Max(H.EntryDate) U_EntDt, Max(H.Div_Code) AS DivCode, 
                        Max(H.ManualRefNo) AS RecId
                        FROM LedgerHead H With (NoLock)
                        LEFT JOIN LedgerHeadDetail L With (NoLock) ON H.DocID = L.DocID
