                ...
                If Val(Dgl1.Item(Col1TotalQty, I).Value) <> 0 Then
                    If Dgl1.Item(ColSNo, I).Tag Is Nothing Then
                        ...
                        mQry = "Insert Into Stock(DocID, TSr, Sr, V_Type, 
                                ...
                                Div_Code, Site_Code, SubCode, Item, 
                                ...
                                (
                                    ...
                                    " & AgL.Chk_Text(mObjFrmStockEntry.TxtDivision.Tag) & ", " & AgL.Chk_Text(mObjFrmStockEntry.DglMain.Item(FrmStockEntry.Col1Value, mObjFrmStockEntry.rowSite_Code).Tag) & ", " & AgL.Chk_Text(mObjFrmStockEntry.DglMain.Item(FrmStockEntry.Col1Value, mObjFrmStockEntry.rowParty).Tag) & ", 
                                    " & AgL.Chk_Text(Dgl1(Col1SKU, I).Tag) & ", 
                                    " & AgL.Chk_Text(mObjFrmStockEntry.Dgl1(FrmStockEntry.Col1LotNo, mGridRowIndex).Value) & ", 'R', " & Val(Dgl1(Col1TotalQty, I).Value) & ", 0,
