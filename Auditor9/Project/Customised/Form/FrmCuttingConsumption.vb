...
Imports System.Linq
Public Class FrmCuttingConsumption
    ...
    Public Const rowRawMaterial As Integer = 1
    ...
    Public Const hcRawMaterial As String = "Fabric Size"
...
#End Region
    Private Sub FrmShade_BaseEvent_FindMain() Handles Me.BaseEvent_FindMain
        ...
        AgL.PubFindQry = " Select T.Code As SearchCode, Max(Ic.Description) As ItemCategory, Max(Rm.Description) As RawMaterial "
        ...
        AgL.PubFindQry += " Group by T.Code "
        AgL.PubFindQry += " Order by T.Code"
    ...
    Private Sub FrmQuality1_BaseFunction_MoveRec(ByVal SearchCode As String) Handles Me.BaseFunction_MoveRec
        ...
        mQry = " SELECT H.*, Ic.Description As ItemCategoryDesc, Rm.Description As RawMaterialDesc
                FROM BomHead H 
                LEFT JOIN ItemCategory Ic ON H.ItemCategory = Ic.Code
                LEFT JOIN Item Rm ON H.RawMaterial = Rm.Code
        ...
        With DtTemp
            If .Rows.Count > 0 Then
                ...
                DglMain.Item(Col1Value, rowRawMaterial).Tag = AgL.XNull(.Rows(0)("RawMaterial"))
                DglMain.Item(Col1Value, rowRawMaterial).Value = AgL.XNull(.Rows(0)("RawMaterialDesc"))
            End If
        End With
        ...
        mQry = "SELECT L.*, L.Description AS MainItemDesc, BomItem.Description AS BomItemDesc, 
                ...
                L.DealQty As BatchQty
                FROM BomHead H 
                LEFT JOIN (SELECT It.ItemCategory, It.Size, It.RawMaterial, It.DealQty, It.Description, Bd.*
			                FROM BomDetail Bd
			                LEFT JOIN Item It ON Bd.Code = It.Code) AS L ON H.ItemCategory = L.ItemCategory AND H.RawMaterial = L.RawMaterial
    ...
    Private Sub FrmCuttingConsumption_BaseFunction_IniGrid() Handles Me.BaseFunction_IniGrid
        ...
        DglMain.Item(Col1Head, rowRawMaterial).Value = hcRawMaterial
        ...
        With AgCL
            ...
            .AddAgTextColumn(Dgl1, Col1Unit, 60, 0, Col1Unit, True, False)
    ...
    Private Sub FrmCuttingConsumption_BaseEvent_Data_Validation(ByRef passed As Boolean) Handles Me.BaseEvent_Data_Validation
        ...
        If AgL.VNull(AgL.Dman_Execute("SELECT Count(*)
                ...
                AND H.RawMaterial = '" & DglMain.Item(Col1Value, rowRawMaterial).Tag & "'
                AND H.Code <> '" & mSearchCode & "'", AgL.GCn).ExecuteScalar()) > 0 Then
            MsgBox("Consumption already exist for " & DglMain.Item(Col1Value, rowItemCategory).Value + " and " & DglMain.Item(Col1Value, rowRawMaterial).Value, MsgBoxStyle.Information)
            DglMain.CurrentCell = DglMain(Col1Value, rowRawMaterial)
            DglMain.Focus()
            passed = False
            Exit Sub
        End If
        ...
        For I = 0 To Dgl1.RowCount - 1
            ...
            If AgL.XNull(Dgl1.Item(Col1MainItemSize, I).Tag) <> "" And AgL.XNull(Dgl1.Item(Col1Item, I).Tag) = "" Then
                MsgBox("Item is blank at row number " & Dgl1.Item(ColSNo, I).Value, MsgBoxStyle.Information)
                Dgl1.CurrentCell = Dgl1(Col1Item, I)
                Dgl1.Focus()
                passed = False
                Exit Sub
    ...
    Private Sub FrmYarn_BaseEvent_Save_InTrans(ByVal SearchCode As String, ByVal Conn As Object, ByVal Cmd As Object) Handles Me.BaseEvent_Save_InTrans
        ...
        mQry = "UPDATE BomHead " &
                ...
                " RawMaterial = " & AgL.Chk_Text(DglMain.Item(Col1Value, rowRawMaterial).Tag) & " " &
                " Where Code = '" & SearchCode & "' "
        AgL.Dman_ExecuteNonQry(mQry, Conn, Cmd)

        For I = 0 To Dgl1.Rows.Count - 1
            If Dgl1.Item(Col1Item, I).Value <> "" Then
                If Dgl1.Item(Col1Qty, I).Value <> 0 Then
                    If AgL.XNull(Dgl1.Item(Col1GeneratedItem, I).Tag) = "" Then
                        ...
                        mQry = " INSERT INTO BomDetail (Code, Sr, Process, Item, Qty, Unit)
                             ...
                             " & AgL.Chk_Text(Dgl1.Item(Col1Unit, I).Value) & " As Unit "
                        AgL.Dman_ExecuteNonQry(mQry, AgL.GCn, AgL.ECmd)
    ...
    Private Sub Dgl1_EditingControl_Validating(ByVal sender As Object, ByVal e As System.ComponentModel.CancelEventArgs) Handles Dgl1.EditingControl_Validating
        ...
        Try
            ...
            Select Case Dgl1.Columns(Dgl1.CurrentCell.ColumnIndex).Name
                Case Col1MainItemSize, Col1RawMaterial
    ...
    Private Sub FHPGD_FillSizes()
        ...
        If mSearchCode <> "" Then
            Dim bExistingSizeStr As String = ""
            For I As Integer = 0 To Dgl1.Rows.Count - 1
                If Dgl1.Item(Col1MainItemSize, I).Value <> "" Then
                    If bExistingSizeStr <> "" Then bExistingSizeStr += ","
                    bExistingSizeStr += AgL.Chk_Text(Dgl1.Item(Col1MainItemSize, I).Tag)
                End If
            Next
            If bExistingSizeStr <> "" Then
                mQry += " And Code Not In (" & bExistingSizeStr & ")"
            End If
        End If
        ...
        For I As Integer = 0 To DtTemp.Rows.Count - 1
            Dgl1.Rows.Add()
            Dgl1.Item(ColSNo, mRow + I).Value = Dgl1.Rows.Count - 1

            Dgl1.Item(Col1RawMaterial, mRow + I).Tag = DglMain.Item(Col1Value, rowRawMaterial).Tag
            Dgl1.Item(Col1RawMaterial, mRow + I).Value = DglMain.Item(Col1Value, rowRawMaterial).Value

            Dgl1.Item(Col1MainItemSize, mRow + I).Tag = AgL.XNull(DtTemp.Rows(I)("Code"))
            Dgl1.Item(Col1MainItemSize, mRow + I).Value = AgL.XNull(DtTemp.Rows(I)("Description"))
        Next
    End Sub
End Class
