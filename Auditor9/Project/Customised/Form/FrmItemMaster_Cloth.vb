...
Public Class FrmItemMaster_Cloth
    ...
    Public Const Col1Discount As String = "Discount"
    Public Const Col1Addition As String = "Addition"
    ...
    Public Const rowDiscountPatternSale As Integer = 0
    Public Const rowDiscountPerSale As Integer = 1
    Public Const rowAdditionPerSale As Integer = 2
    Public Const rowDiscountPatternPurchase As Integer = 3
    Public Const rowDiscountPerPurchase As Integer = 4
    Public Const rowMaintainStockYn As Integer = 5
    Public Const rowShowItemInOtherDivision As Integer = 6
    Public Const rowBarcode As Integer = 7
    Public Const rowDefaultSupplier As Integer = 8
    Public Const rowMRP As Integer = 9
...
#Region "Designer Code"
    Private Sub InitializeComponent()
        ...
        Me.Label15.Location = New System.Drawing.Point(264, 204)
        ...
        Me.LblItemCategory.Location = New System.Drawing.Point(19, 59)
        ...
        Me.Label6.Location = New System.Drawing.Point(125, 81)
        ...
        Me.Label8.Location = New System.Drawing.Point(388, 169)
        ...
        Me.Label5.Location = New System.Drawing.Point(125, 165)
        ...
        Me.TxtItemType.Location = New System.Drawing.Point(402, 203)
        ...
        Me.TxtSaleRate.Location = New System.Drawing.Point(402, 183)
        ...
        Me.TxtItemCategory.Location = New System.Drawing.Point(141, 59)
        ...
        Me.LblItemGroup.Location = New System.Drawing.Point(19, 79)
        ...
        Me.TxtSalesTaxPostingGroup.Location = New System.Drawing.Point(402, 163)
        ...
        Me.LblSalesTaxPostingGroup.Location = New System.Drawing.Point(264, 163)
        ...
        Me.LblManualCodeReq.Location = New System.Drawing.Point(125, 101)
        ...
        Me.TxtManualCode.Location = New System.Drawing.Point(141, 99)
        ...
        Me.LblManualCode.Location = New System.Drawing.Point(19, 99)
        ...
        Me.TxtUnit.Location = New System.Drawing.Point(141, 163)
        ...
        Me.LblUnit.Location = New System.Drawing.Point(19, 163)
        ...
        Me.TxtDescription.Location = New System.Drawing.Point(141, 139)
        ...
        Me.LblDescription.Location = New System.Drawing.Point(19, 139)
        ...
        Me.Label12.Location = New System.Drawing.Point(125, 62)
        ...
        Me.TxtSpecification.Location = New System.Drawing.Point(141, 119)
        ...
        Me.TxtHsn.Location = New System.Drawing.Point(141, 203)
        ...
        Me.TxtPurchaseRate.Location = New System.Drawing.Point(141, 183)
        ...
        Me.Label7.Location = New System.Drawing.Point(264, 183)
        ...
        Me.MnuOptions.Size = New System.Drawing.Size(218, 158)
        ...
        Me.LblPurchaseRate_Mandatory.Location = New System.Drawing.Point(126, 187)
        ...
        Me.LblSaleRate_Mandatory.Location = New System.Drawing.Point(388, 189)
...
#End Region
    ...
    Private Sub FGetItemTypeSetting()
        ...
        Dgl1.Rows(rowDiscountPatternSale).Visible = AgL.VNull(DtItemTypeSetting.Rows(0)("IsApplicable_SaleDiscountInMaster"))
        Dgl1.Rows(rowDiscountPerSale).Visible = AgL.VNull(DtItemTypeSetting.Rows(0)("IsApplicable_SaleDiscountInMaster"))
        Dgl1.Rows(rowAdditionPerSale).Visible = AgL.VNull(DtItemTypeSetting.Rows(0)("IsApplicable_SaleDiscountInMaster"))
    ...
    Private Sub FrmYarn_BaseFunction_FIniMast(ByVal BytDel As Byte, ByVal BytRefresh As Byte) Handles Me.BaseFunction_FIniMast
        Dim mConStr$ = " Where H.ItemType In ('TP', '" & AgTemplate.ClsMain.ItemType.FinishedMaterial & "','" & AgTemplate.ClsMain.ItemType.RawMaterial & "','" & AgTemplate.ClsMain.ItemType.Other & "','" & AgTemplate.ClsMain.ItemType.SemiFinishedMaterial & "') "
    ...
    Public Sub FrmYarn_BaseEvent_FindMain() Handles Me.BaseEvent_FindMain
        Dim mConStr$ = " Where I.ItemType In ('TP','" & AgTemplate.ClsMain.ItemType.FinishedMaterial & "','" & AgTemplate.ClsMain.ItemType.RawMaterial & "','" & AgTemplate.ClsMain.ItemType.Other & "','" & AgTemplate.ClsMain.ItemType.SemiFinishedMaterial & "')  "
...
#End Region
        ...
        mQry = "UPDATE Item " &
                ...
                " DiscountCalculationPatternSale = " & AgL.Chk_Text(Dgl1.Item(Col1Value, rowDiscountPatternSale).Value) & "," &
                " DiscountPerSale = " & Val(Dgl1.Item(Col1Value, rowDiscountPerSale).Value) & "," &
                " AdditionPerSale = " & Val(Dgl1.Item(Col1Value, rowAdditionPerSale).Value) & "," &
                " DiscountCalculationPatternPurchase = " & AgL.Chk_Text(Dgl1.Item(Col1Value, rowDiscountPatternPurchase).Value) & "," &
                " DiscountPerPurchase = " & Val(Dgl1.Item(Col1Value, rowDiscountPerPurchase).Value) & "," &
    ...
    Private Sub FrmQuality1_BaseFunction_MoveRec(ByVal SearchCode As String) Handles Me.BaseFunction_MoveRec
        ...
        With DsTemp.Tables(0)
            If .Rows.Count > 0 Then
                ...
                Dgl1.Item(Col1Value, rowDiscountPatternSale).Value = AgL.XNull(.Rows(0)("DiscountCalculationPatternSale"))
                Dgl1.Item(Col1Value, rowDiscountPerSale).Value = Format(AgL.VNull(.Rows(0)("DiscountPerSale")), "0.00")
                Dgl1.Item(Col1Value, rowAdditionPerSale).Value = Format(AgL.VNull(.Rows(0)("AdditionPerSale")), "0.00")
                Dgl1.Item(Col1Value, rowDiscountPatternPurchase).Value = AgL.XNull(.Rows(0)("DiscountCalculationPatternPurchase"))
                Dgl1.Item(Col1Value, rowDiscountPerPurchase).Value = Format(AgL.VNull(.Rows(0)("DiscountPerPurchase")), "0.00")
                    ...
                    If e.KeyCode <> Keys.Enter Then
                        If TxtDescription.AgHelpDataSet Is Nothing Then
                            mQry = "Select Code, Description As Name , Div_Code, ItemType " &
                                    " From Item Where ItemType in ('" & ItemTypeCode.TradingProduct & "','" & ItemTypeCode.OtherProduct & "')" &
                            ...
                            If e.KeyCode <> Keys.Enter Then
                                If DtItemTypeSetting.rows(0)("IsItemGroupLinkedWithItemCategory") Then
                                    mQry = " Select I.Code As Code, I.Description As ItemGroup, I.ItemCategory, I.ItemType, IT.Name AS ItemTypeName, IC.Description AS ItemCategoryDesc " &
                                        ...
                                        " LEFT JOIN ItemType IT ON IT.Code = I.ItemType " &
                                        " LEFT JOIN ItemCategory IC ON IC.Code = I.ItemCategory " &
                                        " WHERE I.ItemCategory='" & TxtItemCategory.Tag & "' And I.ItemType = '" & TxtItemType.Tag & "' "
                    ...
                    If e.KeyCode <> Keys.Enter Then
                        If TxtItemCategory.AgHelpDataSet Is Nothing Then
                            mQry = "SELECT IC.Code, IC.Description, IC.ItemType, IT.Name as ItemTypeName, IC.SalesTaxGroup, IC.Unit, IC.Hsn 
                                    ...
                                    Where IC.ItemType in ('TP','" & AgTemplate.ClsMain.ItemType.FinishedMaterial & "','" & AgTemplate.ClsMain.ItemType.RawMaterial & "','" & AgTemplate.ClsMain.ItemType.Other & "','" & AgTemplate.ClsMain.ItemType.SemiFinishedMaterial & "') Order by IC.Description  "
    ...
    Public Sub Validate_ItemGroup()
        ...
        End If
    End Sub
    Private Sub Control_Validating(ByVal sender As Object, ByVal e As System.ComponentModel.CancelEventArgs) Handles TxtItemGroup.Validating, TxtItemCategory.Validating, TxtSaleRate.Validating, TxtSpecification.Validating, TxtPurchaseRate.Validating
    ...
    Private Sub FrmItemMaster_BaseFunction_IniGrid() Handles Me.BaseFunction_IniGrid
        ...
        Dgl1.Rows.Add(10)
        Dgl1.Item(Col1Head, rowDiscountPatternSale).Value = "Disc. Pattern (Sale)"
        Dgl1.Item(Col1Head, rowDiscountPerSale).Value = "Disc. (Sale) @"
        Dgl1.Item(Col1Head, rowAdditionPerSale).Value = "Addition (Sale) @"
        Dgl1.Item(Col1Head, rowDiscountPatternPurchase).Value = "Disc. Pattern (Purchase)"
        Dgl1.Item(Col1Head, rowDiscountPerPurchase).Value = "Disc. (Purchase) @"
        Dgl1.Item(Col1Head, rowDefaultSupplier).Value = "Default Supplier"
        Dgl1.Item(Col1Head, rowBarcode).Value = "Barcode"
        Dgl1.Item(Col1Head, rowMRP).Value = "MRP"
        Dgl1.Item(Col1Head, rowShowItemInOtherDivision).Value = "Show In Other Div. (Y/N)"
        Dgl1.Item(Col1Head, rowMaintainStockYn).Value = "Maintain Stock (Y/N)"
        Dgl1.Name = "Dgl1"
    ...
    Private Sub Dgl1_EditingControl_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles Dgl1.EditingControl_KeyDown
        ...
        Try
            ...
            Select Case Dgl1.CurrentCell.RowIndex
                Case rowDiscountPatternSale, rowDiscountPatternPurchase
                    If e.KeyCode <> Keys.Enter Then
    ...
    Private Sub Dgl1_CellEnter(ByVal sender As Object, ByVal e As System.Windows.Forms.DataGridViewCellEventArgs) Handles Dgl1.CellEnter
        Try
            ...
            Select Case Dgl1.CurrentCell.RowIndex
                Case rowDiscountPerSale, rowAdditionPerSale, rowDiscountPerPurchase
