...
Public Class FrmBarcodeGenerate
    ...
    Protected Const Col1RecId As String = "Rec Id"
    Protected Const Col1V_Date As String = "Date"
    Protected Const Col1ItemName As String = "Item Name"
    Protected Const Col1Qty As String = "Qty"
    Protected Const Col1BtnBarcodeDetail As String = "Barcode"
    Protected Const Col1BarcodeType As String = "Barcode Type"
    Protected Const Col1BarcodePattern As String = "Barcode Pattern"
    ...
    Private Sub Ini_Grid()
        ...
        With AgCL
            ...
            .AddAgButtonColumn(Dgl1, Col1BtnBarcodeDetail, 60, Col1BtnBarcodeDetail, True, False)
            .AddAgTextColumn(Dgl1, Col1BarcodeType, 65, 0, " ", True, True)
            .AddAgTextColumn(Dgl1, Col1BarcodePattern, 65, 0, " ", True, True)
        End With
    ...
    Private Sub ShowBarcodeDetail(mRow As Integer)
        If Dgl1.Item(Col1BtnBarcodeDetail, mRow).Tag IsNot Nothing Then
            ...
            CType(Dgl1.Item(Col1BtnBarcodeDetail, mRow).Tag, FrmBarcodeFill).ItemName = " Item : " + Dgl1.Item(Col1ItemName, mRow).Value
            ...
            Else
                If Dgl1.Item(Col1BarcodeType, I).Value = BarcodeType.Fixed Then
                    mQry = "Select 'o' As Tick, B.Code As Code, B.Description As Barcode, 
                                I.Description As Item, CAST(" & Val(Dgl1.Item(Col1Qty, I).Value) & " as Integer) As Qty
                                From Item I 
                ...
                For I = 0 To DtTemp.Rows.Count - 1
                    For J = 1 To Val(DtTemp.Rows(I)("Qty"))
                        ...
                        If AgL.PubServerName = "" Then
                            ...
                            ItemDesc.Value = DtTemp.Rows(I)("Item")
