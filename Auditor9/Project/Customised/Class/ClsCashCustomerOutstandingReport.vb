...
Public Class ClsCashCustomerOutstandingReport
    ...
    Public Sub Ini_Grid()
        Try
            ReportFrm.CreateHelpGrid("AsOnDate", "As On Date", AgLibrary.FrmReportLayout.FieldFilterDataType.StringType, AgLibrary.FrmReportLayout.FieldDataType.DateType, "", AgL.RetMonthEndDate(AgL.PubLoginDate))
    ...
    Private Sub ObjRepFormGlobal_ProcessReport() Handles ReportFrm.ProcessReport
        ProcCashCustomerOutstandingReport()
    End Sub
    Public Sub New(ByVal mReportFrm As FrmRepDisplay)
        ReportFrm = mReportFrm
    End Sub
    Public Sub ProcCashCustomerOutstandingReport(Optional mFilterGrid As AgControls.AgDataGrid = Nothing,
        ...
        Try
            ...
            mCondStr = " And Date(H.V_Date) <= " & AgL.Chk_Date(ReportFrm.FGetText(rowAsOnDate)) & " "
            ...
            mQry = "Select H.DocID As SearchCode, H.RecId As InvoiceNo , 
                    H.V_Date As InvoiceDate, Si.SaleToPartyName As Party, 
                    Si.SaleToPartyMobile As ContactNo, 
                    H.AmtDr as InvoiceAmount, 
                    H.AmtDr-IfNull(Adj.AdjAmt,0) as BalanceAmount 
                    from Ledger H
                    ...
                    Where H.AmtDr - IfNull(Adj.AdjAmt,0) > 0
                    And  H.AmtDr > 0 
                    And H.SubCode = 'Customer' " & mCondStr &
            ...
            ReportFrm.Text = "Cash Customer Outstanding Report"
            ReportFrm.ClsRep = Me
            ReportFrm.ReportProcName = "ProcCashCustomerOutstandingReport"
