...
Public Class ClsTCSReport
    ...
    Dim rowPartyTaxGroup As Integer = 7
    Dim rowItemTaxGroup As Integer = 8
    ...
    Public Sub Ini_Grid()
        Try
            mQry = "Select 'Customise Summary' as Code, 'Customise Summary' as Name
                    Union All Select 'Document Wise Summary' as Code, 'Document Wise Summary' as Name
            ...
            mQry = "Select 'Document Wise Summary' as Code, 'Document Wise Summary' as Name"
            ReportFrm.CreateHelpGrid("Report Type", "Report Type", FrmRepDisplay.FieldFilterDataType.StringType, FrmRepDisplay.FieldDataType.SingleSelection, mQry, "Document Wise Summary",,, 300)
    ...
    Public Sub ProcMain(Optional mFilterGrid As AgControls.AgDataGrid = Nothing,
        ...
        Try
            ...
            If mFilterGrid IsNot Nothing And mGridRow IsNot Nothing Then
                If mGridRow.DataGridView.Columns.Contains("Search Code") = True Then
                    If mFilterGrid.Item(GFilter, rowReportType).Value = "Summary" Then
                        ...
                        mFilterGrid.Item(GFilter, rowHSN).Value = mGridRow.Cells("Item").Value
            ...
            ElseIf ReportFrm.FGetText(0) = "Document Wise Summary" Then
                mQry = " Select VMain.DocId As SearchCode "
                mQry += ", Max(Vmain.Site) as Site "
                mQry += ", Max(VMain.Division) as Division "
                mQry += ", Max(VMain.V_Date) As InvoiceDate "
