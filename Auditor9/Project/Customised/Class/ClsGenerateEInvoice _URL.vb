...
Public Class ClsGenerateEInvoice_URL
    ...
    Private Function FGetJsonForIrn(mSearchCode As String) As String
        ...
        mQry = "SELECT H.Div_Code, H.Site_Code, H.V_Type AS InvoiceType, 
                        ...
                        L.Qty, L.Unit, 
                        Round((L.Taxable_Amount + (CASE WHEN Vt.V_Type ='SR' THEN 0 ELSE L.DiscountAmount + L.AdditionalDiscountAmount END)) / L.Qty,2) As Rate, 
                        L.Taxable_Amount + (CASE WHEN Vt.V_Type ='SR' THEN 0 ELSE L.DiscountAmount + L.AdditionalDiscountAmount END) AS Amount, 
                        CASE WHEN Vt.V_Type ='SR' THEN 0 ELSE L.DiscountAmount + L.AdditionalDiscountAmount END As DiscountAmount,  
