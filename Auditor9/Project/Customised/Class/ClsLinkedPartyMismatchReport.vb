...
Public Class ClsLinkedPartyMismatchReport
    ...
    Private Sub ObjRepFormGlobal_ProcessReport() Handles ReportFrm.ProcessReport
        ProcLinkedPartyMismatchReport()
    End Sub
    Public Sub New(ByVal mReportFrm As FrmRepDisplay)
        ReportFrm = mReportFrm
    End Sub
    Public Sub ProcLinkedPartyMismatchReport(Optional mFilterGrid As AgControls.AgDataGrid = Nothing,
        ...
        Try
            ...
            RepTitle = "Linked Party Mismatch Report"
            ...
            mQry = "SELECT H.DocID As SearchCode, Vt.Description AS VoucherType, H.ManualRefNo, H.V_Date, Sg1.Name AS Party, Sg2.Name AS TransactionLinkedParty, Sg3.Name AS MasterLinkedParty
                    FROM SaleInvoice H 
                    LEFT JOIN ViewHelpSubgroup Sg1 ON H.SaleToParty = Sg1.Code
                    LEFT JOIN ViewHelpSubgroup Sg2 ON H.BillToParty = Sg2.Code
                    LEFT JOIN ViewHelpSubgroup Sg3 ON Sg1.Parent = Sg3.Code
                    LEFT JOIN Voucher_Type Vt ON H.V_Type = Vt.V_Type
                    WHERE H.BillToParty <> Sg1.Parent " & mCondStr & "

                    UNION ALL 

                    SELECT H.DocID As SearchCode, Vt.Description AS VoucherType, H.ManualRefNo, H.V_Date, Sg1.Name AS Party, Sg2.Name AS TransactionLinkedParty, Sg3.Name AS MasterLinkedParty
                    FROM PurchInvoice H 
            ...
            ReportFrm.Text = "Linked Party Mismatch Report"
            ReportFrm.ClsRep = Me
            ReportFrm.ReportProcName = "ProcLinkedPartyMismatchReport"
