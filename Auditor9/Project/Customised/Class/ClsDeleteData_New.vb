    ...
    Private Sub ProcDeleteData()
        ...
        If MsgBox("Are you sure you want to proceed delete data ?" & vbNewLine & "This will wash selected data.", MsgBoxStyle.Question + MsgBoxStyle.YesNo, "") = MsgBoxResult.Yes Then
            Try
                ...
                mQry = "SELECT H.DocId, H.LinkedSubcode, Vt.NCat, H.V_Date
                        FROM LedgerHead H 
                ...
                mQry += "SELECT L.PurchaseInvoiceDocId As DocId, H.LinkedSubcode, Vt.NCat, H.V_Date
                        FROM LedgerHead H 
                        LEFT JOIN Subgroup Sg ON H.LinkedSubcode = Sg.Subcode
                        LEFT JOIN AcGroup Ag ON Sg.GroupCode = Ag.GroupCode
                ...
                mQry += "SELECT L.PaymentDocId As DocId, H.LinkedSubcode, Vt.NCat, H.V_Date
                        FROM LedgerHead H 
                        LEFT JOIN Subgroup Sg ON H.LinkedSubcode = Sg.Subcode
                        LEFT JOIN AcGroup Ag ON Sg.GroupCode = Ag.GroupCode
        ...
        End If
    End Sub
    Private Sub FDeleteLedgerHead(bDocId As String, bSubCode As String, bNCat As String)
