...
Public Class ClsSalesManCommissionReport
    ...
    Private Sub ObjRepFormGlobal_ProcessReport() Handles ReportFrm.ProcessReport
        ProcSalesManCommissionReport()
    End Sub
    Public Sub New(ByVal mReportFrm As FrmRepDisplay)
        ReportFrm = mReportFrm
    End Sub
    Public Sub ProcSalesManCommissionReport(Optional mFilterGrid As AgControls.AgDataGrid = Nothing,
            ...
            If mFilterGrid IsNot Nothing And mGridRow IsNot Nothing Then
                If mGridRow.DataGridView.Columns.Contains("Search Code") = True Then
                    If mFilterGrid.Item(GFilter, rowReportType).Value = "Summary" Then
                        ...
                        mFilterGrid.Item(GFilter, rowSalesRepresentative).Value = mGridRow.Cells("Sale Man").Value
                        mFilterGrid.Item(GFilterCode, rowSalesRepresentative).Value = "'" + mGridRow.Cells("Search Code").Value + "'"
                    Else
