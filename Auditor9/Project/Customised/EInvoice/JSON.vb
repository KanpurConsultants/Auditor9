...
Module JSON
    ...
    '
    Private Function parseObject(ByRef str As String, ByRef index As Long) As Dictionary(Of Object, Object)

        parseObject = New Dictionary(Of Object, Object)
        Dim sKey As String
...
eh:
    ...
    Private Function parseNumber(ByRef str As String, ByRef index As Long)
        ...
        Do While index > 0 And index <= Len(str)
            mChar = Mid(str, index, 1)
            If InStr("+-0123456789.eE", mChar) Then
                Value = Value & mChar
                index = index + 1
            Else
            ...
            Select Case (mChar)
                ...
                Case ":"
                    ...
                    If Not dquote And Not squote Then
                        Exit Do
                    Else
                        parseKey = parseKey & mChar
                    End If
                Case Else
                    If InStr(vbCrLf & vbCr & vbLf & vbTab & " ", mChar) Then
                    Else
                        parseKey = parseKey & mChar
                    End If
                    index = index + 1
    ...
    Public Function toString(ByRef obj As Object) As String
        Dim SB As New StringBuilder
    ...
    Private Function Encode(str) As String
        ...
        aL1 = {&H22, &H5C, &H2F, &H8, &HC, &HA, &HD, &H9}
        aL2 = {&H22, &H5C, &H2F, &H62, &H66, &H6E, &H72, &H74}
        For i = 1 To Len(str)
            p = True
            c = Mid(str, i, 1)
            For j = 0 To 7
            ...
            If p Then
                ...
                ElseIf a > -1 Or a < 65535 Then
                    SB.Append("\u" & str(4 - Len(Hex(a)), "0") & Hex(a))
                End If
            End If
        Next
