...
Public Class FrmFind
    ...
    Private Sub IniGrid()
        ...
        DGL2.DefaultCellStyle.Font = New Font("Verdana", 8, FontStyle.Bold)
    ...
    Private Function RowsFilter(ByVal selStr As String, ByVal CtrlObj As Object, ByVal TXT As TextBox, ByVal e As System.Windows.Forms.KeyPressEventArgs, ByVal FndFldName As String, ByVal DTable As DataTable) As Integer
        Try
            ...
            If sa.Length = 0 And Asc(e.KeyChar) = 8 Then IntRow = 0 : CtrlObj.CurrentCell = CtrlObj(FndFldName, IntRow) : DsMaster.Tables(0).DefaultView.RowFilter = Nothing : ProcFilterGrid() : Exit Function
            ...
            Else
                DsMaster.Tables(0).DefaultView.RowFilter += " [" & FndFldName & "] like '%" & findStr & "%' "
            End If
            If DGL1.Rows.Count > 0 Then DGL1.CurrentCell = DGL1(FndFldName, 0)
