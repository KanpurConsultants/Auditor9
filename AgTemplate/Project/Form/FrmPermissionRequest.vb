...
Public Class FrmPermissionRequest
    ...
    Public Const rowExpiryDate As Integer = 7
    Public Const rowAction As Integer = 8
    Public Const rowReason As Integer = 9
    ...
    Public Const HcExpiryDate As String = "Expiry Date"
    ...
    Public Sub IniGrid()
        ...
        Dgl1.Item(Col1Head, rowExpiryDate).Value = HcExpiryDate
    ...
    Public Sub FMoveRec()
        ...
        Try
            ...
            Dgl1.Item(Col1Value, rowEntryNo).Value = mManualRefNo
            Dgl1.Item(Col1Value, rowV_Date).Value = mV_Date
            Dgl1.Item(Col1Value, rowExpiryDate).Value = AgL.PubLoginDate
    ...
    Public Sub FSave(ByVal Conn As Object, ByVal Cmd As Object)
        ...
        mQry = " INSERT INTO PermissionRequest (Code, FromDate, ToDate, V_Type, V_Date, ExpiryDate, Div_Code, Site_Code, DocId, EntryNo, Action, Reason, EntryBy, EntryDate)
                Select '" & bCode & "', 
                ...
                " & AgL.Chk_Date(Dgl1.Item(Col1Value, rowExpiryDate).Value) & ", 
