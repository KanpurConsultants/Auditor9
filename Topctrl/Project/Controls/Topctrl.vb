...
Public Class Topctrl
    ...
    Dim mAgSearchMethod As AgControls.AgLib.TxtSearchMethod = AgControls.AgLib.TxtSearchMethod.Simple
    ...
    Public Sub BlankTextBoxes(ByVal CntObj As Object)
        ...
        For Each ObjTxt In CntObj.Controls
            ...
            If TypeOf ObjTxt Is GroupBox Or TypeOf ObjTxt Is Panel Then
                BlankTextBoxes(ObjTxt)
                'For Each ObjGroup In ObjTxt.Controls
                '    If TypeOf ObjGroup Is TextBox Then
                '        ObjGroup.Text = ""
                '        ObjGroup.Tag = ""
    ...
    Public Sub FButtonClick(ByVal BytIndex As Byte, Optional ByVal SilentMode As Boolean = False)
        Select Case BytIndex
            ...
            Case indExit
                RaiseEvent tbExit()
                If Me.Mode <> "Browse" Then
                    If MsgBox("Are You Sure to Discard & Exit. ", MsgBoxStyle.Question + MsgBoxStyle.YesNo, FrmParent.Text) = MsgBoxResult.Yes Then
                        FrmParent.close()
                    End If
                Else
                    FrmParent.close()
...
BTNERR:
    ...
    End Sub
    Public Sub FIniForm(ByRef DTMaster As DataTable, ByVal DBCon As SqlClient.SqlConnection, ByVal StrSQL As String,
    Optional ByVal BlnIsMaster As Boolean = False, Optional ByVal CmbMaster As System.Windows.Forms.ComboBox = Nothing,
    Optional ByVal StrCmbValue As String = "", Optional ByVal StrCmbDisplay As String = "",
    Optional ByVal BytDel As Byte = 0, Optional ByVal BytRefresh As Byte = 0)
