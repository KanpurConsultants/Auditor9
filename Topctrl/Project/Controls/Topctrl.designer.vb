...
Partial Class Topctrl
    ...
    Public WithEvents btbAdd As ToolBarButton
    Public WithEvents btbEdit As ToolBarButton
    Public WithEvents btbDel As ToolBarButton
    Public WithEvents btbCancel As ToolBarButton
    Public WithEvents ToolBarButton1 As ToolBarButton
    Public WithEvents btbFirst As ToolBarButton
    Public WithEvents btbPrevious As ToolBarButton
    Public WithEvents btbNext As ToolBarButton
    Public WithEvents btbLast As ToolBarButton
    Public WithEvents ToolBarButton2 As ToolBarButton
    Public WithEvents btbFind As ToolBarButton
    Public WithEvents btbPrint As ToolBarButton
    Public WithEvents ToolBarButton4 As ToolBarButton
    Public WithEvents btbSave As ToolBarButton
    Public WithEvents btbDiscard As ToolBarButton
    Public WithEvents btbSite As ToolBarButton
    Public WithEvents btbRefresh As ToolBarButton
    Public WithEvents ToolBarButton6 As ToolBarButton
    Public WithEvents btbExit As ToolBarButton
End Class
