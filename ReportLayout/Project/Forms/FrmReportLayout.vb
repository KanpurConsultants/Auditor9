...
#Region "General Functions/Procedures Declaration Don't Change It."
    ...
    Sub New(ByVal StrModuleVar As String, ByVal StrReportForVar As String, ByVal StrFormCaption As String, ByVal StrReportPathVar As String, Optional ByVal IntFrmWidthVar As Integer = 554,
...
#End Region
    ...
    Public Sub CreateHelpGrid(ByVal FieldCode As String, ByVal FieldName As String,
                               ByVal FieldFilterDataType As ReportLayout.FrmReportLayout.FieldFilterDataType,
                               ByVal FieldDataType As ReportLayout.FrmReportLayout.FieldDataType,
