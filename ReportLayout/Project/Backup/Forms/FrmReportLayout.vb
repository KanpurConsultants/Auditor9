...
#Region "General Variable Declaration Don't Change It."
    ...
    '================ Start ================
    '=======================================
    Private Const GFieldCode As Byte = 0
    Private Const GFieldName As Byte = 1
    Private Const GFilter As Byte = 2
    Private Const GButton As Byte = 3
    Private Const GFilterCode As Byte = 4
    Private Const GFilterCodeDataType As Byte = 5
    Private Const GDataType As Byte = 6
    Private Const GDisplayOnReport As Byte = 7
    Private Const GHelpQuery As Byte = 8
    Private Const GHGHeight As Byte = 9
    Private Const GHGWidth As Byte = 10
    Private Const GHGColWidth As Byte = 11
    Private Const GHGColAlignment As Byte = 12
    '=======================================
    '===== For FGMain Columns In Grid ======
    '================= End =================
    '=======================================
...
#Region "General Functions/Procedures Declaration Don't Change It."
    ...
    Sub New(ByVal StrModuleVar As String, ByVal StrReportForVar As String, ByVal StrFormCaption As String, ByVal StrReportPathVar As String, Optional ByVal IntFrmWidthVar As Integer = 554, _
    ...
    Private Sub FHPGD_Show_Multiple(ByRef e As System.Windows.Forms.KeyEventArgs)
        ...
        End If
    End Sub
    Private Sub FSetValue(ByVal IntRow As Int16, ByVal StrFieldCode As String, ByVal StrFieldName As String, _
    ByVal BytDataType As FGDataType, ByVal FCTType As FilterCodeType, ByVal strHelpQuery As String, Optional ByVal StrDefaultValue As String = "", _
...
#Region "FIni_Templete For Programmer Help See It."
    ...
    Private Sub FIni_Templete()
        ...
        FRH_Multiple(5) = New DMHelpGrid.FrmHelpGrid_Multi(New DataView(Agl.FillData( _
        ...
        FRH_Single(6) = New DMHelpGrid.FrmHelpGrid(New DataView(Agl.FillData( _
...
#End Region
        ...
        Try
            ...
            If DTTemp.Rows.Count > 0 Then
                ...
                For I = 0 To DTTemp.Rows.Count - 1
                    ...
                    End If
                    FSetValue(I, Agl.XNull(DTTemp.Rows(I).Item("FieldCode")), Agl.XNull(DTTemp.Rows(I).Item("FieldName")), Agl.XNull(DTTemp.Rows(I).Item("FieldDataType")), _
                    ...
                    If Agl.XNull(DTTemp.Rows(I).Item("FieldDataType")) = FGDataType.DT_Selection_Multiple Or Agl.XNull(DTTemp.Rows(I).Item("FieldDataType")) = FGDataType.DT_Selection_Single Then
                        ...
                        If Agl.XNull(DTTemp.Rows(I).Item("FieldDataType")) = FGDataType.DT_Selection_Single Then
                            FRH_Single(I) = New DMHelpGrid.FrmHelpGrid(New DataView(Agl.FillData( _
                                         FRefineSQLQuery(Agl.XNull(DTTemp.Rows(I).Item("DMHGQuery"))), _
                        ...
                        ElseIf Agl.XNull(DTTemp.Rows(I).Item("FieldDataType")) = FGDataType.DT_Selection_Multiple Then
                            FRH_Multiple(I) = New DMHelpGrid.FrmHelpGrid_Multi(New DataView(Agl.FillData( _
                                        FRefineSQLQuery(Agl.XNull(DTTemp.Rows(I).Item("DMHGQuery"))), _
    ...
    Private Sub FReportPrint()
        ...
        mQry = " Select Replace(Report_File_Sql,'`','''') As Report_File_Sql , " & _
                " Replace(Report_Title_Sql,'`','''') As Report_Title_Sql , " & _
                " Replace(Report_ProcedureName_Sql,'`','''') As Report_ProcedureName_Sql " & _
                " From Report_Module_Menu " & _
    ...
    Public Sub CreateHelpGrid(ByVal FieldCode As String, ByVal FieldName As String, _
                               ByVal FieldFilterDataType As ReportLayout.FrmReportLayout.FieldFilterDataType, _
                               ByVal FieldDataType As ReportLayout.FrmReportLayout.FieldDataType, _
                               ByVal DMHGQuery As String, _
                               Optional ByVal DefaultValue As String = "All", _
                               Optional ByVal DMHGHeight As Integer = 400, _
                               Optional ByVal DMHGWidth As Integer = 400, _
                               Optional ByVal ColWidth As Integer = 200, _
                               Optional ByVal ColAlignment As DataGridViewContentAlignment = DataGridViewContentAlignment.NotSet, _
        ...
        Try
            ...
            FGMain.Rows.Add()
            FSetValue(FGMain.Rows.Count - 1, FieldCode, FieldName, FieldDataType, FieldFilterDataType, DMHGQuery, DefaultValue, DisplayOnReport)
    ...
    Public Sub PrintReport(ByVal DsRep As DataSet, ByVal RepName As String, ByVal RepTitle As String, _
                           Optional ByVal ReportPath As String = "", _
